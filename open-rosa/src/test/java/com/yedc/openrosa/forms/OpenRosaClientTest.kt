...
class OpenRosaClientTest {
    private val httpInterface = mock<_root_ide_package_.com.yedc.openrosa.http.OpenRosaHttpInterface>()
    private val webCredentialsProvider =
        _root_ide_package_.com.yedc.openrosa.support.StubWebCredentialsProvider()
    ...
    fun fetchFormList_removesTrailingSlashesFromUrl() {
        ...
        whenever(
            ...
            _root_ide_package_.com.yedc.openrosa.http.HttpGetResult(
