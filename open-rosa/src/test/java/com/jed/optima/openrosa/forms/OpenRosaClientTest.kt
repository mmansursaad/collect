...
class OpenRosaClientTest {
    private val httpInterface = mock<_root_ide_package_.com.jed.optima.openrosa.http.OpenRosaHttpInterface>()
    private val webCredentialsProvider =
        _root_ide_package_.com.jed.optima.openrosa.support.StubWebCredentialsProvider()
    ...
    fun fetchFormList_removesTrailingSlashesFromUrl() {
        ...
        whenever(
            ...
            _root_ide_package_.com.jed.optima.openrosa.http.HttpGetResult(
