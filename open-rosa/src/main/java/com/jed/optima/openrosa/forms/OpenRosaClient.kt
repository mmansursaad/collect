package com.jed.optima.openrosa.forms
...
import com.jed.optima.forms.FormSourceException.AuthRequired
import com.jed.optima.forms.FormSourceException.FetchError
import com.jed.optima.forms.FormSourceException.SecurityError
import com.jed.optima.forms.FormSourceException.ServerNotOpenRosaError
import com.jed.optima.forms.ManifestFile
import com.jed.optima.openrosa.forms.OpenRosaXmlFetcher.WebCredentialsProvider
import com.jed.optima.openrosa.http.OpenRosaConstants
import com.jed.optima.openrosa.parse.OpenRosaResponseParser
...
class OpenRosaClient(
    serverURL: String,
    openRosaHttpInterface: _root_ide_package_.com.jed.optima.openrosa.http.OpenRosaHttpInterface?,
    private val webCredentialsProvider: WebCredentialsProvider,
    private val openRosaResponseParser: OpenRosaResponseParser
) : _root_ide_package_.com.jed.optima.forms.FormSource, EntitySource {
    private val openRosaXMLFetcher =
        _root_ide_package_.com.jed.optima.openrosa.forms.OpenRosaXmlFetcher(
