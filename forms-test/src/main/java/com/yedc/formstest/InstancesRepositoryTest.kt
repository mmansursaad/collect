...
abstract class InstancesRepositoryTest {
    abstract fun buildSubject(): _root_ide_package_.com.yedc.forms.instances.InstancesRepository

    abstract fun buildSubject(clock: Supplier<Long>): _root_ide_package_.com.yedc.forms.instances.InstancesRepository
    ...
    fun allNotDeleted_returnsUndeletedInstances() {
        ...
        instancesRepository.save(
            buildInstance("deleted", "1", instancesDir.absolutePath)
                .status(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_COMPLETE)
    ...
    fun allByStatus_withOneStatus_returnsMatchingInstances() {
        ...
        instancesRepository.save(
            buildInstance("incomplete", "1", instancesDir.absolutePath)
                .status(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE)
                .build()
        )
        instancesRepository.save(
            buildInstance("incomplete", "1", instancesDir.absolutePath)
        ...
        val incomplete = instancesRepository.getAllByStatus(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE)
        ...
        assertThat(
            instancesRepository.getCountByStatus(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE),
            equalTo(2)
        )
    }
    ...
    fun allByStatus_withMultipleStatus_returnsMatchingInstances() {
        ...
        instancesRepository.save(
            buildInstance("submitted", "1", instancesDir.absolutePath)
                .status(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_SUBMITTED)
                .build()
        )
        instancesRepository.save(
            buildInstance("submitted", "1", instancesDir.absolutePath)
        ...
        val incomplete =
            instancesRepository.getAllByStatus(
                _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE,
                _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_SUBMITTED
            )
        ...
        // Check corresponding count method is also correct
        assertThat(
            instancesRepository.getCountByStatus(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE, _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_SUBMITTED),
            equalTo(4)
        )
    }
    ...
    fun allByFormId_includesAllVersionsForFormId() {
        ...
        instancesRepository.save(
            buildInstance(
                ...
                "2",
                "display",
                _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_COMPLETE,
                null,
    ...
    fun save_whenInstanceHasId_updatesExisting() {
        ...
        instancesRepository.save(
            _root_ide_package_.com.yedc.forms.instances.Instance.Builder(originalInstance)
    ...
    fun save_whenStatusIsNotFinalized_doesNotPopulateFinalizationDate() {
        ...
        val nonFinalizedStatuses = listOf(
            _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_VALID,
            _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INVALID,
            _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_NEW_EDIT,
            _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_SUBMISSION_FAILED,
            _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_SUBMITTED
        )
    ...
    fun save_whenStatusIsNull_usesIncomplete() {
        ...
        assertThat(
            instancesRepository[instance.dbId]!!.status, equalTo(_root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE)
        )
    }
    ...
    fun delete_failsWhenDeletingInstanceWithEdits() {
        ...
        assertThrows(_root_ide_package_.com.yedc.forms.instances.InstancesRepository.IntegrityException::class.java) {
