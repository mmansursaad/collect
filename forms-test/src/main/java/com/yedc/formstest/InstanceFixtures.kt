...
object InstanceFixtures {
    ...
    fun instance(
        status: String = _root_ide_package_.com.yedc.forms.instances.Instance.STATUS_INCOMPLETE,
        lastStatusChangeDate: Long = 0,
        displayName: String = "Form",
        dbId: Long? = null,
        form: _root_ide_package_.com.yedc.forms.Form? = null,
    ...
    ): _root_ide_package_.com.yedc.forms.instances.Instance {
