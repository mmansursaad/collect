...
public class GeoPointMapActivity extends LocalizedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ToastUtils.showShortToast(com.yedc.strings.R.string.google_play_services_error_occured);
            finish();
            return;
        }
    ...
    public void initMap(MapFragment newMapFragment) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            if (!intentDraggable) {
                ...
                locationStatus.setTitle(getString(com.yedc.strings.R.string.geopoint_no_draggable_instruction));
            }
    ...
    private void placeMarker(@NonNull MapPoint point) {
        map.clearFeatures();
        featureId = map.addMarker(new MarkerDescription(point, intentDraggable && !intentReadOnly && !isPointLocked, MapFragment.CENTER, new MarkerIconDescription(com.yedc.icons.R.drawable.ic_map_point)));
        if (!intentReadOnly) {
