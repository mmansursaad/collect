...
import com.yedc.geo.databinding.AccuracyProgressLayoutBinding
...
internal class AccuracyProgressView @JvmOverloads constructor(
    ...
    private fun getTextAndStrength(accuracy: LocationAccuracy): Pair<Int, Int> {
        return when (accuracy) {
            is LocationAccuracy.Improving -> Pair(com.yedc.strings.R.string.improving_accuracy, 80)
            is LocationAccuracy.Poor -> Pair(com.yedc.strings.R.string.poor_accuracy, 60)
            is LocationAccuracy.Unacceptable -> Pair(com.yedc.strings.R.string.unacceptable_accuracy, 40)
        }
    }
}
