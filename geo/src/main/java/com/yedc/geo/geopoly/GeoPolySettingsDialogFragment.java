...
public class GeoPolySettingsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(getString(com.yedc.strings.R.string.input_method))
                .setView(settingsView)
                .setPositiveButton(getString(com.yedc.strings.R.string.start), (dialog, id) -> {
                ...
                .setNegativeButton(com.yedc.strings.R.string.cancel, (dialog, id) -> {
                    dismiss();
                })
                .create();
    }
    ...
    private String formatInterval(int seconds) {
        ...
        return minutes > 0
                ? getResources().getQuantityString(com.yedc.strings.R.plurals.number_of_minutes, minutes, minutes)
                : getResources().getQuantityString(com.yedc.strings.R.plurals.number_of_seconds, seconds, seconds);
    }
    ...
    private String formatAccuracyThreshold(int meters) {
        return meters > 0
                ? getResources().getQuantityString(com.yedc.strings.R.plurals.number_of_meters, meters, meters)
                : getString(com.yedc.strings.R.string.none);
    }
