...
import com.yedc.androidshared.ui.multiclicksafe.setMultiClickSafeOnClickListener
import com.yedc.async.Scheduler
import com.yedc.geo.GeoDependencyComponentProvider
import com.yedc.geo.databinding.SelectionMapLayoutBinding
...
class SelectionMapFragment(
    ...
    @Inject
    lateinit var externalWebPageHelper: _root_ide_package_.com.yedc.webpage.ExternalWebPageHelper
    ...
    override fun onAttach(context: Context) {
        ...
        _root_ide_package_.com.yedc.material.MaterialProgressDialogFragment.showOn(
            this,
            selectionMapData.isLoading(),
            childFragmentManager
        ) {
            _root_ide_package_.com.yedc.material.MaterialProgressDialogFragment()
                .also { dialog ->
