...
import com.yedc.geo.geopoint.GeoPointDialogFragment
import com.yedc.geo.geopoint.GeoPointViewModelFactory
import com.yedc.geo.geopoint.LocationTrackerGeoPointViewModel
...
interface GeoDependencyComponent {
    ...
    fun inject(geoPointMapActivity: _root_ide_package_.com.yedc.geo.geopoint.GeoPointMapActivity)
    fun inject(geoPolyActivity: _root_ide_package_.com.yedc.geo.geopoly.GeoPolyActivity)
...
open class GeoDependencyModule {
    ...
    @Provides
    open fun providesExternalWebPageHelper(): _root_ide_package_.com.yedc.webpage.ExternalWebPageHelper {
        throw UnsupportedOperationException("This should be overridden by dependent application")
    }
}
