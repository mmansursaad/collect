...
public final class GeoUtils {
    ...
    public static String formatLocationResultString(Location location) {
        return formatLocationResultString(new com.yedc.location.Location(
    ...
    public static String formatLocationResultString(com.yedc.location.Location location) {
    ...
    public static String formatAccuracy(Context context, float accuracy) {
        ...
        return context.getString(com.yedc.strings.R.string.accuracy_m, formattedValue);
    }
}
