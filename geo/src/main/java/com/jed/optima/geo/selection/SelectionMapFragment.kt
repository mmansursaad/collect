...
import com.jed.optima.androidshared.ui.multiclicksafe.setMultiClickSafeOnClickListener
import com.jed.optima.async.Scheduler
import com.jed.optima.geo.GeoDependencyComponentProvider
import com.jed.optima.geo.databinding.SelectionMapLayoutBinding
...
class SelectionMapFragment(
    ...
    @Inject
    lateinit var externalWebPageHelper: _root_ide_package_.com.jed.optima.webpage.ExternalWebPageHelper
    ...
    override fun onAttach(context: Context) {
        ...
        _root_ide_package_.com.jed.optima.material.MaterialProgressDialogFragment.showOn(
            this,
            selectionMapData.isLoading(),
            childFragmentManager
        ) {
            _root_ide_package_.com.jed.optima.material.MaterialProgressDialogFragment()
                .also { dialog ->
