...
public final class GeoUtils {
    ...
    public static String formatLocationResultString(Location location) {
        return formatLocationResultString(new com.jed.optima.location.Location(
    ...
    public static String formatLocationResultString(com.jed.optima.location.Location location) {
    ...
    public static String formatAccuracy(Context context, float accuracy) {
        ...
        return context.getString(com.jed.optima.strings.R.string.accuracy_m, formattedValue);
    }
}
