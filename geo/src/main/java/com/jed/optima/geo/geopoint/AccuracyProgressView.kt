...
import com.jed.optima.geo.databinding.AccuracyProgressLayoutBinding
...
internal class AccuracyProgressView @JvmOverloads constructor(
    ...
    private fun getTextAndStrength(accuracy: LocationAccuracy): Pair<Int, Int> {
        return when (accuracy) {
            is LocationAccuracy.Improving -> Pair(com.jed.optima.strings.R.string.improving_accuracy, 80)
            is LocationAccuracy.Poor -> Pair(com.jed.optima.strings.R.string.poor_accuracy, 60)
            is LocationAccuracy.Unacceptable -> Pair(com.jed.optima.strings.R.string.unacceptable_accuracy, 40)
        }
    }
}
