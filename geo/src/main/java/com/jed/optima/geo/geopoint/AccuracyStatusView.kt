...
import com.jed.optima.geo.databinding.AccuracyStatusLayoutBinding
...
internal class AccuracyStatusView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, com.jed.optima.geo.R.styleable.AccuracyStatusView) {
            title = getString(com.jed.optima.geo.R.styleable.AccuracyStatusView_title) ?: ""
        }
    }
    ...
    private fun formatLocationStatus(accuracy: LocationAccuracy): String {
        val formattedAccuracy = _root_ide_package_.com.jed.optima.geo.GeoUtils.formatAccuracy(context, accuracy.value)
