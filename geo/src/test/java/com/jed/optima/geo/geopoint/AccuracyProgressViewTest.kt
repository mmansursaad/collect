...
class AccuracyProgressViewTest {
    ...
    fun `updates current accuracy`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(com.jed.optima.strings.R.string.empty_accuracy))
        )

        view.accuracy = LocationAccuracy.Improving(52f)
        assertThat(
            view.binding.currentAccuracy.text,
            equalTo(context.getString(com.jed.optima.strings.R.string.accuracy_m, "52"))
        )
    }
    ...
    fun `updates text and strength based on accuracy`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(com.jed.optima.strings.R.string.waiting_for_location))
        )
        ...
        assertThat(
            view.binding.text.text,
            equalTo(context.getString(com.jed.optima.strings.R.string.unacceptable_accuracy))
        )
        assertThat(view.binding.strength.progress, equalTo(40))

        view.accuracy = LocationAccuracy.Poor(10f)
        assertThat(view.binding.text.text, equalTo(context.getString(com.jed.optima.strings.R.string.poor_accuracy)))
        assertThat(view.binding.strength.progress, equalTo(60))

        view.accuracy = LocationAccuracy.Improving(10f)
        assertThat(view.binding.text.text, equalTo(context.getString(com.jed.optima.strings.R.string.improving_accuracy)))
