...
class GeoPolyActivityTest {
    ...
    fun setUp() {
        ...
        application.geoDependencyComponent = DaggerGeoDependencyComponent.builder()
            ...
            .geoDependencyModule(object : GeoDependencyModule() {
                ...
                override fun providesExternalWebPageHelper(): _root_ide_package_.com.jed.optima.webpage.ExternalWebPageHelper {
                    return mock()
                }
            })
            .build()
    ...
    fun testLocationTrackerLifecycle() {
        val scenario = launcherRule.launch(
            _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity::class.java
        )
        mapFragment.ready()
    ...
    fun recordButton_should_beHiddenForAutomaticMode() {
        launcherRule.launch(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity::class.java)
        mapFragment.ready()
    ...
    fun whenPolygonExtraPresent_showsPoly() {
        val intent =
            Intent(ApplicationProvider.getApplicationContext(), _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity::class.java)
        val polygon = ArrayList<MapPoint>()
        polygon.add(MapPoint(1.0, 2.0, 3.0, 4.0))
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.EXTRA_POLYGON, polygon)
        launcherRule.launch<_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity>(intent)
        mapFragment.ready()
    ...
    fun whenPolygonExtraPresent_andOutputModeIsShape_showsClosedPoly() {
        ...
        polygon.add(MapPoint(1.0, 2.0, 3.0, 4.0))
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.EXTRA_POLYGON, polygon)
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.OUTPUT_MODE_KEY, _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.OutputMode.GEOSHAPE)
        launcherRule.launch<_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity>(intent)
        mapFragment.ready()
        val polys = mapFragment.getPolyLines()
        assertThat(polys.size, equalTo(1))
    ...
    fun whenPolygonExtraPresent_andPolyIsEmpty_pressingBack_finishes() {
        ...
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.EXTRA_POLYGON, polygon)
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.OUTPUT_MODE_KEY, _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.OutputMode.GEOSHAPE)
        val scenario = launcherRule.launch<_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity>(intent)
        mapFragment.ready()
        Espresso.pressBack()
    ...
    fun buttonsShouldBeEnabledInEditableMode() {
        ...
        val intent =
            Intent(ApplicationProvider.getApplicationContext(), _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity::class.java)
        intent.putExtra(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity.EXTRA_POLYGON, polyline)
        val scenario = launcherRule.launch<_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity>(intent)
        mapFragment.ready()
        scenario.onActivity { activity: _root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity ->
    ...
    fun recreatingTheActivityWithTheLayersDialogDisplayedDoesNotCrashTheApp() {
        val scenario = launcherRule.launch(_root_ide_package_.com.jed.optima.geo.geopoly.GeoPolyActivity::class.java)
        mapFragment.ready()
