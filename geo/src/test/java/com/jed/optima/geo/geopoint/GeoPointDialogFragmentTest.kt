...
class GeoPointDialogFragmentTest {
    ...
    fun `disables save until location is available`() {
        ...
        onView(withText(com.jed.optima.strings.R.string.save)).inRoot(isDialog()).check(matches(not(isEnabled())))

        currentAccuracyLiveData.value = LocationAccuracy.Improving(5.0f)
        onView(withText(com.jed.optima.strings.R.string.save)).inRoot(isDialog()).check(matches(isEnabled()))
    }
    ...
    fun `shows accuracy threshold`() {
        ...
        onView(withText(application.getLocalizedString(com.jed.optima.strings.R.string.point_will_be_saved, _root_ide_package_.com.jed.optima.geo.GeoUtils.formatAccuracy(application, 5.0f))))
            .inRoot(isDialog())
            .perform(scrollTo())
    ...
    fun `shows and updates current accuracy`() {
        ...
        onView(withText(_root_ide_package_.com.jed.optima.geo.GeoUtils.formatAccuracy(application, 15.65f))).inRoot(isDialog())
    ...
    fun `shows and updates time elapsed`() {
        ...
        onView(withText(application.getLocalizedString(com.jed.optima.strings.R.string.time_elapsed, "00:00")))
            .inRoot(isDialog())
            .perform(scrollTo()).check(matches(isDisplayed()))

        timeElapsedLiveData.value = 62000
        onView(withText(application.getLocalizedString(com.jed.optima.strings.R.string.time_elapsed, "01:02")))
            .inRoot(isDialog())
            .perform(scrollTo()).check(matches(isDisplayed()))
    }
    ...
    fun `shows and updates satellites`() {
        ...
        onView(withText(application.getLocalizedString(com.jed.optima.strings.R.string.satellites, 0)))
            .inRoot(isDialog())
            .perform(scrollTo())
            .check(matches(isDisplayed()))
        ...
        onView(withText(application.getLocalizedString(com.jed.optima.strings.R.string.satellites, 5)))
            .inRoot(isDialog())
            .perform(scrollTo())
            .check(matches(isDisplayed()))
    }
    ...
    fun `clicking save calls forceLocation() on view model`() {
        ...
        onView(withText(com.jed.optima.strings.R.string.save)).inRoot(isDialog()).perform(click())
