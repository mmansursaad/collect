package com.yedc.geo.selection
...
import com.yedc.geo.support.Fixtures
...
class SelectionMapFragmentTest {
    ...
    fun `updates item count when items update`() {
        ...
        onView(withText(application.getString(com.yedc.strings.R.string.select_item_count, "Things", 0, 2)))
            .check(matches(isDisplayed()))

        itemsLiveData.value = emptyList()
        onView(withText(application.getString(com.yedc.strings.R.string.select_item_count, "Things", 0, 0)))
            .check(matches(isDisplayed()))
    }
    ...
    fun `shows polyline when item has multiple points`() {
        ...
        onView(withText(application.getString(com.yedc.strings.R.string.select_item_count, "Things", 0, 1)))
            .check(matches(isDisplayed()))
    }
    ...
    fun `hides new item button when showNewItemButton is false`() {
        ...
        onView(withContentDescription(com.yedc.strings.R.string.new_item)).check(matches(not(isDisplayed())))
    }
    ...
    fun `shows progress dialog when loading`() {
        ...
        launcherRule.launchInContainer(SelectionMapFragment::class.java).onFragment {
            val dialogClass = _root_ide_package_.com.yedc.material.MaterialProgressDialogFragment::class.java
