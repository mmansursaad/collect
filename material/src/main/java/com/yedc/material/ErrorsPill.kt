...
class ErrorsPill(context: Context, attrs: AttributeSet?) : MaterialPill(context, attrs) {
    ...
    private fun setup(errors: Boolean) {
        if (errors) {
            ...
            setIcon(com.yedc.icons.R.drawable.ic_baseline_rule_24)
            setText(com.yedc.strings.R.string.draft_errors)
            ...
            visibility = View.VISIBLE
            setIcon(com.yedc.icons.R.drawable.ic_baseline_check_24)
            setText(com.yedc.strings.R.string.draft_no_errors)
