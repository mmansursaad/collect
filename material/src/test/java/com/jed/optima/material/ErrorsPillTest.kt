...
class ErrorsPillTest {
    ...
    private fun assertErrorsPill() {
        ...
        assertThat(Shadows.shadowOf(errorsPill.binding.icon.drawable).createdFromResId, equalTo(com.jed.optima.icons.R.drawable.ic_baseline_rule_24))
        assertThat(errorsPill.binding.text.text, equalTo(context.getString(com.jed.optima.strings.R.string.draft_errors)))
    }

    private fun assertNoErrorsPill() {
        assertThat(errorsPill.visibility, equalTo(View.VISIBLE))
        assertThat(Shadows.shadowOf(errorsPill.binding.icon.drawable).createdFromResId, equalTo(com.jed.optima.icons.R.drawable.ic_baseline_check_24))
        assertThat(errorsPill.binding.text.text, equalTo(context.getString(com.jed.optima.strings.R.string.draft_no_errors)))
    }
}
