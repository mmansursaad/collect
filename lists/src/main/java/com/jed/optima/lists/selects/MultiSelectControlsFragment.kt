...
import com.jed.optima.lists.databinding.MultiSelectControlsLayoutBinding
...
private class MultiSelectControlsView(context: Context) :
    ...
    private fun render() {
        if (isAllSelected) {
            binding.selectAll.setText(com.jed.optima.strings.R.string.clear_all)
            binding.selectAll.setOnClickListener {
                listener?.onClearAll()
            }
        } else {
            binding.selectAll.setText(com.jed.optima.strings.R.string.select_all)
            binding.selectAll.setOnClickListener {
