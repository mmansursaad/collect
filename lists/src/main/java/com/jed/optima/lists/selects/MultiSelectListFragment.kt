...
import com.jed.optima.lists.databinding.MultiSelectListBinding
...
class MultiSelectListFragment<T, VH : MultiSelectAdapter.ViewHolder<T>>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        appBarLayout = requireActivity().findViewById(com.jed.optima.androidshared.R.id.appBarLayout)
