...
import com.yedc.lists.databinding.MultiSelectControlsLayoutBinding
...
private class MultiSelectControlsView(context: Context) :
    ...
    private fun render() {
        if (isAllSelected) {
            binding.selectAll.setText(com.yedc.strings.R.string.clear_all)
            binding.selectAll.setOnClickListener {
                listener?.onClearAll()
            }
        } else {
            binding.selectAll.setText(com.yedc.strings.R.string.select_all)
            binding.selectAll.setOnClickListener {
