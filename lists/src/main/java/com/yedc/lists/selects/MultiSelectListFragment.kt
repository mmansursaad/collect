...
import com.yedc.lists.R
import com.yedc.lists.databinding.MultiSelectListBinding
...
class MultiSelectListFragment<T, VH : MultiSelectAdapter.ViewHolder<T>>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        appBarLayout = requireActivity().findViewById(com.yedc.androidshared.R.id.appBarLayout)
