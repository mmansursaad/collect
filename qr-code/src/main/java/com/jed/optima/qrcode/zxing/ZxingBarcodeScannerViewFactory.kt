package com.jed.optima.qrcode.zxing
...
import com.jed.optima.qrcode.databinding.ZxingBarcodeScannerLayoutBinding
...
private class ZxingBarcodeScannerView(
    ...
    override fun scan(callback: (String) -> Unit) {
        ...
        if (useFrontCamera) {
            ...
            cameraSettings.requestedCameraId = _root_ide_package_.com.jed.optima.androidshared.system.CameraUtils.getFrontCameraId()
