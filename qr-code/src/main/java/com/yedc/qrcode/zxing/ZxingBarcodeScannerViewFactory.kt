...
import com.yedc.qrcode.databinding.ZxingBarcodeScannerLayoutBinding
...
private class ZxingBarcodeScannerView(
    ...
    override fun scan(callback: (String) -> Unit) {
        ...
        if (useFrontCamera) {
            ...
            cameraSettings.requestedCameraId = _root_ide_package_.com.yedc.androidshared.system.CameraUtils.getFrontCameraId()
