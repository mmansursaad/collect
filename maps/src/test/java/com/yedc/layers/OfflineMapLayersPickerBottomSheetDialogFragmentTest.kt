...
import com.yedc.androidtest.DrawableMatcher.withImageDrawable
import com.yedc.fragmentstest.FragmentScenarioLauncherRule
import com.yedc.maps.R
...
import com.yedc.testshared.RecyclerViewMatcher
import com.yedc.testshared.ViewMatchers.atPositionInRecyclerView
...
class OfflineMapLayersPickerBottomSheetDialogFragmentTest {
    ...
    private val externalWebPageHelper = mock<_root_ide_package_.com.yedc.webpage.ExternalWebPageHelper>()
    ...
    fun `clicking the 'cancel' button does not save the layer`() {
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layer1", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
    ...
    fun `clicking the 'save' button saves the layer id if any is checked`() {
        val file = TempFiles.createTempFileWithName("layer1", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION)
        ...
        Interactions.clickOn(withText("layer1${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}"))
        Interactions.clickOn(withText(string.save))
        assertThat(
            settingsProvider.getUnprotectedSettings().getString(ProjectKeys.KEY_REFERENCE_LAYER),
    ...
    fun `when layer id is saved in settings the layer it belongs to should be checked`() {
        val file1 = TempFiles.createTempFileWithName("layer1", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION)
        val file2 = TempFiles.createTempFileWithName("layer2", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION)
    ...
    fun `if there are multiple layers all of them are displayed along with the 'None' and sorted in A-Z order`() {
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layerB", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layerA", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
        ...
        onView(atPositionInRecyclerView(R.id.layers, 1, R.id.title))
            .check(matches(withText("layerA${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))

        onView(atPositionInRecyclerView(R.id.layers, 2, R.id.title))
            .check(matches(withText("layerB${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))
    }
    ...
    fun `layers are collapsed by default`() {
        ...
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layer2", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
    ...
    fun `recreating maintains expanded layers`() {
        ...
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layer3", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
    ...
    fun `clicking delete and canceling does not remove the layer`() {
        ...
        onView(atPositionInRecyclerView(R.id.layers, 0, R.id.title))
            .check(matches(withText(string.none)))
        onView(atPositionInRecyclerView(R.id.layers, 1, R.id.title))
            .check(matches(withText("layer1${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))
    ...
    fun `clicking delete and confirming removes the layer`() {
        ...
        onView(atPositionInRecyclerView(R.id.layers, 0, R.id.title))
            .check(matches(withText(string.none)))
        onView(atPositionInRecyclerView(R.id.layers, 1, R.id.title))
            .check(matches(withText("layer2${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))
    ...
    fun `deleting the selected layer changes selection to 'none' and saves it`() {
        val file = TempFiles.createTempFileWithName("layer1.${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION)
        referenceLayerRepository.addLayer(file, true)
    ...
    fun `deleting one of the layers keeps the list sorted in A-Z order`() {
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layerC", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
        referenceLayerRepository.addLayer(
            TempFiles.createTempFileWithName("layerB", _root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION), true
        )
        ...
        onView(atPositionInRecyclerView(R.id.layers, 1, R.id.title))
            .check(matches(withText("layerA${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))
        onView(atPositionInRecyclerView(R.id.layers, 2, R.id.title))
            .check(matches(withText("layerC${_root_ide_package_.com.yedc.maps.layers.MbtilesFile.FILE_EXTENSION}")))
    }
    ...
    private fun assertLayerCollapsed(position: Int) {
        onView(atPositionInRecyclerView(R.id.layers, position, R.id.arrow))
            .check(
                matches(
                    withImageDrawable(com.yedc.icons.R.drawable.ic_baseline_expand_24)
                )
            )
    ...
    private fun assertLayerExpanded(position: Int) {
        onView(atPositionInRecyclerView(R.id.layers, position, R.id.arrow))
            .check(
                matches(
                    withImageDrawable(com.yedc.icons.R.drawable.ic_baseline_collapse_24)
                )
            )
