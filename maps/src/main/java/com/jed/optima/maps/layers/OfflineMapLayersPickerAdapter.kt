...
import com.jed.optima.maps.databinding.OfflineMapLayersPickerItemBinding
import java.io.File
...
class OfflineMapLayersPickerAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (layer.isExpanded) {
            holder.binding.arrow.setImageDrawable(ContextCompat.getDrawable(holder.binding.root.context, com.jed.optima.icons.R.drawable.ic_baseline_collapse_24))
            holder.binding.path.visibility = View.VISIBLE
            holder.binding.deleteLayer.visibility = View.VISIBLE
        } else {
            holder.binding.arrow.setImageDrawable(ContextCompat.getDrawable(holder.binding.root.context, com.jed.optima.icons.R.drawable.ic_baseline_expand_24))
