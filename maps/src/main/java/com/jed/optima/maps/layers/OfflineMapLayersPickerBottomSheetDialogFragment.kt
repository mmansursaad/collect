...
import com.jed.optima.androidshared.ui.addOnClickListener
...
import com.jed.optima.lists.selects.SingleSelectViewModel
import com.jed.optima.maps.databinding.OfflineMapLayersPickerBinding
...
class OfflineMapLayersPickerBottomSheetDialogFragment(
    ...
    private val externalWebPageHelper: _root_ide_package_.com.jed.optima.webpage.ExternalWebPageHelper
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _root_ide_package_.com.jed.optima.androidshared.livedata.LiveDataUtils.zip3(
        ...
        MaterialAlertDialogBuilder(requireActivity())
            .setMessage(
                requireActivity().getLocalizedString(
                    com.jed.optima.strings.R.string.delete_layer_confirmation_message,
                    layerItem.name
                )
            )
            .setPositiveButton(com.jed.optima.strings.R.string.delete_layer) { _, _ ->
