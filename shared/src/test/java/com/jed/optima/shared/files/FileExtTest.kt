package com.jed.optima.shared.files
...
import com.jed.optima.shared.files.FileExt.listFilesRecursively
import com.jed.optima.shared.files.FileExt.sanitizedCanonicalPath
import com.jed.optima.shared.files.FileExt.saveToFile
import java.io.File
...
class FileExtTest {
    ...
    fun `sanitizedCanonicalPath returns sanitized canonicalPath if androidData path segment is incorrect`() {
        val file = mock<File>().apply {
            whenever(canonicalPath).thenReturn("/storage/emulated/0/android/Data/com.jed.optima.android/files/projects/DEMO/blah")
        }

        assertThat(file.sanitizedCanonicalPath(), equalTo("/storage/emulated/0/Android/data/com.jed.optima.android/files/projects/DEMO/blah"))
    }
