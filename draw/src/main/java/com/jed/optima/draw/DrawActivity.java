...
public class DrawActivity extends LocalizedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (OPTION_SIGNATURE.equals(loadOption)) {
            alertTitleString = getString(com.jed.optima.strings.R.string.quit_application,
                    getString(com.jed.optima.strings.R.string.sign_button));
        } else if (OPTION_ANNOTATE.equals(loadOption)) {
            alertTitleString = getString(com.jed.optima.strings.R.string.quit_application,
                    getString(com.jed.optima.strings.R.string.markup_image));
        } else {
            alertTitleString = getString(com.jed.optima.strings.R.string.quit_application,
                    getString(com.jed.optima.strings.R.string.draw_image));
        }
    ...
    private void createQuitDrawDialog() {
        int dividerHeight = getResources().getDimensionPixelSize(com.jed.optima.androidshared.R.dimen.margin_extra_small);
        ...
        items = Arrays.asList(new IconMenuListAdapter.IconMenuItem(com.jed.optima.icons.R.drawable.ic_save, com.jed.optima.strings.R.string.keep_changes),
                new IconMenuListAdapter.IconMenuItem(com.jed.optima.icons.R.drawable.ic_delete, com.jed.optima.strings.R.string.discard_changes));
        ...
        actionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (item.getTextResId() == com.jed.optima.strings.R.string.keep_changes) {
        ...
        alertDialog = new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(getString(com.jed.optima.strings.R.string.do_not_exit), null)
