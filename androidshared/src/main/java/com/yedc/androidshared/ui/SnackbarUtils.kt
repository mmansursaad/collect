...
*/
package com.yedc.androidshared.ui
            ...
            if (displayDismissButton) {
                view.findViewById<Button>(com.google.android.material.R.id.snackbar_action).let {
                    val dismissButton = ImageView(view.context).apply {
                        setImageResource(com.yedc.androidshared.R.drawable.ic_close_24)
                        setOnClickListener {
                            dismiss()
                        }
                        contentDescription =
                            context.getString(com.yedc.strings.R.string.close_snackbar)
                    }
