package com.yedc.androidshared
...
import com.yedc.androidshared.databinding.ColorPickerDialogLayoutBinding
...
class ColorPickerDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setTitle(com.yedc.strings.R.string.project_color)
            .setNegativeButton(com.yedc.strings.R.string.cancel) { _, _ -> dismiss() }
            .setPositiveButton(com.yedc.strings.R.string.ok) { _, _ -> model.pickColor("#${binding.hexColor.text}") }
            .create()
    }
    ...
    private fun updateCurrentColorCircle(color: String) {
        try {
            ...
            binding.hexColor.error = getString(com.yedc.strings.R.string.invalid_hex_code)
            (dialog as? AlertDialog)?.also {
