...
*/
package com.jed.optima.androidshared.ui
            ...
            if (displayDismissButton) {
                view.findViewById<Button>(com.google.android.material.R.id.snackbar_action).let {
                    val dismissButton = ImageView(view.context).apply {
                        setImageResource(com.jed.optima.androidshared.R.drawable.ic_close_24)
                        setOnClickListener {
                            dismiss()
                        }
                        contentDescription =
                            context.getString(com.jed.optima.strings.R.string.close_snackbar)
                    }
