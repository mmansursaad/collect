package com.jed.optima.androidshared
...
import com.jed.optima.androidshared.databinding.ColorPickerDialogLayoutBinding
...
class ColorPickerDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setTitle(com.jed.optima.strings.R.string.project_color)
            .setNegativeButton(com.jed.optima.strings.R.string.cancel) { _, _ -> dismiss() }
            .setPositiveButton(com.jed.optima.strings.R.string.ok) { _, _ -> model.pickColor("#${binding.hexColor.text}") }
            .create()
    }
    ...
    private fun updateCurrentColorCircle(color: String) {
        try {
            ...
            binding.hexColor.error = getString(com.jed.optima.strings.R.string.invalid_hex_code)
            (dialog as? AlertDialog)?.also {
