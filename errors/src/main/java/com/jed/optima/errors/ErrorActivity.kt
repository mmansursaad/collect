...
class ErrorActivity : LocalizedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getLocalizedString(com.jed.optima.strings.R.string.errors)
        val toolbar = findViewById<View>(com.jed.optima.androidshared.R.id.toolbar) as Toolbar
        setSupportActionBar(toolbar)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        findViewById<Toolbar>(com.jed.optima.androidshared.R.id.toolbar).setNavigationOnClickListener { finish() }
