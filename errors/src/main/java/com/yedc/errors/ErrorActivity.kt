...
class ErrorActivity : LocalizedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getLocalizedString(com.yedc.strings.R.string.errors)
        val toolbar = findViewById<View>(com.yedc.androidshared.R.id.toolbar) as Toolbar
        setSupportActionBar(toolbar)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        findViewById<Toolbar>(com.yedc.androidshared.R.id.toolbar).setNavigationOnClickListener { finish() }
