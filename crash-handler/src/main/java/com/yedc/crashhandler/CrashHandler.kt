    ...
    fun getCrashView(context: Context, onErrorDismissed: Runnable? = null): CrashView? {
        ...
        return if (conditionFailure != null) {
            ...
            createCrashView(context).also {
                it.setCrash(context.getString(com.yedc.strings.R.string.cant_start_app), crashMessage) {
                    processKiller.run()
                }
            }
            ...
            createCrashView(context).also {
                it.setCrash(context.getString(com.yedc.strings.R.string.crash_last_run), crashMessage) {
