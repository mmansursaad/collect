...
abstract class BaseLocationClient(protected val locationManager: LocationManager?) :
    _root_ide_package_.com.jed.optima.location.LocationClient {

    private var listener: LocationClientListener? = null
    private var priority = _root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_HIGH_ACCURACY
    ...
    protected fun getProvider(): String? {
        ...
        when (priority) {
            _root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_HIGH_ACCURACY -> {
                provider = LocationManager.GPS_PROVIDER
                backupProvider = LocationManager.NETWORK_PROVIDER
            }
            _root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_BALANCED_POWER_ACCURACY -> {
                provider = LocationManager.NETWORK_PROVIDER
                backupProvider = LocationManager.GPS_PROVIDER
            }
            _root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_LOW_POWER -> {
                provider = LocationManager.NETWORK_PROVIDER
                backupProvider = LocationManager.PASSIVE_PROVIDER
            }
            _root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_NO_POWER -> {
    ...
    override fun setPriority(priority: _root_ide_package_.com.jed.optima.location.LocationClient.Priority) {
        this.priority = priority
    }

    protected fun getPriority(): _root_ide_package_.com.jed.optima.location.LocationClient.Priority {
        return priority
    }
