...
object LocationClientProvider {
    ...
    private var testClient: _root_ide_package_.com.jed.optima.location.LocationClient? = null

    @JvmStatic
    fun getClient(application: Application): _root_ide_package_.com.jed.optima.location.LocationClient {
        return getClient(
            application,
    ...
    internal fun getClient(
        ...
        return testClient.let {
            if (it != null) {
                ...
                _root_ide_package_.com.jed.optima.location.AndroidLocationClient(context)
            }
        }
    }
     ...
     */
    fun setTestClient(testClient: _root_ide_package_.com.jed.optima.location.LocationClient?) {
