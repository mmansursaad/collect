...
private class FakeLocationClient : _root_ide_package_.com.jed.optima.location.LocationClient {
    ...
    override fun setListener(locationClientListener: _root_ide_package_.com.jed.optima.location.LocationClient.LocationClientListener?) {
