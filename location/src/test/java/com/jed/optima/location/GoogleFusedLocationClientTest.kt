...
class GoogleFusedLocationClientTest {
    ...
    private val locationListener = _root_ide_package_.com.jed.optima.location.TestLocationListener()
    ...
    fun `#stop stops location updates`() {
        val listener = _root_ide_package_.com.jed.optima.location.TestLocationListener()
    ...
    fun `#requestLocationUpdates builds location request based on passed values`() {
        client.setPriority(_root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_NO_POWER)
        ...
        verify(fusedLocationProviderClientWrapper).requestLocationUpdates(
            argThat { locationRequest: LocationRequest ->
                assertThat(locationRequest.priority, equalTo(_root_ide_package_.com.jed.optima.location.LocationClient.Priority.PRIORITY_NO_POWER.value))
