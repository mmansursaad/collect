...
private class FakeLocationClient : _root_ide_package_.com.yedc.location.LocationClient {
    ...
    override fun setListener(locationClientListener: _root_ide_package_.com.yedc.location.LocationClient.LocationClientListener?) {
