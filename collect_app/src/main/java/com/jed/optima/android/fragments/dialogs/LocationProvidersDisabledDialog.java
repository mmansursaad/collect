...
public class LocationProvidersDisabledDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setIcon(com.jed.optima.permissions.R.drawable.ic_room_24dp)
                .setTitle(com.jed.optima.strings.R.string.provider_disabled_error)
                .setMessage(com.jed.optima.strings.R.string.location_providers_disabled_dialog_message)
                .setPositiveButton(com.jed.optima.strings.R.string.go_to_settings, (dialog, id) -> {
