...
public class BearingActivity extends LocalizedActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(com.jed.optima.strings.R.string.get_bearing));
    ...
    private void setupBearingDialog() {
        ...
        bearingDialog.setTitle(getString(com.jed.optima.strings.R.string.getting_bearing));
        bearingDialog.setMessage(getString(com.jed.optima.strings.R.string.please_wait_long));
        bearingDialog.setButton(DialogInterface.BUTTON_POSITIVE,
                getString(com.jed.optima.strings.R.string.accept_bearing),
                geopointButtonListener);
        bearingDialog.setButton(DialogInterface.BUTTON_NEGATIVE,
                getString(com.jed.optima.strings.R.string.cancel_location),
                geopointButtonListener);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mAccelerometer != null && mGeomagnetic != null) {
            ...
            if (success) {
                ...
                bearingDialog.setMessage(getString(com.jed.optima.strings.R.string.direction, dir)
                        + "\n" + getString(com.jed.optima.strings.R.string.bearing, degrees));
