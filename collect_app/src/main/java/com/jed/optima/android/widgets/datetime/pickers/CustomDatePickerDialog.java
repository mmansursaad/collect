...
import com.jed.optima.android.widgets.datetime.DateTimeUtils;
import com.jed.optima.android.widgets.utilities.DateTimeWidgetUtils;
import com.jed.optima.android.widgets.viewmodels.DateTimeViewModel;
...
public abstract class CustomDatePickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(com.jed.optima.strings.R.string.select_date)
                .setView(R.layout.custom_date_picker_dialog)
                .setPositiveButton(com.jed.optima.strings.R.string.ok, (dialog, id) -> {
                ...
                .setNegativeButton(com.jed.optima.strings.R.string.cancel, (dialog, id) -> dismiss())
                .create();
    }
