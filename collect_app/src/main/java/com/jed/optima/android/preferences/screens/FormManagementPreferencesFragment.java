...
import static com.jed.optima.android.preferences.utilities.PreferencesUtils.displayDisabled;
import static com.jed.optima.settings.enums.StringIdEnumUtils.getFormUpdateMode;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_AUTOMATIC_UPDATE;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_AUTOSEND;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_CONSTRAINT_BEHAVIOR;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_FORM_UPDATE_MODE;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_GUIDANCE_HINT;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_IMAGE_SIZE;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK;
import static com.jed.optima.settings.keys.ProtectedProjectKeys.ALLOW_OTHER_WAYS_OF_EDITING_FORM;
...
import com.jed.optima.settings.enums.StringIdEnumUtils;
    ...
    private void initPref(String key) {
        ...
        if (pref != null) {
            if (key.equals(KEY_AUTOMATIC_UPDATE)) {
                ...
                pref.setEnabled(!formUpdateCheckPeriod.equals(getString(com.jed.optima.strings.R.string.never_value)));
            }
        }
    }
