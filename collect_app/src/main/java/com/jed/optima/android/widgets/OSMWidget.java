...
import com.jed.optima.android.databinding.OsmWidgetAnswerBinding;
...
public class OSMWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public OSMWidget(Context context, QuestionDetails questionDetails, WaitingForDataRegistry waitingForDataRegistry,
        ...
        if (osmFileName != null) {
            binding.launchOpenMapKitButton.setText(getContext().getString(com.jed.optima.strings.R.string.recapture_osm));
    ...
    private void launchOpenMapKit() {
        try {
            ...
            builder.setTitle(com.jed.optima.strings.R.string.alert);
            builder.setMessage(com.jed.optima.strings.R.string.install_openmapkit);
            DialogInterface.OnClickListener okClickListener = (dialog, id) -> {
                //TODO: launch to app store?
            };
            builder.setPositiveButton(getContext().getString(com.jed.optima.strings.R.string.ok), okClickListener);
    ...
    public void clearAnswer() {
        ...
        binding.osmFileHeaderText.setVisibility(View.GONE);
        binding.launchOpenMapKitButton.setText(getContext().getString(com.jed.optima.strings.R.string.capture_osm));
        widgetValueChanged();
    }
