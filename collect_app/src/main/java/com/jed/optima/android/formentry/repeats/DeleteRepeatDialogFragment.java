package com.jed.optima.android.formentry.repeats;
...
public class DeleteRepeatDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        alertDialog.setTitle(getActivity().getString(com.jed.optima.strings.R.string.delete_repeat_ask));
        alertDialog.setMessage(getActivity().getString(com.jed.optima.strings.R.string.delete_repeat_confirm, name));
        ...
        alertDialog.setButton(BUTTON_POSITIVE, getActivity().getString(com.jed.optima.strings.R.string.discard_group), quitListener);
        alertDialog.setButton(BUTTON_NEGATIVE, getActivity().getString(com.jed.optima.strings.R.string.delete_repeat_no), quitListener);
