...
public abstract class BarCodeScannerFragment extends Fragment implements BarcodeScannerView.TorchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        barcodeScannerViewContainer.setup(barcodeScannerViewFactory, requireActivity(), getViewLifecycleOwner(), isQrOnly(), getContext().getString(com.jed.optima.strings.R.string.barcode_scanner_prompt), frontCameraUsed());
        ...
        barcodeScannerViewContainer.getBarcodeScannerView().getLatestBarcode().observe(getViewLifecycleOwner(), result -> {
            ...
            try {
                ...
                ToastUtils.showShortToast(getString(com.jed.optima.strings.R.string.invalid_qrcode));
            }
        });
    ...
    private void switchFlashlight() {
        if (getString(com.jed.optima.strings.R.string.turn_on_flashlight).equals(switchFlashlightButton.getText())) {
    ...
    public void onTorchOn() {
        switchFlashlightButton.setText(com.jed.optima.strings.R.string.turn_off_flashlight);
    }

    @Override
    public void onTorchOff() {
        switchFlashlightButton.setText(com.jed.optima.strings.R.string.turn_on_flashlight);
    }
