...
public class SaveAnswerFileErrorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(requireContext())
                .setTitle(com.jed.optima.strings.R.string.error_occured)
                .setMessage(getString(com.jed.optima.strings.R.string.answer_file_copy_failed_message, formSaveViewModel.getAnswerFileError().getValue()))
