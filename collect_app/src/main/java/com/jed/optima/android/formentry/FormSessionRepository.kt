...
interface FormSessionRepository {
    ...
    fun set(id: String, formController: FormController, form: com.jed.optima.forms.Form) {
        set(id, formController, form, null)
    }

    fun set(id: String, formController: FormController, form: com.jed.optima.forms.Form, instance: com.jed.optima.forms.instances.Instance?)

    fun update(id: String, instance: com.jed.optima.forms.instances.Instance?)
}
...
data class FormSession @JvmOverloads constructor(
    ...
    val form: com.jed.optima.forms.Form,
    val instance: com.jed.optima.forms.instances.Instance? = null
)
