...
import static com.jed.optima.androidshared.system.ContextUtils.getThemeAttributeValue;
...
/**
 * @deprecated Use
 * {@link com.jed.optima.androidshared.system.ContextUtils#getThemeAttributeValue(Context, int)}
 * intead.
 */
@Deprecated
public final class ThemeUtils {
    ...
    public boolean isSystemTheme() {
        if (FeatureFlags.NO_THEME_SETTING) {
            ...
            return getPrefsTheme().equals(context.getString(com.jed.optima.strings.R.string.app_theme_system));
        }
    }
    ...
    public boolean isDarkTheme() {
        if (isSystemTheme()) {
            ...
            return theme.equals(context.getString(com.jed.optima.strings.R.string.app_theme_dark));
        }
    }
