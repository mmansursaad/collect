...
class FormEntryAccessPreferencesFragment : com.jed.optima.android.preferences.screens.BaseAdminPreferencesFragment() {
        ...
        findPreference(ProtectedProjectKeys.KEY_MOVING_BACKWARDS).onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { preference: Preference, _: Any? ->
                if ((preference as CheckBoxPreference).isChecked) {
                    com.jed.optima.android.fragments.dialogs.MovingBackwardsDialog().show(
                        requireActivity().supportFragmentManager,
                        com.jed.optima.android.fragments.dialogs.MovingBackwardsDialog.MOVING_BACKWARDS_DIALOG_TAG
                    )
                } else {
                    com.jed.optima.android.fragments.dialogs.SimpleDialog.newInstance(
                        requireActivity().getString(com.jed.optima.strings.R.string.moving_backwards_enabled_title),
                        0,
                        requireActivity().getString(com.jed.optima.strings.R.string.moving_backwards_enabled_message),
                        requireActivity().getString(com.jed.optima.strings.R.string.ok),
                        false
                    ).show(
                        requireActivity().supportFragmentManager,
                        com.jed.optima.android.fragments.dialogs.SimpleDialog.COLLECT_DIALOG_TAG
                    )
