...
import com.jed.optima.android.databinding.GeotraceQuestionBinding;
...
/**
 * GeoTraceWidget allows the user to com.jed.optima a trace of GPS points as the
...
public class GeoTraceWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (getFormEntryPrompt().isReadOnly()) {
            if (dataAvailable) {
                binding.simpleButton.setText(com.jed.optima.strings.R.string.view_line);
            } else {
                binding.simpleButton.setVisibility(View.GONE);
            }
        } else {
            if (dataAvailable) {
                binding.simpleButton.setText(com.jed.optima.strings.R.string.view_or_change_line);
            } else {
                binding.simpleButton.setText(com.jed.optima.strings.R.string.get_line);
            }
        }
    ...
    public void setData(Object answer) {
        ...
        binding.geoAnswerText.setVisibility(binding.geoAnswerText.getText().toString().isBlank() ? GONE : VISIBLE);
        binding.simpleButton.setText(answer.toString().isEmpty() ? com.jed.optima.strings.R.string.get_line : com.jed.optima.strings.R.string.view_or_change_line);
        widgetValueChanged();
    }
