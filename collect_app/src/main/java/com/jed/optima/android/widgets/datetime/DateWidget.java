...
import com.jed.optima.android.databinding.DateWidgetAnswerBinding;
...
public class DateWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public IAnswerData getAnswer() {
        return binding.dateAnswerText.getText().equals(getContext().getString(com.jed.optima.strings.R.string.no_date_selected))
                ? null
    ...
    public void clearAnswer() {
        selectedDate = DateTimeUtils.getCurrentDateTime();
        binding.dateAnswerText.setText(com.jed.optima.strings.R.string.no_date_selected);
        widgetValueChanged();
    }
