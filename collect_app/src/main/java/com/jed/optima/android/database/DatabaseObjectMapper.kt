...
import com.jed.optima.shared.PathUtils.getRelativeFilePath
import java.lang.Boolean

object DatabaseObjectMapper {

    @JvmStatic
    fun getValuesFromForm(form: com.jed.optima.forms.Form, formsPath: String): ContentValues {
    ...
    fun getFormFromCurrentCursorPosition(
        ...
        return com.jed.optima.forms.Form.Builder()
    ...
    @JvmStatic
    fun getInstanceFromValues(values: ContentValues): com.jed.optima.forms.instances.Instance? {
    ...
    @JvmStatic
    fun getInstanceFromCurrentCursorPosition(cursor: Cursor, instancesPath: String): com.jed.optima.forms.instances.Instance? {
    ...
    @JvmStatic
    fun getValuesFromInstance(instance: com.jed.optima.forms.instances.Instance, instancesPath: String): ContentValues {
        val values = ContentValues()
