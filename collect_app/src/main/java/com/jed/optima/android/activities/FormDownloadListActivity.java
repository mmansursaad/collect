...
import com.jed.optima.android.activities.viewmodels.FormDownloadListViewModel;
import com.jed.optima.android.adapters.FormDownloadListAdapter;
import com.jed.optima.android.formentry.RefreshFormListDialogFragment;
...
import com.jed.optima.android.listeners.DownloadFormsTaskListener;
import com.jed.optima.android.listeners.FormListDownloaderListener;
import com.jed.optima.android.projects.ProjectsDataService;
import com.jed.optima.android.tasks.DownloadFormListTask;
import com.jed.optima.android.tasks.DownloadFormsTask;
import com.jed.optima.android.utilities.ApplicationConstants;
import com.jed.optima.android.utilities.AuthDialogUtility;
import com.jed.optima.android.utilities.DialogUtils;
import com.jed.optima.android.utilities.WebCredentialsUtils;
import com.jed.optima.android.views.DayNightProgressDialog;
...
public class FormDownloadListActivity extends FormListActivity implements FormListDownloaderListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(com.jed.optima.strings.R.string.get_forms));
    ...
    private void downloadFormList() {
        if (!connectivityProvider.isDeviceOnline()) {
            ...
            if (viewModel.isDownloadOnlyMode()) {
                setReturnResult(false, getString(com.jed.optima.strings.R.string.no_connection), viewModel.getFormResults());
                finish();
            }
        } else {
    ...
    private void startFormsDownload(@NonNull ArrayList<ServerFormDetails> filesToDownload) {
        ...
        if (totalCount > 0) {
            ...
            ToastUtils.showShortToast(com.jed.optima.strings.R.string.noselect_error);
        }
    }
        ...
        if (exception == null) {
            ...
            for (int i = 0; i < formList.size(); i++) {
                ...
                item.put(FORMID_DISPLAY,
                        ((details.getFormVersion() == null) ? "" : (getString(com.jed.optima.strings.R.string.version) + " "
            ...
            if (exception instanceof FormSourceException.AuthRequired) {
                ...
                String dialogTitle = getString(com.jed.optima.strings.R.string.load_remote_form_error);
    ...
    private void createAlertDialog(String title, String message, final boolean shouldExit) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, getString(com.jed.optima.strings.R.string.ok), quitListener);
    ...
    private void createCancelDialog() {
        ...
        cancelDialog.setTitle(getString(com.jed.optima.strings.R.string.canceling));
        cancelDialog.setMessage(getString(com.jed.optima.strings.R.string.please_wait));
    ...
    public void progressUpdate(String currentFile, int progress, int total) {
        ...
        if (fragment != null) {
            fragment.setMessage(getString(com.jed.optima.strings.R.string.fetching_file, currentFile,
