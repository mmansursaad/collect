...
import com.jed.optima.android.logic.actions.setgeopoint.CollectSetGeopointAction;
...
public class BackgroundLocationManager implements LocationClient.LocationClientListener, LocationListener {
    ...
    public enum BackgroundLocationMessage {
        LOCATION_PREF_DISABLED(com.jed.optima.strings.R.string.background_location_disabled, true),
        PLAY_SERVICES_UNAVAILABLE(com.jed.optima.strings.R.string.google_play_services_not_available, false),
        COLLECTING_LOCATION(com.jed.optima.strings.R.string.background_location_enabled, true),
