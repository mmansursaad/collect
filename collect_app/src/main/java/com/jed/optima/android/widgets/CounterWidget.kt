...
import com.jed.optima.android.databinding.CounterWidgetBinding
...
class CounterWidget(
    ...
    override fun getAnswer(): IAnswerData? {
        return com.jed.optima.android.widgets.utilities.StringWidgetUtils.getIntegerData(value?.toString().orEmpty(), formEntryPrompt)
    }
