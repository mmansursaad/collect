...
public class ResetSettingsResultDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(com.jed.optima.strings.R.string.reset_app_state_result)
                .setMessage(message)
                .setPositiveButton(com.jed.optima.strings.R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
