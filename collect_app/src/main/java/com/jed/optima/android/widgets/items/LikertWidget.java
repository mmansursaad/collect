        ...
        try {
            ...
            if (imageFile.exists()) {
                ...
                if (b != null) {
                    ...
                    errorMsg = getContext().getString(com.jed.optima.strings.R.string.file_invalid, imageFile);

                }
            } else {
                errorMsg = getContext().getString(com.jed.optima.strings.R.string.file_missing, imageFile);
            }
            if (errorMsg != null) {
