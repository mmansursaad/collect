...
import static com.jed.optima.android.fragments.dialogs.ResetSettingsResultDialog.RESET_SETTINGS_RESULT_DIALOG_TAG;
import static com.jed.optima.android.projects.ProjectResetter.ResetAction.RESET_PREFERENCES;
...
import com.jed.optima.android.fragments.dialogs.ResetSettingsResultDialog;
            ...
            switch (action) {
                case RESET_PREFERENCES:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_settings_result),
                                context.getString(com.jed.optima.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_settings_result),
                                context.getString(com.jed.optima.strings.R.string.success)));
                    }
                    break;
                case ProjectResetter.ResetAction.RESET_INSTANCES:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_saved_forms_result),
                                context.getString(com.jed.optima.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_saved_forms_result),
                                context.getString(com.jed.optima.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_FORMS:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_blank_forms_result),
                                context.getString(com.jed.optima.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_blank_forms_result),
                                context.getString(com.jed.optima.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_CACHE:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_cache_result),
                                context.getString(com.jed.optima.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_cache_result),
                                context.getString(com.jed.optima.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_LAYERS:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_layers_result),
                                context.getString(com.jed.optima.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(com.jed.optima.strings.R.string.reset_layers_result),
                                context.getString(com.jed.optima.strings.R.string.success)));
