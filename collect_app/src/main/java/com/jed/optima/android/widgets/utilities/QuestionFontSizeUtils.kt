...
object QuestionFontSizeUtils {
    ...
    fun getQuestionFontSize(): Int {
        return try {
            val fontSize = DaggerUtils.getComponent(com.jed.optima.android.application.Collect.getInstance()).settingsProvider().getUnprotectedSettings().getString(ProjectKeys.KEY_FONT_SIZE)!!.toInt()
