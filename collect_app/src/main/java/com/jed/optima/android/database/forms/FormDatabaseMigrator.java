...
import com.jed.optima.db.sqlite.DatabaseMigrator;
import com.jed.optima.db.sqlite.SQLiteUtils;
...
import static com.jed.optima.android.database.forms.DatabaseFormColumns.DISPLAY_SUBTEXT;
...
import static com.jed.optima.android.database.forms.DatabaseFormColumns.LAST_DETECTED_FORM_VERSION_HASH;
...
import static com.jed.optima.db.sqlite.SQLiteDatabaseExt.addColumn;
...
public class FormDatabaseMigrator implements DatabaseMigrator {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion) throws SQLException {
        ...
        switch (oldVersion) {
            ...
            case 14:
                // Remember to bump the database version number in {@link com.jed.optima.android.database.DatabaseConstants}
