...
package com.jed.optima.android.upload;
...
import com.jed.optima.android.utilities.ResponseMessageParser;
...
import com.jed.optima.openrosa.http.CaseInsensitiveHeaders;
import com.jed.optima.openrosa.http.HttpHeadResult;
import com.jed.optima.openrosa.http.HttpPostResult;
    ...
    public String uploadOneSubmission(Instance instance, String urlString) throws FormUploadException {
        ...
        if (uriRemap.containsKey(submissionUri)) {
            ...
            try {
                ...
                throw new FormUploadException(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.url_error));
            }
            ...
            if (headResult.getStatusCode() == HttpsURLConnection.HTTP_UNAUTHORIZED) {
                throw new FormUploadAuthRequestedException(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.server_auth_credentials, submissionUri.getHost()),
                        submissionUri);
