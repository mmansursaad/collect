...
public class MovingBackwardsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(com.jed.optima.strings.R.string.moving_backwards_disabled_title)
                .setMessage(com.jed.optima.strings.R.string.moving_backwards_disabled_message)
                .setPositiveButton(com.jed.optima.strings.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        listener.preventOtherWaysOfEditingForm();
                    }
                })
                .setNegativeButton(com.jed.optima.strings.R.string.no, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                    }
                })
