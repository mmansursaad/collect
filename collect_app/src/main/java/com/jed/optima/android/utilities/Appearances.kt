...
object Appearances {
    ...
    fun getSanitizedAppearanceHint(fep: FormEntryPrompt): String {
        ...
        if (appearance == null) {
            ...
            appearance = com.jed.optima.android.dynamicpreload.ExternalDataUtil.SEARCH_FUNCTION_REGEX.matcher(appearance).replaceAll("")
        }
        return appearance
    }
     ...
     */
    @JvmStatic
    fun getNumberOfColumns(formEntryPrompt: FormEntryPrompt, screenUtils: com.jed.optima.androidshared.utils.ScreenUtils): Int {
        var numColumns = 1
