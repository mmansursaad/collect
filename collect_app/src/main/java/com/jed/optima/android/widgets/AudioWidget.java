...
import com.jed.optima.android.databinding.AudioWidgetAnswerBinding;
...
import static com.jed.optima.strings.format.LengthFormatterKt.formatLength;
            ...
            binding.audioPlayer.audioController.setListener(new AudioControllerView.Listener() {
                ...
                public void onRemoveClicked() {
                    new MaterialAlertDialogBuilder(getContext())
                            .setTitle(com.jed.optima.strings.R.string.delete_answer_file_question)
                            .setMessage(com.jed.optima.strings.R.string.answer_file_delete_warning)
                            .setPositiveButton(com.jed.optima.strings.R.string.delete_answer_file, (dialog, which) -> clearAnswer())
