...
class BuddhistDatePickerDialog : com.jed.optima.android.widgets.datetime.pickers.CustomDatePickerDialog() {
    ...
    private fun setUpDatePicker() {
        val buddhistDate = com.jed.optima.android.widgets.datetime.DateTimeUtils
