...
import static com.jed.optima.android.utilities.Appearances.FRONT;
...
import com.jed.optima.android.activities.ScannerWithFlashlightActivity;
import com.jed.optima.android.databinding.BarcodeWidgetAnswerBinding;
...
public class BarcodeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answer != null && !answer.isEmpty()) {
            binding.barcodeButton.setText(getContext().getString(com.jed.optima.strings.R.string.replace_barcode));
    ...
    public void clearAnswer() {
        ...
        binding.barcodeButton.setText(getContext().getString(com.jed.optima.strings.R.string.get_barcode));
        widgetValueChanged();
    ...
    private void setCameraIdIfNeeded(FormEntryPrompt prompt, IntentIntegrator intent) {
        if (Appearances.isFrontCameraAppearance(prompt)) {
            if (cameraUtils.isFrontCameraAvailable(getContext())) {
                ...
                ToastUtils.showLongToast(com.jed.optima.strings.R.string.error_front_camera_unavailable);
            }
        }
    }
}
