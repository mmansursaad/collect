...
import static com.jed.optima.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static com.jed.optima.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static com.jed.optima.android.formentry.repeats.DeleteRepeatDialogFragment.REQUEST_DELETE_REPEAT;
import static com.jed.optima.android.javarosawrapper.FormControllerExt.getGroupsForCurrentIndex;
import static com.jed.optima.android.javarosawrapper.FormControllerExt.getQuestionPrompts;
import static com.jed.optima.android.utilities.AnimationUtils.areAnimationsEnabled;
import static com.jed.optima.android.utilities.ApplicationConstants.RequestCodes;
import static com.jed.optima.android.utilities.DialogUtils.getDialog;
import static com.jed.optima.androidshared.ui.DialogFragmentUtils.showIfNotShowing;
import static com.jed.optima.androidshared.ui.ToastUtils.showLongToast;
import static com.jed.optima.androidshared.ui.ToastUtils.showShortToast;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_NAVIGATION;
import static com.jed.optima.settings.keys.ProtectedProjectKeys.KEY_MOVING_BACKWARDS;
import static com.jed.optima.strings.localization.LocalizedApplicationKt.getLocalizedString;
...
import com.jed.optima.android.audio.AMRAppender;
import com.jed.optima.android.audio.AudioControllerView;
import com.jed.optima.android.audio.AudioRecordingControllerFragment;
import com.jed.optima.android.audio.M4AAppender;
import com.jed.optima.android.dao.helpers.InstancesDaoHelper;
import com.jed.optima.android.entities.EntitiesRepositoryProvider;
import com.jed.optima.android.exception.JavaRosaException;
...
import com.jed.optima.android.formentry.BackgroundAudioViewModel;
import com.jed.optima.android.formentry.FormAnimation;
import com.jed.optima.android.formentry.FormAnimationType;
import com.jed.optima.android.formentry.FormEndView;
import com.jed.optima.android.formentry.FormEndViewModel;
import com.jed.optima.android.formentry.FormEntryMenuProvider;
import com.jed.optima.android.formentry.FormEntryViewModel;
import com.jed.optima.android.formentry.FormError;
import com.jed.optima.android.formentry.FormIndexAnimationHandler;
import com.jed.optima.android.formentry.FormIndexAnimationHandler.Direction;
import com.jed.optima.android.formentry.FormLoadingDialogFragment;
...
import com.jed.optima.android.formentry.QuitFormDialog;
import com.jed.optima.android.formentry.RecordingHandler;
import com.jed.optima.android.formentry.RecordingWarningDialogFragment;
import com.jed.optima.android.formentry.SwipeHandler;
import com.jed.optima.android.formentry.audit.AuditEvent;
import com.jed.optima.android.formentry.audit.ChangesReasonPromptDialogFragment;
import com.jed.optima.android.formentry.audit.IdentifyUserPromptDialogFragment;
import com.jed.optima.android.formentry.audit.IdentityPromptViewModel;
import com.jed.optima.android.formentry.backgroundlocation.BackgroundLocationManager;
import com.jed.optima.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import com.jed.optima.android.formentry.repeats.AddRepeatDialog;
import com.jed.optima.android.formentry.repeats.DeleteRepeatDialogFragment;
import com.jed.optima.android.formentry.saving.FormSaveViewModel;
import com.jed.optima.android.formentry.saving.SaveAnswerFileErrorDialogFragment;
import com.jed.optima.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
...
import com.jed.optima.android.fragments.MediaLoadingFragment;
import com.jed.optima.android.fragments.dialogs.LocationProvidersDisabledDialog;
import com.jed.optima.android.fragments.dialogs.NumberPickerDialog;
import com.jed.optima.android.fragments.dialogs.RankingWidgetDialog;
import com.jed.optima.android.fragments.dialogs.SelectMinimalDialog;
import com.jed.optima.android.instancemanagement.InstanceExtKt;
import com.jed.optima.android.instancemanagement.InstancesDataService;
import com.jed.optima.android.instancemanagement.LocalInstancesUseCases;
...
import com.jed.optima.android.javarosawrapper.SuccessValidationResult;
import com.jed.optima.android.javarosawrapper.ValidationResult;
import com.jed.optima.android.listeners.AdvanceToNextListener;
import com.jed.optima.android.listeners.FormLoaderListener;
import com.jed.optima.android.listeners.WidgetValueChangedListener;
import com.jed.optima.android.projects.ProjectsDataService;
import com.jed.optima.android.savepoints.SavepointListener;
import com.jed.optima.android.savepoints.SavepointTask;
...
import com.jed.optima.android.tasks.SaveFormIndexTask;
import com.jed.optima.android.utilities.ChangeLockProvider;
import com.jed.optima.android.utilities.ContentUriHelper;
import com.jed.optima.android.utilities.ControllableLifecyleOwner;
...
import com.jed.optima.android.widgets.datetime.DateTimeWidget;
import com.jed.optima.android.widgets.datetime.pickers.CustomDatePickerDialog;
import com.jed.optima.android.widgets.datetime.pickers.CustomTimePickerDialog;
...
import com.jed.optima.android.widgets.range.RangePickerDecimalWidget;
import com.jed.optima.android.widgets.range.RangePickerIntegerWidget;
import com.jed.optima.android.widgets.utilities.ExternalAppRecordingRequester;
import com.jed.optima.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import com.jed.optima.android.widgets.utilities.InternalRecordingRequester;
import com.jed.optima.android.widgets.utilities.ViewModelAudioPlayer;
...
import com.jed.optima.androidshared.system.ProcessRestoreDetector;
...
import com.jed.optima.audioclips.AudioClipViewModel;
 ...
 *
 * This class should never be started directly. Instead {@link com.jed.optima.android.external.FormUriActivity}
...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appBarLayout = findViewById(com.jed.optima.androidshared.R.id.appBarLayout);
        ...
        MaterialProgressDialogFragment.showOn(this, printerWidgetViewModel.isLoading(), getSupportFragmentManager(), () -> {
            ...
            dialog.setMessage(getLocalizedString(this, com.jed.optima.strings.R.string.loading));
            return dialog;
        });
    }
            ...
            if (session != null && session.getFile() != null) {
                recordingHandler.handle(getFormController(), session, file -> {
                    if (file != null) {
                        ...
                        String message = getString(com.jed.optima.strings.R.string.answer_file_copy_failed_message, path);
    ...
    private void handleValidationResult(ValidationResult validationResult) {
        if (validationResult instanceof FailedValidationResult failedValidationResult) {
            ...
            SnackbarUtils.showLongSnackbar(findViewById(R.id.llParent), getString(com.jed.optima.strings.R.string.success_form_validation), findViewById(R.id.buttonholder));
        }
    }
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(com.jed.optima.androidshared.R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle(getString(com.jed.optima.strings.R.string.loading_form));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        if (intent == null && requestCode != RequestCodes.DRAW_IMAGE && requestCode != RequestCodes.ANNOTATE_IMAGE
            ...
            showLongToast(getString(com.jed.optima.strings.R.string.null_intent_value));
            return;
        }
    ...
    private void loadMedia(Uri uri) {
        permissionsProvider.requestReadUriPermission(this, uri, getContentResolver(), () -> {
            ...
            progressDialog.setMessage(getString(com.jed.optima.strings.R.string.please_wait));
                ...
                if (widget instanceof WidgetDataReceiver) {
                    if (waitingForDataRegistry.isWaitingForData(widget.getFormEntryPrompt().getIndex())) {
                        try {
                            ...
                            Timber.e(e);
                            ToastUtils.showLongToast(currentViewIfODKView.getContext().getString(com.jed.optima.strings.R.string.error_attaching_binary_file,
                                    e.getMessage()));
                        }
                        set = true;
                        break;
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (!swipeHandler.beenSwiped()) {
            ...
            menu.add(0, v.getId(), 0, getString(com.jed.optima.strings.R.string.clear_answer));
            if (formController.indexContainsRepeatableGroup()) {
                menu.add(0, DELETE_REPEAT, 0, getString(com.jed.optima.strings.R.string.delete_repeat));
            }
            menu.setHeaderTitle(getString(com.jed.optima.strings.R.string.edit_prompt));
        }
    }
    ...
    private SwipeHandler.View createView(int event, boolean advancingPage) {
        ...
        switch (event) {
            ...
            default:
                ...
                try {
                    event = formController.stepToNextScreenEvent();
                    createErrorDialog(new FormError.Fatal(getString(com.jed.optima.strings.R.string.survey_internal_error)));
                } catch (JavaRosaException e) {
                    Timber.d(e);
    ...
    private void createErrorDialog(FormError error) {
        ...
        if (formError instanceof FormError.Fatal) {
            alertDialog.setTitle(getString(com.jed.optima.strings.R.string.form_cannot_be_used));
        } else {
            alertDialog.setTitle(getString(com.jed.optima.strings.R.string.error_occured));
        }
        ...
        alertDialog.setButton(BUTTON_POSITIVE, getString(com.jed.optima.strings.R.string.ok), errorListener);
        swipeHandler.setBeenSwiped(false);
        alertDialog.show();
    }
    ...
    public boolean saveForm(boolean exit, boolean complete, String updatedSaveName,
        ...
        if (current) {
            if (!formEntryViewModel.updateAnswersForScreen(getAnswers(), complete)) {
                showShortToast(com.jed.optima.strings.R.string.data_saved_error);
                return false;
            }
        }
        ...
        switch (result.getState()) {
            ...
            case SAVED:
                ...
                if (result.getRequest().viewExiting()) {
                    ...
                    showShortToast(com.jed.optima.strings.R.string.data_saved_ok);
                }
            ...
            case SAVE_ERROR:
                ...
                if (result.getMessage() != null) {
                    message = getString(com.jed.optima.strings.R.string.data_saved_error) + " "
                            + result.getMessage();
                } else {
                    message = getString(com.jed.optima.strings.R.string.data_saved_error);
                }
            ...
            case FINALIZE_ERROR:
                ...
                showLongToast(String.format(getString(com.jed.optima.strings.R.string.encryption_error_message),
                        result.getMessage()));
                finishAndReturnInstance();
                formSaveViewModel.resumeFormEntry();
                break;
    ...
    private void createClearDialog(final QuestionWidget qw) {
        alertDialog = new MaterialAlertDialogBuilder(this).create();
        alertDialog.setTitle(getString(com.jed.optima.strings.R.string.clear_answer_ask));
        ...
        alertDialog.setMessage(getString(com.jed.optima.strings.R.string.clearanswer_confirm,
                question));
        ...
        alertDialog.setCancelable(false);
        alertDialog
                .setButton(BUTTON_POSITIVE, getString(com.jed.optima.strings.R.string.discard_answer), quitListener);
        alertDialog.setButton(BUTTON_NEGATIVE, getString(com.jed.optima.strings.R.string.clear_answer_no),
                quitListener);
        alertDialog.show();
    }
    ...
    public void createLanguageDialog() {
        ...
        alertDialog = new MaterialAlertDialogBuilder(this)
                ...
                .setTitle(getString(com.jed.optima.strings.R.string.change_language))
                .setNegativeButton(getString(com.jed.optima.strings.R.string.do_not_change), null).create();
        alertDialog.show();
    }
    ...
    public void loadingComplete(FormLoaderTask task, FormDef formDef, String warningMsg) {
        ...
        if (formController != null) {
            ...
            if (hasUsedSavepoint) {
                runOnUiThread(() -> showLongToast(com.jed.optima.strings.R.string.savepoint_used));
            }
            ...
            if (formController.getInstanceFile() == null) {
                ...
                if (instanceFile != null) {
                    ...
                    showFormLoadErrorAndExit(getString(com.jed.optima.strings.R.string.loading_form_failed));
                }
            ...
            showLongToast(com.jed.optima.strings.R.string.loading_form_failed);
            exit();
        }
    }
    ...
    private void showFormLoadErrorAndExit(String errorMsg) {
        ...
        if (errorMsg != null) {
            ...
            createErrorDialog(new FormError.Fatal(getString(com.jed.optima.strings.R.string.parse_error)));
        }
    }
    ...
    public void onProgressStep(String stepMessage) {
        ...
        if (dialog != null) {
            dialog.setMessage(getString(com.jed.optima.strings.R.string.please_wait) + "\n\n" + stepMessage);
        }
    }
    ...
    public void onSavePointError(String errorMessage) {
        if (errorMessage != null && errorMessage.trim().length() > 0) {
            showLongToast(getString(com.jed.optima.strings.R.string.save_point_error, errorMessage));
        }
    }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Timber.e(e);
                        createErrorDialog(new FormError.Fatal(getString(com.jed.optima.strings.R.string.update_widgets_error)));
                    }
                }
            });
        }
