...
class FormsDataService(
    ...
    private val forms by qualifiedData(DataKeys.FORMS, emptyList<com.jed.optima.forms.Form>()) { projectId ->
    ...
    fun getForms(projectId: String): Flow<List<com.jed.optima.forms.Form>> {
        ...
        return projectDependencies.formsLock.withLock { acquiredLock ->
            if (acquiredLock) {
                ...
                val serverFormsSynchronizer =
                    com.jed.optima.android.formmanagement.matchexactly.ServerFormsSynchronizer(
...
private fun formDownloader(
    ...
    clock: Supplier<Long>
): com.jed.optima.android.formmanagement.download.ServerFormDownloader {
    return com.jed.optima.android.formmanagement.download.ServerFormDownloader(
