...
import com.jed.optima.android.databinding.ShowQrcodeFragmentBinding
...
class ShowQRCodeFragment : Fragment() {
    ...
    private fun passwordWarningClicked() {
        val items = arrayOf(
            getString(com.jed.optima.strings.R.string.admin_password),
            getString(com.jed.optima.strings.R.string.server_password)
        )
        MaterialAlertDialogBuilder(requireActivity())
            .setTitle(com.jed.optima.strings.R.string.include_password_dialog)
            .setMultiChoiceItems(
                items,
                checkedItems
            ...
            .setCancelable(false)
            .setPositiveButton(com.jed.optima.strings.R.string.generate) { dialog: DialogInterface, _: Int ->
                qrCodeViewModel.setIncludedKeys(
                    selectedPasswordKeys
                )
                dialog.dismiss()
            }
            .setNegativeButton(com.jed.optima.strings.R.string.cancel) { dialog: DialogInterface, _: Int -> dialog.dismiss() }
            .create()
            .apply {
