...
public class InstanceUploaderActivity extends LocalizedActivity implements InstanceUploaderListener,
    ...
    private void init(Bundle savedInstanceState) {
        alertMsg = getString(com.jed.optima.strings.R.string.please_wait);
    ...
    public void progressUpdate(int progress, int total) {
        alertMsg = getString(com.jed.optima.strings.R.string.sending_items, String.valueOf(progress), String.valueOf(total));
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case PROGRESS_DIALOG:
                ...
                progressDialog.setTitle(getString(com.jed.optima.strings.R.string.uploading_data));
                progressDialog.setMessage(alertMsg);
                progressDialog.setIndeterminate(true);
                progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                progressDialog.setCancelable(false);
                progressDialog.setButton(getString(com.jed.optima.strings.R.string.cancel), loadingButtonListener);
    ...
    private void createUploadInstancesResultDialog(String message) {
        String dialogTitle = getString(com.jed.optima.strings.R.string.upload_results);
        String buttonTitle = getString(com.jed.optima.strings.R.string.ok);
