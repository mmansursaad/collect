...
object ContentUriHelper {
    ...
    fun getFileExtensionFromUri(fileUri: Uri): String? {
        val mimeType = com.jed.optima.android.application.Collect.getInstance().contentResolver.getType(fileUri)
        ...
        if (extension == null || extension.isEmpty()) {
            com.jed.optima.android.application.Collect.getInstance().contentResolver.query(fileUri, null, null, null, null).use { cursor ->
