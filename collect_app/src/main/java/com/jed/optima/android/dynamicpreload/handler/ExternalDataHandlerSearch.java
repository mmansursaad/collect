...
package com.jed.optima.android.dynamicpreload.handler;
...
import com.jed.optima.android.dynamicpreload.ExternalSQLiteOpenHelper;
import com.jed.optima.android.dynamicpreload.ExternalSelectChoice;
    ...
    public Object eval(Object[] args, EvaluationContext ec) {
        ...
        try {
            ...
            try {
                ...
                Timber.e(new Error(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.ext_import_csv_missing_error, dataSetName, dataSetName)));
                c = db.query(ExternalDataUtil.EXTERNAL_DATA_TABLE_NAME, sqlColumns, selection,
