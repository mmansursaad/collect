...
import com.jed.optima.android.formmanagement.formmap.FormMapViewModel
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.setFragmentResultListener(
            ...
            if (result.containsKey(SelectionMapFragment.RESULT_SELECTED_ITEM)) {
                ...
                startActivity(FormFillingIntentFactory.newFormIntent(this, com.jed.optima.android.external.FormsContract.getUri(projectsDataService.requireCurrentProject().uuid, formId)))
            }
        }
    }
