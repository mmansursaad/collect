...
import com.jed.optima.android.audio.AudioButton;
import com.jed.optima.android.databinding.AudioVideoImageTextLabelBinding;
...
public class AudioVideoImageTextLabel extends RelativeLayout implements View.OnClickListener {
    ...
    public void setImage(@NonNull File imageFile, ImageLoader imageLoader) {
        if (imageFile.exists()) {
            ...
            binding.missingImage.setText(getContext().getString(com.jed.optima.strings.R.string.file_missing, imageFile));
        }
    }
