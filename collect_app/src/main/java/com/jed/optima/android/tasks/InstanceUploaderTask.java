...
import static com.jed.optima.android.analytics.AnalyticsEvents.SUBMISSION;
...
import com.jed.optima.android.upload.FormUploadAuthRequestedException;
import com.jed.optima.android.upload.FormUploadException;
import com.jed.optima.android.upload.InstanceServerUploader;
        ...
        for (int i = 0; i < instancesToUpload.size(); i++) {
            ...
            try {
                ...
                outcome.messagesByInstanceId.put(instance.getDbId().toString(),
                        customMessage != null ? customMessage : getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.success));
