...
interface FormController {
    ...
    fun getAuditEventLogger(): com.jed.optima.android.formentry.audit.AuditEventLogger?
     ...
     */
    fun getSubmissionMetadata(): com.jed.optima.android.javarosawrapper.InstanceMetadata?
