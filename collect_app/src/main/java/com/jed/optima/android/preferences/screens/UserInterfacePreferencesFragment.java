...
import static com.jed.optima.android.activities.ActivityUtils.startActivityAndCloseAllOthers;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_APP_LANGUAGE;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_APP_THEME;
        ...
        if (FeatureFlags.NO_THEME_SETTING) {
            ...
            if (pref != null) {
                if (!inFormEntry) {
                    ...
                    pref.setSummary(com.jed.optima.strings.R.string.setting_not_available_during_form_entry);
                }
            }
        }
    }
        ...
        if (pref != null) {
            if (!inFormEntry) {
                ...
                entries.add(0, getActivity().getResources()
                        .getString(com.jed.optima.strings.R.string.use_device_language));
