...
import com.jed.optima.android.databinding.TimeWidgetAnswerBinding;
...
public class TimeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public void clearAnswer() {
        selectedTime = DateTimeUtils.getCurrentDateTime();
        binding.timeAnswerText.setText(com.jed.optima.strings.R.string.no_time_selected);
        widgetValueChanged();
    }

    @Override
    public IAnswerData getAnswer() {
        return binding.timeAnswerText.getText().equals(getContext().getString(com.jed.optima.strings.R.string.no_time_selected))
                ? null
