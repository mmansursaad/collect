...
import com.jed.optima.android.databinding.BearingWidgetAnswerBinding;
import com.jed.optima.android.formentry.questions.QuestionDetails;
import com.jed.optima.android.widgets.utilities.StringWidgetUtils;
...
public class BearingWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answerText != null && !answerText.isEmpty()) {
            binding.bearingButton.setText(getContext().getString(com.jed.optima.strings.R.string.replace_bearing));
        }
    ...
    public void clearAnswer() {
        binding.bearingButton.setText(getContext().getString(com.jed.optima.strings.R.string.get_bearing));
    ...
    private void onButtonClick() {
        if (areSensorsAvailable()) {
            ...
            ToastUtils.showLongToast(com.jed.optima.strings.R.string.bearing_lack_of_sensors);
