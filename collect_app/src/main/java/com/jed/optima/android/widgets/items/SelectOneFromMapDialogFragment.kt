...
class SelectOneFromMapDialogFragment(private val viewModelFactory: ViewModelProvider.Factory) :
    com.jed.optima.material.MaterialFullScreenDialogFragment(), FragmentResultListener {

    @Inject
    lateinit var scheduler: Scheduler

    private val formEntryViewModel: com.jed.optima.android.formentry.FormEntryViewModel by activityViewModels { viewModelFactory }
...
internal class SelectChoicesMapData(
                        ...
                        if (withinBounds) {
                            ...
                            if (points.size == 1) {
                                ...
                                list + MappableSelectItem.MappableSelectPoint(
                                    ...
                                    point = points[0],
                                    smallIcon = if (markerSymbol.isNullOrBlank()) com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_small else com.jed.optima.icons.R.drawable.ic_map_marker_small,
                                    largeIcon = if (markerSymbol.isNullOrBlank()) com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_big else com.jed.optima.icons.R.drawable.ic_map_marker_big,
                                    color = markerColor,
                                    symbol = markerSymbol,
                                    action = IconifiedText(
                                        com.jed.optima.icons.R.drawable.ic_save,
                                        resources.getString(com.jed.optima.strings.R.string.select_item)
                                    )
                                )
    ...
    override fun getItemType(): String {
        return resources.getString(com.jed.optima.strings.R.string.choices)
    }
