package com.jed.optima.android.widgets.warnings;
...
import com.jed.optima.android.utilities.UnderlyingValuesConcat;
    ...
    private static class SpacesInUnderlyingValuesTextCreator implements WarningTextCreator {
        ...
        public String create(List<SelectChoice> invalidValues, Context context) {
            return context.getResources().getString(
                    invalidValues.size() > 1 ? com.jed.optima.strings.R.string.invalid_space_in_answer_plural : com.jed.optima.strings.R.string.invalid_space_in_answer_singular,
