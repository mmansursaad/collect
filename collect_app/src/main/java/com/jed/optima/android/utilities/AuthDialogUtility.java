...
public class AuthDialogUtility {
    ...
    public AlertDialog createDialog(final Context context,
        ...
        builder.setTitle(context.getString(com.jed.optima.strings.R.string.server_requires_auth));
        builder.setMessage(context.getString(com.jed.optima.strings.R.string.server_auth_credentials, overriddenUrl != null ? overriddenUrl : webCredentialsUtils.getServerUrlFromPreferences()));
        builder.setView(dialogView);
        String finalOverriddenUrl = overriddenUrl;
        builder.setPositiveButton(context.getString(com.jed.optima.strings.R.string.ok), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(context.getString(com.jed.optima.strings.R.string.cancel),
