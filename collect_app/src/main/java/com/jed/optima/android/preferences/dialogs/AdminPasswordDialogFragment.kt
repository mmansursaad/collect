...
import com.jed.optima.android.databinding.AdminPasswordDialogLayoutBinding
...
class AdminPasswordDialogFragment : DialogFragment() {
    ...
    @Inject
    lateinit var adminPasswordProvider: com.jed.optima.android.utilities.AdminPasswordProvider
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setTitle(getString(com.jed.optima.strings.R.string.enter_admin_password))
            .setPositiveButton(getString(com.jed.optima.strings.R.string.ok)) { _: DialogInterface?, _: Int ->
                if (adminPasswordProvider.adminPassword == binding.editText.text.toString()) {
                    ...
                    ToastUtils.showShortToast(
                        com.jed.optima.strings.R.string.admin_password_incorrect
                    )
                }
                dismiss()
            }
