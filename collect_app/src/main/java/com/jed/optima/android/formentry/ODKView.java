...
import static com.jed.optima.android.injection.DaggerUtils.getComponent;
import static com.jed.optima.android.utilities.ApplicationConstants.RequestCodes;
import static com.jed.optima.settings.keys.ProjectKeys.KEY_EXTERNAL_APP_RECORDING;
...
import com.jed.optima.android.dynamicpreload.ExternalAppsUtils;
import com.jed.optima.android.exception.ExternalParamsException;
import com.jed.optima.android.exception.JavaRosaException;
import com.jed.optima.android.formentry.media.PromptAutoplayer;
...
import com.jed.optima.android.logic.ImmutableDisplayableQuestion;
...
import com.jed.optima.android.widgets.StringWidget;
import com.jed.optima.android.widgets.WidgetFactory;
...
import com.jed.optima.android.widgets.utilities.FileRequesterImpl;
...
import com.jed.optima.android.widgets.utilities.StringRequesterImpl;
...
import com.jed.optima.audioclips.PlaybackFailedException;
...
public class ODKView extends SwipeHandler.View implements OnLongClickListener, WidgetValueChangedListener {
    ...
    private void setupAudioErrors() {
        audioPlayer.onPlaybackError(e -> {
            if (e instanceof PlaybackFailedException) {
                ...
                Toast.makeText(
                        getContext(),
                        getContext().getString(playbackFailedException.getExceptionMsg() == 0 ? com.jed.optima.strings.R.string.file_missing : com.jed.optima.strings.R.string.file_invalid, playbackFailedException.getURI()),
                        Toast.LENGTH_SHORT
                ).show();
            }
        });
    ...
    private View getDividerView() {
        ...
        int marginVertical = (int) getContext().getResources().getDimension(com.jed.optima.androidshared.R.dimen.margin_extra_small);
    ...
    private void addIntentLaunchButton(Context context, FormEntryPrompt[] questionPrompts,
        ...
        final String buttonText = (v != null) ? v : context.getString(com.jed.optima.strings.R.string.launch_app);
        ...
        launchIntentButton.setOnClickListener(view -> {
            ...
            try {
                ...
                final String errorString = (formErrorText != null) ? formErrorText : context.getString(com.jed.optima.strings.R.string.no_app);
                        ...
                        switch (prompt.getDataType()) {
                            ...
                            default:
                                throw new RuntimeException(
                                        getContext().getString(com.jed.optima.strings.R.string.ext_assign_value_error,
