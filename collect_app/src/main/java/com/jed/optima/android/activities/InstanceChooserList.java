...
import com.jed.optima.android.adapters.InstanceListCursorAdapter;
...
import com.jed.optima.android.formmanagement.drafts.BulkFinalizationViewModel;
import com.jed.optima.android.formmanagement.drafts.DraftsMenuProvider;
import com.jed.optima.android.injection.DaggerUtils;
import com.jed.optima.android.instancemanagement.FinalizeAllSnackbarPresenter;
...
public class InstanceChooserList extends AppListActivity implements AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (formMode == null || FormOpeningMode.EDIT_SAVED.equalsIgnoreCase(formMode)) {
            setTitle(getString(com.jed.optima.strings.R.string.review_data));
            editMode = true;
        } else {
            setTitle(getString(com.jed.optima.strings.R.string.view_sent_forms));
            EmptyListView emptyListView = findViewById(android.R.id.empty);
            emptyListView.setIcon(R.drawable.ic_baseline_inbox_72);
            emptyListView.setTitle(getString(com.jed.optima.strings.R.string.empty_list_of_sent_forms_title));
            emptyListView.setSubtitle(getString(com.jed.optima.strings.R.string.empty_list_of_sent_forms_subtitle));
        }
