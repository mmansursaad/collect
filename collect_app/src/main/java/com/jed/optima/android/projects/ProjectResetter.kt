...
class ProjectResetter(
    ...
    private val formsRepositoryProvider: ProjectDependencyFactory<com.jed.optima.forms.FormsRepository>,
    ...
    private fun resetPreferences() {
        com.jed.optima.android.utilities.WebCredentialsUtils.clearAllCredentials()
    ...
    private fun resetForms() {
        ...
        File(storagePaths.metaDir + File.separator + com.jed.optima.android.fastexternalitemset.ItemsetDbAdapter.DATABASE_NAME).delete()
