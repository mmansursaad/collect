...
package com.jed.optima.android.adapters;

import static com.jed.optima.android.formentry.media.FormMediaUtils.getClip;
...
import com.jed.optima.android.formentry.questions.NoButtonsItem;
...
public abstract class AbstractSelectListAdapter extends RecyclerView.Adapter<AbstractSelectListAdapter.ViewHolder>
    ...
    abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private String getErrorMsg(File imageFile) {
            return context.getString(com.jed.optima.strings.R.string.file_missing, imageFile);
        }
