...
object ImageCaptureIntentCreator {
    ...
    fun imageCaptureIntent(prompt: FormEntryPrompt, context: Context, tmpImageFilePath: String): Intent {
        ...
        val packageName = com.jed.optima.android.utilities.FormEntryPromptUtils.getAdditionalAttribute(prompt, "intent")
        if (packageName != null) {
        ...
        try {
            val uri = com.jed.optima.android.utilities.ContentUriProvider().getUriForFile(
                context,
            ...
            com.jed.optima.android.utilities.FileUtils.grantFilePermissions(intent, uri, context)
