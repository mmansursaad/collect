...
import com.jed.optima.android.widgets.utilities.RangeWidgetUtils;
...
public class RangePickerIntegerWidget extends QuestionWidget {
    ...
    public IAnswerData getAnswer() {
        return binding.widgetAnswerText.getText().toString().equals(getContext().getString(com.jed.optima.strings.R.string.no_value_selected))
                ? null
    ...
    private void setUpNullValue() {
        progress = 0;
        binding.widgetAnswerText.setText(getContext().getString(com.jed.optima.strings.R.string.no_value_selected));
        binding.widgetButton.setText(getContext().getString(com.jed.optima.strings.R.string.select_value));
    }
