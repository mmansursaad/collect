...
import static com.jed.optima.android.utilities.ViewUtils.pxFromDp;
...
import com.jed.optima.android.adapters.RankingListAdapter;
import com.jed.optima.android.fragments.viewmodels.RankingViewModel;
import com.jed.optima.android.utilities.RankingItemTouchHelperCallback;
...
public class RankingWidgetDialog extends DialogFragment {
    ...
    private NestedScrollView setUpRankingLayout() {
        ...
        float standardMargin = requireContext()
                .getResources()
                .getDimension(com.jed.optima.androidshared.R.dimen.margin_standard);
