...
import static com.jed.optima.android.analytics.AnalyticsEvents.ENCRYPT_SUBMISSION;
...
import com.jed.optima.android.exception.EncryptionException;
import com.jed.optima.android.external.InstancesContract;
import com.jed.optima.android.formentry.FormEntryUseCases;
import com.jed.optima.android.formentry.saving.FormSaver;
...
import com.jed.optima.android.utilities.EncryptionUtils;
import com.jed.optima.android.utilities.EncryptionUtils.EncryptedFormInformation;
...
public class SaveFormToDisk {
    ...
    public SaveToDiskResult saveForm(FormSaver.ProgressListener progressListener) {
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.survey_saving_validating_message));
    ...
    private Instance exportData(boolean markCompleted, FormSaver.ProgressListener progressListener, ValidationResult validationResult) throws IOException, EncryptionException {
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.survey_saving_collecting_message));
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.survey_saving_saving_message));
        ...
        if (markCompleted) {
            ...
            progressListener.onProgressUpdate(
                    getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.survey_saving_finalizing_message));
            ...
            if (formInfo != null) {
                ...
                progressListener.onProgressUpdate(
                        getLocalizedString(Collect.getInstance(), com.jed.optima.strings.R.string.survey_saving_encrypting_message));
