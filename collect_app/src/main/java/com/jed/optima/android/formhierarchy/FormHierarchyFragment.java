...
import static com.jed.optima.android.javarosawrapper.FormIndexUtils.getPreviousLevel;
import static com.jed.optima.androidshared.ui.SnackbarUtils.showLongSnackbar;
...
import com.jed.optima.android.databinding.FormHierarchyLayoutBinding;
...
import com.jed.optima.android.javarosawrapper.JavaRosaFormController;
...
public class FormHierarchyFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        MaterialProgressDialogFragment.showOn(this, formHierarchyViewModel.isEditingInstance(), getParentFragmentManager(), () -> {
            ...
            dialog.setMessage(getString(com.jed.optima.strings.R.string.preparing_form_edit));
            return dialog;
        });
    ...
    private void showOpenDraftEditDialog(Instance instance) {
        String dialogMessage = new SimpleDateFormat(
                getString(com.jed.optima.strings.R.string.newer_draft_edit_found_dialog_message),
                Locale.getDefault()
        ).format(instance.getLastStatusChangeDate());

        new MaterialAlertDialogBuilder(requireContext())
                .setTitle(com.jed.optima.strings.R.string.newer_draft_edit_found_dialog_title)
                .setMessage(dialogMessage)
                .setPositiveButton(com.jed.optima.strings.R.string.newer_draft_edit_found_dialog_positive_button, (dialog, which) -> {
                    Intent intent = FormFillingIntentFactory.editDraftFormIntent(requireContext(), currentProjectId, instance.getDbId());
                    startActivity(intent);
                    requireActivity().getOnBackPressedDispatcher().onBackPressed();
                })
                .setNegativeButton(com.jed.optima.strings.R.string.cancel, (dialog, which) -> {})
                .setCancelable(false)
                .show();
    }
    ...
    private void showOpenFinalizedEditDialog(Instance instance) {
        String dialogMessage = new SimpleDateFormat(
                getString(com.jed.optima.strings.R.string.newer_finalized_edit_found_dialog_message),
                Locale.getDefault()
        ).format(instance.getLastStatusChangeDate());

        new MaterialAlertDialogBuilder(requireContext())
                .setTitle(com.jed.optima.strings.R.string.newer_finalized_edit_found_dialog_title)
                .setMessage(dialogMessage)
                .setPositiveButton(com.jed.optima.strings.R.string.newer_finalized_edit_found_dialog_positive_button, (dialog, which) -> {
                    formHierarchyViewModel.editInstance(
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (newEdit) {
            showLongSnackbar(
                    view,
                    getString(com.jed.optima.strings.R.string.finalized_form_edit_started),
                    null,
                    null,
                    true
            );
    ...
    protected void createErrorDialog(String errorMsg) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, getString(com.jed.optima.strings.R.string.ok), errorListener);
        alertDialog.show();
    }
