        ...
        if (csvFiles != null) {
            ...
            if (externalDataMap.isNotEmpty()) {
                progressReporter.accept { resources ->
                    resources.getString(com.jed.optima.strings.R.string.survey_loading_reading_csv_message)
                }
                val externalDataReader: com.jed.optima.android.dynamicpreload.ExternalDataReader =
                    com.jed.optima.android.dynamicpreload.ExternalDataReaderImpl(
                        isCancelled,
                        progressReporter
                    )
