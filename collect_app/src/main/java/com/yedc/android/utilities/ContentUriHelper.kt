...
object ContentUriHelper {
    ...
    fun getFileExtensionFromUri(fileUri: Uri): String? {
        val mimeType = _root_ide_package_.com.yedc.android.application.Collect.getInstance().contentResolver.getType(fileUri)
        ...
        if (extension == null || extension.isEmpty()) {
            _root_ide_package_.com.yedc.android.application.Collect.getInstance().contentResolver.query(fileUri, null, null, null, null).use { cursor ->
