...
object Appearances {
    ...
    fun getSanitizedAppearanceHint(fep: FormEntryPrompt): String {
        ...
        if (appearance == null) {
            ...
            appearance = _root_ide_package_.com.yedc.android.dynamicpreload.ExternalDataUtil.SEARCH_FUNCTION_REGEX.matcher(appearance).replaceAll("")
        }
        return appearance
    }
     ...
     */
    @JvmStatic
    fun getNumberOfColumns(formEntryPrompt: FormEntryPrompt, screenUtils: com.yedc.androidshared.utils.ScreenUtils): Int {
        var numColumns = 1
