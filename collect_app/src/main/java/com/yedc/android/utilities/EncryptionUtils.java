...
import static com.yedc.android.utilities.ApplicationConstants.Namespaces.XML_OPENROSA_NAMESPACE;
...
public class EncryptionUtils {
    ...
    public static EncryptedFormInformation getEncryptedFormInformation(Uri uri, InstanceMetadata instanceMetadata) throws EncryptionException {
        ...
        if (InstancesContract.CONTENT_ITEM_TYPE.equals(Collect.getInstance().getContentResolver().getType(uri))) {
            ...
            if (instance == null) {
                String msg = getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.not_exactly_one_record_for_this_instance);
            ...
            if (forms.isEmpty() || new FormsRepositoryProvider(Collect.getInstance()).create().getAllNotDeletedByFormIdAndVersion(formId, formVersion).size() > 1) {
                String msg = getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.not_exactly_one_blank_form_for_this_form_id);
                Timber.d(msg);
                throw new EncryptionException(msg, null);
            }
        ...
        if (formId == null || formId.length() == 0) {
            String msg = getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.no_form_id_specified);
            Timber.d(msg);
            throw new EncryptionException(msg, null);
        }
        ...
        try {
            ...
            String msg = getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.phone_does_not_support_rsa);
        ...
        try {
            ...
            String msg = getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.invalid_rsa_public_key);
            Timber.d(e, "%s due to %s ", msg, e.getMessage());
            throw new EncryptionException(msg, e);
        }
