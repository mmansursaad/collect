...
import static com.yedc.androidshared.system.ContextUtils.getThemeAttributeValue;
...
/**
 * @deprecated Use
 * {@link com.yedc.androidshared.system.ContextUtils#getThemeAttributeValue(Context, int)}
 * intead.
 */
@Deprecated
public final class ThemeUtils {
    ...
    public boolean isSystemTheme() {
        if (FeatureFlags.NO_THEME_SETTING) {
            ...
            return getPrefsTheme().equals(context.getString(com.yedc.strings.R.string.app_theme_system));
        }
    }
    ...
    public boolean isDarkTheme() {
        if (isSystemTheme()) {
            ...
            return theme.equals(context.getString(com.yedc.strings.R.string.app_theme_dark));
        }
    }
