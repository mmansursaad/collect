        ...
        if (csvFiles != null) {
            ...
            if (externalDataMap.isNotEmpty()) {
                progressReporter.accept { resources ->
                    resources.getString(com.yedc.strings.R.string.survey_loading_reading_csv_message)
                }
                val externalDataReader: _root_ide_package_.com.yedc.android.dynamicpreload.ExternalDataReader =
                    _root_ide_package_.com.yedc.android.dynamicpreload.ExternalDataReaderImpl(
                        isCancelled,
                        progressReporter
                    )
