...
package com.yedc.android.dynamicpreload.handler;
...
import com.yedc.android.dynamicpreload.ExternalSQLiteOpenHelper;
import com.yedc.android.dynamicpreload.ExternalSelectChoice;
    ...
    public Object eval(Object[] args, EvaluationContext ec) {
        ...
        try {
            ...
            try {
                ...
                Timber.e(new Error(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_import_csv_missing_error, dataSetName, dataSetName)));
                c = db.query(ExternalDataUtil.EXTERNAL_DATA_TABLE_NAME, sqlColumns, selection,
