...
package com.yedc.android.dynamicpreload;
...
import com.yedc.android.exception.ExternalDataException;
import com.yedc.android.dynamicpreload.handler.ExternalDataHandlerSearch;
                    ...
                    if (xpathFuncExpr.id.name.equalsIgnoreCase(
                        ...
                        if (xpathFuncExpr.args.length == 1 || xpathFuncExpr.args.length == 4
                            ...
                            Toast.makeText(Collect.getInstance(),
                                    getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_wrong_arguments_error),
                                    Toast.LENGTH_SHORT).show();
                            Timber.i(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_wrong_arguments_error));
                            return null;
                        }
                    } else {
                        // this might mean a problem in the regex above. Unit tests required.
                        Toast.makeText(Collect.getInstance(),
                                getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_wrong_function_error, xpathFuncExpr.id.name),
                                Toast.LENGTH_SHORT).show();
                        Timber.i(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_wrong_function_error, xpathFuncExpr.id.name));
                        return null;
                    }
                } else {
                    // this might mean a problem in the regex above. Unit tests required.
                    Toast.makeText(Collect.getInstance(),
                            getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_bad_function_error, function),
                            Toast.LENGTH_SHORT).show();
                    Timber.i(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_bad_function_error, function));
                    return null;
                }
            } catch (XPathSyntaxException e) {
                Toast.makeText(Collect.getInstance(),
                        getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_generic_error, appearance),
                        Toast.LENGTH_SHORT).show();
                Timber.i(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_generic_error, appearance));
                return null;
            }
        } else {
            return null;
                ...
                if (isAnInteger(value)) {
                    ...
                    if (eval.getClass().isAssignableFrom(ArrayList.class)) {
                        ...
                        throw new ExternalDataException(
                                getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.ext_search_return_error,
