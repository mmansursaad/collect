...
import com.yedc.shared.PathUtils.getRelativeFilePath
import java.lang.Boolean

object DatabaseObjectMapper {

    @JvmStatic
    fun getValuesFromForm(form: com.yedc.forms.Form, formsPath: String): ContentValues {
    ...
    fun getFormFromCurrentCursorPosition(
        ...
        return com.yedc.forms.Form.Builder()
    ...
    @JvmStatic
    fun getInstanceFromValues(values: ContentValues): com.yedc.forms.instances.Instance? {
        return com.yedc.forms.instances.Instance.Builder()
    ...
    @JvmStatic
    fun getInstanceFromCurrentCursorPosition(cursor: Cursor, instancesPath: String): com.yedc.forms.instances.Instance? {
    ...
    @JvmStatic
    fun getValuesFromInstance(instance: com.yedc.forms.instances.Instance, instancesPath: String): ContentValues {
        val values = ContentValues()
