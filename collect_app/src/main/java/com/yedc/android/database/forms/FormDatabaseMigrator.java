...
import com.yedc.db.sqlite.DatabaseMigrator;
import com.yedc.db.sqlite.SQLiteUtils;
...
import static com.yedc.android.database.forms.DatabaseFormColumns.DISPLAY_SUBTEXT;
...
import static com.yedc.android.database.forms.DatabaseFormColumns.LAST_DETECTED_FORM_VERSION_HASH;
...
import static com.yedc.db.sqlite.SQLiteDatabaseExt.addColumn;
...
public class FormDatabaseMigrator implements DatabaseMigrator {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion) throws SQLException {
        ...
        switch (oldVersion) {
            ...
            case 14:
                // Remember to bump the database version number in {@link com.yedc.android.database.DatabaseConstants}
