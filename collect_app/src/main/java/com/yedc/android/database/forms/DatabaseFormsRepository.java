package com.yedc.android.database.forms;

import static android.provider.BaseColumns._ID;
import static com.yedc.android.database.DatabaseConstants.FORMS_TABLE_NAME;
import static com.yedc.android.database.DatabaseObjectMapper.getFormFromCurrentCursorPosition;
import static com.yedc.android.database.DatabaseObjectMapper.getValuesFromForm;
import static com.yedc.android.database.forms.DatabaseFormColumns.AUTO_DELETE;
import static com.yedc.android.database.forms.DatabaseFormColumns.AUTO_SEND;
import static com.yedc.android.database.forms.DatabaseFormColumns.BASE64_RSA_PUBLIC_KEY;
import static com.yedc.android.database.forms.DatabaseFormColumns.DATE;
import static com.yedc.android.database.forms.DatabaseFormColumns.DELETED_DATE;
import static com.yedc.android.database.forms.DatabaseFormColumns.DESCRIPTION;
import static com.yedc.android.database.forms.DatabaseFormColumns.DISPLAY_NAME;
import static com.yedc.android.database.forms.DatabaseFormColumns.USES_ENTITIES;
import static com.yedc.android.database.forms.DatabaseFormColumns.FORM_FILE_PATH;
import static com.yedc.android.database.forms.DatabaseFormColumns.FORM_MEDIA_PATH;
import static com.yedc.android.database.forms.DatabaseFormColumns.GEOMETRY_XPATH;
import static com.yedc.android.database.forms.DatabaseFormColumns.JRCACHE_FILE_PATH;
import static com.yedc.android.database.forms.DatabaseFormColumns.JR_FORM_ID;
import static com.yedc.android.database.forms.DatabaseFormColumns.JR_VERSION;
import static com.yedc.android.database.forms.DatabaseFormColumns.LANGUAGE;
import static com.yedc.android.database.forms.DatabaseFormColumns.LAST_DETECTED_ATTACHMENTS_UPDATE_DATE;
import static com.yedc.android.database.forms.DatabaseFormColumns.MD5_HASH;
import static com.yedc.android.database.forms.DatabaseFormColumns.SUBMISSION_URI;
import static com.yedc.shared.PathUtils.getRelativeFilePath;
...
import com.yedc.android.database.DatabaseConstants;
...
import com.yedc.shared.files.FileExt;
...
public class DatabaseFormsRepository implements FormsRepository {
    ...
    public Form getOneByMd5Hash(@NotNull String hash) {
        if (hash == null) {
            throw new IllegalArgumentException("Missing form hash. ODK-compatible servers must include form hashes in their form lists. Please talk to the person who asked you to com.yedc data.");
        }
