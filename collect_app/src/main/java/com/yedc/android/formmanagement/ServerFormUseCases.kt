...
import com.yedc.android.instancemanagement.autosend.getLastUpdated
import com.yedc.async.OngoingWorkListener
...
object ServerFormUseCases {
    ...
    fun copySavedFileFromPreviousFormVersionIfExists(
        ...
        val lastSavedFile: File? = formsRepository
            ...
            ?.let {
                File(it.formMediaPath, _root_ide_package_.com.yedc.android.utilities.FileUtils.LAST_SAVED_FILENAME)
            }

        if (lastSavedFile != null && lastSavedFile.exists()) {
            File(mediaDirPath).mkdir()
            _root_ide_package_.com.yedc.android.utilities.FileUtils.copyFile(lastSavedFile, File(mediaDirPath, _root_ide_package_.com.yedc.android.utilities.FileUtils.LAST_SAVED_FILENAME))
        }
    }
    ...
    fun downloadMediaFiles(
        ...
        formSource: com.yedc.forms.FormSource,
        formsRepository: com.yedc.forms.FormsRepository,
    ...
    private fun downloadMediaFile(
        ...
        _root_ide_package_.com.yedc.android.utilities.FileUtils.interuptablyWriteFile(file, tempMediaFile, tempDir, stateListener)
    }
    ...
    private fun searchForExistingMediaFile(
        currentOrLastFormVersion: com.yedc.forms.Form?,
        mediaFile: MediaFile
    ): File? {
