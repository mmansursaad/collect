...
import static com.yedc.android.formentry.media.FormMediaUtils.getClip;
import static com.yedc.android.formentry.media.FormMediaUtils.getClipID;
...
import com.yedc.android.formentry.questions.AudioVideoImageTextLabel;
import com.yedc.android.formentry.questions.NoButtonsItem;
...
public abstract class AbstractSelectListAdapter extends RecyclerView.Adapter<AbstractSelectListAdapter.ViewHolder>
    ...
    abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private String getErrorMsg(File imageFile) {
            return context.getString(com.yedc.strings.R.string.file_missing, imageFile);
        }
