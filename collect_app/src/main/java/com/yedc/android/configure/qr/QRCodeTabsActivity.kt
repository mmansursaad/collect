...
class QRCodeTabsActivity : LocalizedActivity() {
    ...
    @Inject
    lateinit var fileProvider: _root_ide_package_.com.yedc.android.utilities.FileProvider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupAppBarLayout(this, getString(com.yedc.strings.R.string.reconfigure_with_qr_code_settings_title))
    ...
    private fun setupViewPager() {
        val fragmentTitleList = arrayOf(
            getString(com.yedc.strings.R.string.scan_qr_code_fragment_title),
            getString(com.yedc.strings.R.string.view_qr_code_fragment_title)
        )
