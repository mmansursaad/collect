...
import com.yedc.android.databinding.ShowQrcodeFragmentBinding
...
class ShowQRCodeFragment : Fragment() {
    ...
    private fun passwordWarningClicked() {
        val items = arrayOf(
            getString(com.yedc.strings.R.string.admin_password),
            getString(com.yedc.strings.R.string.server_password)
        )
        MaterialAlertDialogBuilder(requireActivity())
            .setTitle(com.yedc.strings.R.string.include_password_dialog)
            .setMultiChoiceItems(
                items,
                checkedItems
            ...
            .setCancelable(false)
            .setPositiveButton(com.yedc.strings.R.string.generate) { dialog: DialogInterface, _: Int ->
                qrCodeViewModel.setIncludedKeys(
                    selectedPasswordKeys
                )
                dialog.dismiss()
            }
            .setNegativeButton(com.yedc.strings.R.string.cancel) { dialog: DialogInterface, _: Int -> dialog.dismiss() }
            .create()
            .apply {
