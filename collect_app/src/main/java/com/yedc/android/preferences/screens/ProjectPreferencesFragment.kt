...
class ProjectPreferencesFragment(private val inFormEntry: Boolean) :
    _root_ide_package_.com.yedc.android.preferences.screens.BaseProjectPreferencesFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>(PROJECT_MANAGEMENT_PREFERENCE_KEY)!!.also {
            ...
            if (inFormEntry) {
                it.isEnabled = false
                it.setSummary(com.yedc.strings.R.string.setting_not_available_during_form_entry)
            }
        }
    }
    ...
    override fun onPreferenceClick(preference: Preference): Boolean {
        if (MultiClickGuard.allowClick(javaClass.name)) {
            when (preference.key) {
                PROTOCOL_PREFERENCE_KEY -> displayPreferences(_root_ide_package_.com.yedc.android.preferences.screens.ServerPreferencesFragment())
                PROJECT_DISPLAY_PREFERENCE_KEY -> displayPreferences(ProjectDisplayPreferencesFragment())
                USER_INTERFACE_PREFERENCE_KEY -> {
                    val fragment =
                        _root_ide_package_.com.yedc.android.preferences.screens.UserInterfacePreferencesFragment()
                    fragment.arguments =
                        bundleOf(_root_ide_package_.com.yedc.android.preferences.screens.UserInterfacePreferencesFragment.ARG_IN_FORM_ENTRY to inFormEntry)
                    displayPreferences(fragment)
                }
                MAPS_PREFERENCE_KEY -> displayPreferences(MapsPreferencesFragment())
                FORM_MANAGEMENT_PREFERENCE_KEY -> displayPreferences(_root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment())
                USER_AND_DEVICE_IDENTITY_PREFERENCE_KEY -> displayPreferences(IdentityPreferencesFragment())
                EXPERIMENTAL_PREFERENCE_KEY -> displayPreferences(_root_ide_package_.com.yedc.android.preferences.screens.ExperimentalPreferencesFragment())
