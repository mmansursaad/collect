...
object Defaults {
    ...
    val unprotected: HashMap<String, Any>
        get() {
            ...
            hashMap[ProjectKeys.KEY_APP_THEME] = _root_ide_package_.com.yedc.android.application.Collect.getInstance().getString(com.yedc.strings.R.string.app_theme_system)
