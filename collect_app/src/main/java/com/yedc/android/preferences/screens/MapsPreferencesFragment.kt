...
import com.yedc.settings.keys.ProjectKeys.CATEGORY_BASEMAP
import com.yedc.settings.keys.ProjectKeys.KEY_BASEMAP_SOURCE
import com.yedc.strings.localization.getLocalizedString
import javax.inject.Inject

class MapsPreferencesFragment : _root_ide_package_.com.yedc.android.preferences.screens.BaseProjectPreferencesFragment(), Preference.OnPreferenceClickListener {
    ...
    @Inject
    lateinit var externalWebPageHelper: com.yedc.webpage.ExternalWebPageHelper
    ...
    override fun onSettingChanged(key: String) {
        ...
        if (key == ProjectKeys.KEY_REFERENCE_LAYER) {
            ...
            val cftor = _root_ide_package_.com.yedc.android.geo.MapConfiguratorProvider.getConfigurator(settingsProvider.getUnprotectedSettings().getString(key))
    ...
    private fun initBasemapSourcePref() {
        basemapSourcePref = PrefUtils.createListPref(
            requireContext(),
            KEY_BASEMAP_SOURCE,
            getString(com.yedc.strings.R.string.basemap_source),
            _root_ide_package_.com.yedc.android.geo.MapConfiguratorProvider.getLabelIds(),
            _root_ide_package_.com.yedc.android.geo.MapConfiguratorProvider.getIds(),
            settingsProvider.getUnprotectedSettings()
        )

        basemapSourcePref.setIconSpaceReserved(false)
        onBasemapSourceChanged(_root_ide_package_.com.yedc.android.geo.MapConfiguratorProvider.getConfigurator())
    }
