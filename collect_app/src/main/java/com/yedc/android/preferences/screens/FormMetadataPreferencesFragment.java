...
import static com.yedc.metadata.PropertyManager.PROPMGR_DEVICE_ID;
import static com.yedc.settings.keys.ProjectKeys.KEY_METADATA_EMAIL;
import static com.yedc.settings.keys.ProjectKeys.KEY_METADATA_PHONENUMBER;
    ...
    private void setupPrefs() {
        emailPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            ...
            if (!newValueString.isEmpty() && !Validator.isEmailAddressValid(newValueString)) {
                ToastUtils.showLongToast(com.yedc.strings.R.string.invalid_email_address);
                return false;
            }
    ...
    private class PropertyManagerPropertySummaryProvider implements Preference.SummaryProvider<EditTextPreference> {
        ...
        public CharSequence provideSummary(EditTextPreference preference) {
            ...
            if (!TextUtils.isEmpty(value)) {
                ...
                return getString(com.yedc.strings.R.string.preference_not_available);
            }
        }
    }
}
