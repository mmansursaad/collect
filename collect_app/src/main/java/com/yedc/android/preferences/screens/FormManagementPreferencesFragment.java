...
import static com.yedc.android.preferences.utilities.PreferencesUtils.displayDisabled;
import static com.yedc.settings.enums.StringIdEnumUtils.getFormUpdateMode;
import static com.yedc.settings.keys.ProjectKeys.KEY_AUTOMATIC_UPDATE;
import static com.yedc.settings.keys.ProjectKeys.KEY_AUTOSEND;
import static com.yedc.settings.keys.ProjectKeys.KEY_CONSTRAINT_BEHAVIOR;
import static com.yedc.settings.keys.ProjectKeys.KEY_FORM_UPDATE_MODE;
import static com.yedc.settings.keys.ProjectKeys.KEY_GUIDANCE_HINT;
import static com.yedc.settings.keys.ProjectKeys.KEY_IMAGE_SIZE;
import static com.yedc.settings.keys.ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK;
import static com.yedc.settings.keys.ProtectedProjectKeys.ALLOW_OTHER_WAYS_OF_EDITING_FORM;
...
import com.yedc.settings.enums.StringIdEnumUtils;
    ...
    private void initPref(String key) {
        ...
        if (pref != null) {
            if (key.equals(KEY_AUTOMATIC_UPDATE)) {
                ...
                pref.setEnabled(!formUpdateCheckPeriod.equals(getString(com.yedc.strings.R.string.never_value)));
            }
        }
    }
