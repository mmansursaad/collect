...
class ProjectPreferencesViewModel(adminPasswordProvider: _root_ide_package_.com.yedc.android.utilities.AdminPasswordProvider) : ViewModel() {
    enum class State {
    ...
    open class Factory(private val adminPasswordProvider: _root_ide_package_.com.yedc.android.utilities.AdminPasswordProvider) : ViewModelProvider.Factory {
