...
import static com.yedc.android.activities.ActivityUtils.startActivityAndCloseAllOthers;
import static com.yedc.settings.keys.ProjectKeys.KEY_APP_LANGUAGE;
import static com.yedc.settings.keys.ProjectKeys.KEY_APP_THEME;
import static com.yedc.settings.keys.ProjectKeys.KEY_FONT_SIZE;
        ...
        if (FeatureFlags.NO_THEME_SETTING) {
            ...
            if (pref != null) {
                if (!inFormEntry) {
                    ...
                    pref.setSummary(com.yedc.strings.R.string.setting_not_available_during_form_entry);
                }
            }
        }
    }
        ...
        if (pref != null) {
            if (!inFormEntry) {
                ...
                entries.add(0, getActivity().getResources()
                        .getString(com.yedc.strings.R.string.use_device_language));
