...
object QuestionAnswerProcessor {
    ...
    fun getQuestionAnswer(fep: FormEntryPrompt, context: Context, formController: FormController): String {
        ...
        if (data is DateTimeData) {
            return _root_ide_package_.com.yedc.android.widgets.utilities.DateTimeWidgetUtils.getDateTimeLabel(
                data.getValue() as Date,
                _root_ide_package_.com.yedc.android.widgets.utilities.DateTimeWidgetUtils.getDatePickerDetails(appearance),
                true,
                context
            )
        }
        ...
        if (data != null && fep.dataType == Constants.DATATYPE_TEXT && fep.question.getAdditionalAttribute(null, "query") != null) { // ItemsetWidget
            ...
            return _root_ide_package_.com.yedc.android.fastexternalitemset.ItemsetDao(
                ...
                .getItemLabel(fep.answerValue!!.displayText, formController.getMediaFolder()!!.absolutePath, language)
        }
