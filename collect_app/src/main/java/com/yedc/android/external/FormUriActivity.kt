...
import com.yedc.android.instancemanagement.InstanceDeleter
import com.yedc.android.instancemanagement.canBeEdited
import com.yedc.android.projects.ProjectsDataService
import com.yedc.android.savepoints.SavepointUseCases
...
class FormUriActivity : LocalizedActivity() {
    ...
    private fun displaySavePointRecoveryDialog(savepoint: Savepoint) {
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton(string.recover) { _, _ ->
                ...
                if (uriMimeType == _root_ide_package_.com.yedc.android.external.FormsContract.CONTENT_ITEM_TYPE) {
                    startForm(_root_ide_package_.com.yedc.android.external.FormsContract.getUri(projectsDataService.requireCurrentProject().uuid, savepoint.formDbId))
                } else {
    ...
    private fun startForm(uri: Uri) {
        ...
        openForm.launch(
            Intent(this, _root_ide_package_.com.yedc.android.activities.FormFillingActivity::class.java).apply {
...
private class FormUriViewModel(
    ...
    private fun assertValidUri(): String? {
        val isUriValid = uri?.let {
            ...
            if (uriMimeType == null) {
                ...
                uriMimeType == _root_ide_package_.com.yedc.android.external.FormsContract.CONTENT_ITEM_TYPE || uriMimeType == _root_ide_package_.com.yedc.android.external.InstancesContract.CONTENT_ITEM_TYPE
            }
        } ?: false
    ...
    private fun assertFormNotEncrypted(): String? {
        ...
        return if (uriMimeType == _root_ide_package_.com.yedc.android.external.InstancesContract.CONTENT_ITEM_TYPE) {
            val instance = instancesRepositoryProvider.create().get(ContentUriHelper.getIdFromUri(uri))
    ...
    private fun assertDoesNotUseEntitiesOrFormsUpdateNotInProgress(): String? {
        ...
        val form = if (uriMimeType == _root_ide_package_.com.yedc.android.external.FormsContract.CONTENT_ITEM_TYPE) {
    ...
    private fun canFormBeEdited(): Boolean {
        ...
        val formEditingEnabled = if (uriMimeType == _root_ide_package_.com.yedc.android.external.InstancesContract.CONTENT_ITEM_TYPE) {
            val instance = instancesRepositoryProvider.create().get(ContentUriHelper.getIdFromUri(uri))
...
private sealed class FormInspectionResult {
    ...
    data class Savepoint(val savepoint: com.yedc.forms.savepoints.Savepoint) : FormInspectionResult()
