...
import static com.yedc.android.analytics.AnalyticsEvents.ENCRYPT_SUBMISSION;
...
import com.yedc.android.exception.EncryptionException;
import com.yedc.android.external.InstancesContract;
import com.yedc.android.formentry.FormEntryUseCases;
import com.yedc.android.formentry.saving.FormSaver;
...
import com.yedc.android.utilities.EncryptionUtils;
import com.yedc.android.utilities.EncryptionUtils.EncryptedFormInformation;
...
public class SaveFormToDisk {
    ...
    public SaveToDiskResult saveForm(FormSaver.ProgressListener progressListener) {
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.survey_saving_validating_message));
    ...
    private Instance exportData(boolean markCompleted, FormSaver.ProgressListener progressListener, ValidationResult validationResult) throws IOException, EncryptionException {
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.survey_saving_collecting_message));
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.survey_saving_saving_message));
        ...
        if (markCompleted) {
            ...
            progressListener.onProgressUpdate(
                    getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.survey_saving_finalizing_message));
            ...
            if (formInfo != null) {
                ...
                progressListener.onProgressUpdate(
                        getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.survey_saving_encrypting_message));
