...
import static com.yedc.android.analytics.AnalyticsEvents.SUBMISSION;
...
import com.yedc.android.upload.FormUploadAuthRequestedException;
import com.yedc.android.upload.FormUploadException;
import com.yedc.android.upload.InstanceServerUploader;
        ...
        for (int i = 0; i < instancesToUpload.size(); i++) {
            ...
            try {
                ...
                outcome.messagesByInstanceId.put(instance.getDbId().toString(),
                        customMessage != null ? customMessage : getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.success));
