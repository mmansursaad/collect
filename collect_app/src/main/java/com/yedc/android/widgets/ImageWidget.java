...
import com.yedc.android.databinding.ImageWidgetBinding;
...
import com.yedc.selfiecamera.CaptureSelfieActivity;
...
public class ImageWidget extends BaseImageWidget {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        binding.chooseButton.setOnClickListener(v -> imageCaptureHandler.chooseImage(com.yedc.strings.R.string.choose_image));
    ...
    private void captureImage() {
        if (selfie && new CameraUtils().isFrontCameraAvailable(getContext())) {
            ...
            imageCaptureHandler.captureImage(intent, RequestCodes.MEDIA_FILE_PATH, com.yedc.strings.R.string.capture_image);
        } else {
            Intent intent = ImageCaptureIntentCreator.imageCaptureIntent(getFormEntryPrompt(), getContext(), tmpImageFilePath);
            imageCaptureHandler.captureImage(intent, RequestCodes.IMAGE_CAPTURE, com.yedc.strings.R.string.capture_image);
        }
    }
}
