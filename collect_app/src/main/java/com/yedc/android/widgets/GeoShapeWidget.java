...
import com.yedc.android.databinding.GeoshapeQuestionBinding;
...
public class GeoShapeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (getFormEntryPrompt().isReadOnly()) {
            if (dataAvailable) {
                binding.simpleButton.setText(com.yedc.strings.R.string.view_polygon);
            } else {
                binding.simpleButton.setVisibility(View.GONE);
            }
        } else {
            if (dataAvailable) {
                binding.simpleButton.setText(com.yedc.strings.R.string.view_or_change_polygon);
            } else {
                binding.simpleButton.setText(com.yedc.strings.R.string.get_polygon);
            }
        }
    ...
    public void setData(Object answer) {
        ...
        binding.geoAnswerText.setVisibility(binding.geoAnswerText.getText().toString().isBlank() ? GONE : VISIBLE);
        binding.simpleButton.setText(answer.toString().isEmpty() ? com.yedc.strings.R.string.get_polygon : com.yedc.strings.R.string.view_or_change_polygon);
        widgetValueChanged();
    }
