...
import com.yedc.android.databinding.BearingWidgetAnswerBinding;
...
public class BearingWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answerText != null && !answerText.isEmpty()) {
            binding.bearingButton.setText(getContext().getString(com.yedc.strings.R.string.replace_bearing));
        }
    ...
    public void clearAnswer() {
        binding.bearingButton.setText(getContext().getString(com.yedc.strings.R.string.get_bearing));
    ...
    private void onButtonClick() {
        if (areSensorsAvailable()) {
            ...
            ToastUtils.showLongToast(com.yedc.strings.R.string.bearing_lack_of_sensors);
