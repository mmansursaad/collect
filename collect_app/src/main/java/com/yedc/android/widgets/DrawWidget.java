...
import com.yedc.android.databinding.DrawWidgetBinding;
...
public class DrawWidget extends BaseImageWidget {
    ...
    public DrawWidget(Context context, QuestionDetails prompt, QuestionMediaManager questionMediaManager, WaitingForDataRegistry waitingForDataRegistry, String tmpImageFilePath, Dependencies dependencies) {
        ...
        imageClickHandler = new DrawImageClickHandler(DrawActivity.OPTION_DRAW, RequestCodes.DRAW_IMAGE, com.yedc.strings.R.string.draw_image);
    ...
    public void clearAnswer() {
        super.clearAnswer();
        binding.drawButton.setText(getContext().getString(com.yedc.strings.R.string.draw_image));
    }
