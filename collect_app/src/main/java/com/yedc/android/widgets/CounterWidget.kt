...
import com.yedc.android.databinding.CounterWidgetBinding
...
class CounterWidget(
    ...
    override fun getAnswer(): IAnswerData? {
        return _root_ide_package_.com.yedc.android.widgets.utilities.StringWidgetUtils.getIntegerData(value?.toString().orEmpty(), formEntryPrompt)
    }
