...
import com.yedc.android.databinding.VideoWidgetBinding;
...
public class VideoWidget extends QuestionWidget implements FileWidget, WidgetDataReceiver {
    ...
    private void captureVideo() {
        ...
        try {
            ...
            Toast.makeText(
                    getContext(),
                    getContext().getString(com.yedc.strings.R.string.activity_not_found,
                            getContext().getString(com.yedc.strings.R.string.capture_video)), Toast.LENGTH_SHORT)
                    .show();
    ...
    private void chooseVideo() {
        ...
        try {
            ...
            Toast.makeText(
                    getContext(),
                    getContext().getString(com.yedc.strings.R.string.activity_not_found,
                            getContext().getString(com.yedc.strings.R.string.choose_video)), Toast.LENGTH_SHORT)
                    .show();
