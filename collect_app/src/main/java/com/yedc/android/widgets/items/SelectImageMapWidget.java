...
import com.yedc.android.databinding.SelectImageMapWidgetAnswerBinding;
...
public abstract class SelectImageMapWidget extends QuestionWidget {
    ...
    private String getParsedSVGFile() {
        ...
        try (FileInputStream inputStream = new FileInputStream(initialFile)) {
            ...
            Timber.w(e);
            return getContext().getString(com.yedc.strings.R.string.svg_file_does_not_exist);
        }
    }
    ...
    protected void refreshSelectedItemsLabel() {
        ...
        if (!selections.isEmpty()) {
            stringBuilder
                    .append("<b>")
                    .append(getContext().getString(com.yedc.strings.R.string.selected))
                    .append("</b> ");
            for (Selection selection : selections) {
