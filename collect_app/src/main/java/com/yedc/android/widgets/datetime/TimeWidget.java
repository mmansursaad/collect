...
import com.yedc.android.databinding.TimeWidgetAnswerBinding;
...
public class TimeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public void clearAnswer() {
        selectedTime = DateTimeUtils.getCurrentDateTime();
        binding.timeAnswerText.setText(com.yedc.strings.R.string.no_time_selected);
        widgetValueChanged();
    }

    @Override
    public IAnswerData getAnswer() {
        return binding.timeAnswerText.getText().equals(getContext().getString(com.yedc.strings.R.string.no_time_selected))
                ? null
