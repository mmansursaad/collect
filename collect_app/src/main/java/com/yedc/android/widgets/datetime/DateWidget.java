...
import com.yedc.android.databinding.DateWidgetAnswerBinding;
...
public class DateWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public IAnswerData getAnswer() {
        return binding.dateAnswerText.getText().equals(getContext().getString(com.yedc.strings.R.string.no_date_selected))
                ? null
    ...
    public void clearAnswer() {
        selectedDate = DateTimeUtils.getCurrentDateTime();
        binding.dateAnswerText.setText(com.yedc.strings.R.string.no_date_selected);
        widgetValueChanged();
    }
