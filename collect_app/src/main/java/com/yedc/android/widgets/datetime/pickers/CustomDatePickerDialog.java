...
import com.yedc.android.widgets.datetime.DateTimeUtils;
import com.yedc.android.widgets.utilities.DateTimeWidgetUtils;
import com.yedc.android.widgets.viewmodels.DateTimeViewModel;
...
public abstract class CustomDatePickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(com.yedc.strings.R.string.select_date)
