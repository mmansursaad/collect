...
import com.yedc.android.databinding.GeopointQuestionBinding;
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answerToDisplay.isEmpty()) {
            if (getFormEntryPrompt().isReadOnly()) {
                ...
                binding.simpleButton.setText(com.yedc.strings.R.string.get_point);
            }
            answerText = null;
        } else {
            if (getFormEntryPrompt().isReadOnly()) {
                binding.simpleButton.setText(com.yedc.strings.R.string.view_point);
            } else {
                binding.simpleButton.setText(com.yedc.strings.R.string.view_or_change_point);
            }
