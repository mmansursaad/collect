...
import com.yedc.android.databinding.AudioWidgetAnswerBinding;
...
import com.yedc.android.widgets.interfaces.FileWidget;
...
import static com.yedc.strings.format.LengthFormatterKt.formatLength;
            ...
            binding.audioPlayer.audioController.setListener(new AudioControllerView.Listener() {
                ...
                public void onRemoveClicked() {
                    new MaterialAlertDialogBuilder(getContext())
                            .setTitle(com.yedc.strings.R.string.delete_answer_file_question)
                            .setMessage(com.yedc.strings.R.string.answer_file_delete_warning)
                            .setPositiveButton(com.yedc.strings.R.string.delete_answer_file, (dialog, which) -> clearAnswer())
