...
import com.yedc.android.databinding.SignatureWidgetBinding;
...
public class SignatureWidget extends BaseImageWidget {
    ...
    public SignatureWidget(Context context, QuestionDetails prompt, QuestionMediaManager questionMediaManager, WaitingForDataRegistry waitingForDataRegistry, String tmpImageFilePath, Dependencies dependencies) {
        ...
        imageClickHandler = new DrawImageClickHandler(DrawActivity.OPTION_SIGNATURE, RequestCodes.SIGNATURE_CAPTURE, com.yedc.strings.R.string.signature_capture);
    ...
    public void clearAnswer() {
        super.clearAnswer();
        binding.signButton.setText(getContext().getString(com.yedc.strings.R.string.sign_button));
    }
