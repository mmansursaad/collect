...
import static com.yedc.android.utilities.Appearances.FRONT;
...
import com.yedc.android.activities.ScannerWithFlashlightActivity;
import com.yedc.android.databinding.BarcodeWidgetAnswerBinding;
...
public class BarcodeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answer != null && !answer.isEmpty()) {
            binding.barcodeButton.setText(getContext().getString(com.yedc.strings.R.string.replace_barcode));
    ...
    public void clearAnswer() {
        ...
        binding.barcodeButton.setText(getContext().getString(com.yedc.strings.R.string.get_barcode));
        widgetValueChanged();
    ...
    private void setCameraIdIfNeeded(FormEntryPrompt prompt, IntentIntegrator intent) {
        if (Appearances.isFrontCameraAppearance(prompt)) {
            if (cameraUtils.isFrontCameraAvailable(getContext())) {
                ...
                ToastUtils.showLongToast(com.yedc.strings.R.string.error_front_camera_unavailable);
            }
        }
    }
}
