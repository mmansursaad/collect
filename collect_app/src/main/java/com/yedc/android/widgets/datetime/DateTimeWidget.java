...
import com.yedc.android.databinding.DateTimeWidgetAnswerBinding;
...
public class DateTimeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    private void resetAnswerFields() {
        selectedDateTime = DateTimeUtils.getCurrentDateTime();
        binding.dateWidget.dateAnswerText.setText(com.yedc.strings.R.string.no_date_selected);
        binding.timeWidget.timeAnswerText.setText(com.yedc.strings.R.string.no_time_selected);
    }
    ...
    private boolean isDateNull() {
        return binding.dateWidget.dateAnswerText.getText().equals(getContext().getString(com.yedc.strings.R.string.no_date_selected));
    }

    private boolean isTimeNull() {
        return binding.timeWidget.timeAnswerText.getText().equals(getContext().getString(com.yedc.strings.R.string.no_time_selected));
    }
}
