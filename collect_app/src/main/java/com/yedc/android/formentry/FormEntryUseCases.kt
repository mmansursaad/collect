...
import com.yedc.entities.LocalEntityUseCases
...
object FormEntryUseCases {
    ...
    ): Pair<FormDef, com.yedc.forms.Form>? {
        val form =
    ...
    fun loadFormDef(
        ...
        _root_ide_package_.com.yedc.android.utilities.FormUtils.setupReferenceManagerForForm(
    ...
    fun loadBlankForm(
        ...
        return _root_ide_package_.com.yedc.android.javarosawrapper.JavaRosaFormController(
    ...
    fun finalizeDraft(
        ...
        return if (valid) {
            ...
            instancesRepository.save(
                com.yedc.forms.instances.Instance.Builder(instance)
    ...
    private fun saveInstanceToDisk(formController: FormController) {
        ...
        _root_ide_package_.com.yedc.android.utilities.FileUtils.write(formController.getInstanceFile(), payload!!.payloadBytes)
    }
    ...
    private fun createFormDefFromCacheOrXml(xForm: File, formDefCache: FormDefCache): FormDef? {
        ...
        val lastSavedSrc = _root_ide_package_.com.yedc.android.utilities.FileUtils.getOrCreateLastSavedSrc(xForm)
    ...
    private fun importInstance(instanceFile: File, formEntryController: FormEntryController) {
        ...
        XFormParser.setAnswerResolver(_root_ide_package_.com.yedc.android.dynamicpreload.ExternalAnswerResolver())
