...
import com.yedc.android.audio.AudioButton;
import com.yedc.android.databinding.AudioVideoImageTextLabelBinding;
...
public class AudioVideoImageTextLabel extends RelativeLayout implements View.OnClickListener {
    ...
    public void setImage(@NonNull File imageFile, ImageLoader imageLoader) {
        if (imageFile.exists()) {
            ...
            binding.missingImage.setText(getContext().getString(com.yedc.strings.R.string.file_missing, imageFile));
        }
    }
