...
interface FormSessionRepository {
    ...
    fun set(id: String, formController: FormController, form: com.yedc.forms.Form) {
        set(id, formController, form, null)
    }

    fun set(id: String, formController: FormController, form: com.yedc.forms.Form, instance: com.yedc.forms.instances.Instance?)

    fun update(id: String, instance: com.yedc.forms.instances.Instance?)
}
...
data class FormSession @JvmOverloads constructor(
    ...
    val form: com.yedc.forms.Form,
    val instance: com.yedc.forms.instances.Instance? = null
)
