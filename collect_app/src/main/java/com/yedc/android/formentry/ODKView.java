...
import static com.yedc.settings.keys.ProjectKeys.KEY_EXTERNAL_APP_RECORDING;
...
import com.yedc.android.exception.ExternalParamsException;
import com.yedc.android.exception.JavaRosaException;
import com.yedc.android.formentry.media.PromptAutoplayer;
...
import com.yedc.android.logic.ImmutableDisplayableQuestion;
...
import com.yedc.android.widgets.StringWidget;
import com.yedc.android.widgets.WidgetFactory;
...
import com.yedc.android.widgets.utilities.FileRequesterImpl;
...
import com.yedc.android.widgets.utilities.StringRequesterImpl;
...
import com.yedc.audioclips.PlaybackFailedException;
...
public class ODKView extends SwipeHandler.View implements OnLongClickListener, WidgetValueChangedListener {
    ...
    private void setupAudioErrors() {
        audioPlayer.onPlaybackError(e -> {
            if (e instanceof PlaybackFailedException) {
                ...
                Toast.makeText(
                        getContext(),
                        getContext().getString(playbackFailedException.getExceptionMsg() == 0 ? com.yedc.strings.R.string.file_missing : com.yedc.strings.R.string.file_invalid, playbackFailedException.getURI()),
                        Toast.LENGTH_SHORT
                ).show();
            }
        });
    ...
    private View getDividerView() {
        ...
        int marginVertical = (int) getContext().getResources().getDimension(com.yedc.androidshared.R.dimen.margin_extra_small);
    ...
    private void addIntentLaunchButton(Context context, FormEntryPrompt[] questionPrompts,
        ...
        final String buttonText = (v != null) ? v : context.getString(com.yedc.strings.R.string.launch_app);
        ...
        launchIntentButton.setOnClickListener(view -> {
            ...
            try {
                ...
                final String errorString = (formErrorText != null) ? formErrorText : context.getString(com.yedc.strings.R.string.no_app);
                        ...
                        switch (prompt.getDataType()) {
                            ...
                            default:
                                throw new RuntimeException(
                                        getContext().getString(com.yedc.strings.R.string.ext_assign_value_error,
