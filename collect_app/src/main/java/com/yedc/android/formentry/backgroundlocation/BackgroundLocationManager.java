...
import com.yedc.android.logic.actions.setgeopoint.CollectSetGeopointAction;
...
public class BackgroundLocationManager implements LocationClient.LocationClientListener, LocationListener {
    ...
    public enum BackgroundLocationMessage {
        LOCATION_PREF_DISABLED(com.yedc.strings.R.string.background_location_disabled, true),
        PLAY_SERVICES_UNAVAILABLE(com.yedc.strings.R.string.google_play_services_not_available, false),
        COLLECTING_LOCATION(com.yedc.strings.R.string.background_location_enabled, true),
