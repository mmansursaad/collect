...
class ProjectResetter(
    ...
    private val formsRepositoryProvider: ProjectDependencyFactory<com.yedc.forms.FormsRepository>,
    ...
    private fun resetPreferences() {
        _root_ide_package_.com.yedc.android.utilities.WebCredentialsUtils.clearAllCredentials()
    ...
    private fun resetForms() {
        ...
        File(storagePaths.metaDir + File.separator + _root_ide_package_.com.yedc.android.fastexternalitemset.ItemsetDbAdapter.DATABASE_NAME).delete()
