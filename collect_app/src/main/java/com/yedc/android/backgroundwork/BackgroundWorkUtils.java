...
public final class BackgroundWorkUtils {
    ...
    public static long getPeriodInMilliseconds(String period, Context context) {
        if (period.equals(context.getString(com.yedc.strings.R.string.every_one_hour_value))) {
            return ONE_HOUR_PERIOD;
        } else if (period.equals(context.getString(com.yedc.strings.R.string.every_six_hours_value))) {
            return SIX_HOURS_PERIOD;
        } else if (period.equals(context.getString(com.yedc.strings.R.string.every_24_hours_value))) {
            return ONE_DAY_PERIOD;
        } else if (period.equals(context.getString(com.yedc.strings.R.string.every_fifteen_minutes_value))) {
