...
import com.yedc.material.ErrorsPill
...
object InstanceListItemView {
    ...
    fun setInstance(view: View, instance: com.yedc.forms.instances.Instance, shouldCheckDisabled: Boolean) {
        ...
        if (pill != null) {
            when (instance.status) {
                com.yedc.forms.instances.Instance.STATUS_INVALID, com.yedc.forms.instances.Instance.STATUS_INCOMPLETE -> pill.errors = true
                com.yedc.forms.instances.Instance.STATUS_VALID, com.yedc.forms.instances.Instance.STATUS_NEW_EDIT -> pill.errors = false
    ...
    private fun setUpSubtext(view: View, instance: com.yedc.forms.instances.Instance, context: Context) {
        val subtext = instance.getStatusDescription(context.resources)
        val formSubtitle = view.findViewById<TextView>(R.id.form_subtitle)
        formSubtitle.text = subtext
    }

    private fun setImageFromStatus(imageView: ImageView, instance: com.yedc.forms.instances.Instance) {
