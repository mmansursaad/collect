...
object LocalInstancesUseCases {
    ...
    fun createInstanceFile(
        ...
        val sanitizedFormName = _root_ide_package_.com.yedc.android.utilities.FormNameUtils.formatFilenameFromFormName(formName)
        ...
        if (_root_ide_package_.com.yedc.android.utilities.FileUtils.createFolder(instanceDir)) {
    ...
    fun editInstance(
        ...
        val actionValue = if (sourceInstance.status == com.yedc.forms.instances.Instance.STATUS_COMPLETE) {
            "finalized $formHash"
        } else {
            "sent $formHash"
        }
    ...
    private fun findLatestEditIfExists(
        ...
        instancesRepository: com.yedc.forms.instances.InstancesRepository
    ): com.yedc.forms.instances.Instance? {
    ...
    private fun cloneInstance(
        sourceInstance: com.yedc.forms.instances.Instance,
        instanceFilePath: String,
        instancesDir: String,
        instancesRepository: com.yedc.forms.instances.InstancesRepository,
        formsRepository: com.yedc.forms.FormsRepository,
        ...
        return instancesRepository.save(
            com.yedc.forms.instances.Instance.Builder(sourceInstance)
                .dbId(null)
                .status(com.yedc.forms.instances.Instance.STATUS_NEW_EDIT)
...
sealed class InstanceEditResult(val instance: com.yedc.forms.instances.Instance) {
    data class EditCompleted(val resultInstance: com.yedc.forms.instances.Instance) : InstanceEditResult(resultInstance)
    data class EditBlockedByNewerExistingEdit(val resultInstance: com.yedc.forms.instances.Instance) : InstanceEditResult(resultInstance)
}
