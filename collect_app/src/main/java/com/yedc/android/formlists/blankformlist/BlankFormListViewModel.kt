...
import com.yedc.async.flowOnBackground
...
class BlankFormListViewModel(
    ...
    fun isMatchExactlyEnabled(): Boolean {
        return generalSettings.getFormUpdateMode(application) == com.yedc.settings.enums.FormUpdateMode.MATCH_EXACTLY
    }
    ...
    private fun filterAndSortForms(
        forms: List<com.yedc.forms.Form>,
        sort: SortOrder,
        filter: String
