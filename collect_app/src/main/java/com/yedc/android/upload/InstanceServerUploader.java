...
package com.yedc.android.upload;
...
import com.yedc.android.utilities.ResponseMessageParser;
...
import com.yedc.openrosa.http.CaseInsensitiveHeaders;
import com.yedc.openrosa.http.HttpHeadResult;
import com.yedc.openrosa.http.HttpPostResult;
    ...
    public String uploadOneSubmission(Instance instance, String urlString) throws FormUploadException {
        ...
        if (uriRemap.containsKey(submissionUri)) {
            ...
            try {
                ...
                throw new FormUploadException(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.url_error));
            }
            ...
            if (headResult.getStatusCode() == HttpsURLConnection.HTTP_UNAUTHORIZED) {
                throw new FormUploadAuthRequestedException(getLocalizedString(Collect.getInstance(), com.yedc.strings.R.string.server_auth_credentials, submissionUri.getHost()),
                        submissionUri);
