...
import static com.yedc.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static com.yedc.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static com.yedc.android.formentry.repeats.DeleteRepeatDialogFragment.REQUEST_DELETE_REPEAT;
import static com.yedc.android.javarosawrapper.FormControllerExt.getGroupsForCurrentIndex;
import static com.yedc.android.javarosawrapper.FormControllerExt.getQuestionPrompts;
import static com.yedc.android.utilities.AnimationUtils.areAnimationsEnabled;
import static com.yedc.android.utilities.ApplicationConstants.RequestCodes;
import static com.yedc.android.utilities.DialogUtils.getDialog;
import static com.yedc.androidshared.ui.DialogFragmentUtils.showIfNotShowing;
import static com.yedc.androidshared.ui.ToastUtils.showLongToast;
import static com.yedc.androidshared.ui.ToastUtils.showShortToast;
import static com.yedc.settings.keys.ProjectKeys.KEY_NAVIGATION;
import static com.yedc.settings.keys.ProtectedProjectKeys.KEY_MOVING_BACKWARDS;
...
import com.yedc.android.audio.AMRAppender;
import com.yedc.android.audio.AudioControllerView;
import com.yedc.android.audio.AudioRecordingControllerFragment;
import com.yedc.android.audio.M4AAppender;
import com.yedc.android.dao.helpers.InstancesDaoHelper;
import com.yedc.android.entities.EntitiesRepositoryProvider;
import com.yedc.android.exception.JavaRosaException;
...
import com.yedc.android.formentry.BackgroundAudioViewModel;
import com.yedc.android.formentry.FormAnimation;
import com.yedc.android.formentry.FormAnimationType;
import com.yedc.android.formentry.FormEndView;
import com.yedc.android.formentry.FormEndViewModel;
import com.yedc.android.formentry.FormEntryMenuProvider;
import com.yedc.android.formentry.FormEntryViewModel;
import com.yedc.android.formentry.FormError;
import com.yedc.android.formentry.FormIndexAnimationHandler;
import com.yedc.android.formentry.FormIndexAnimationHandler.Direction;
import com.yedc.android.formentry.FormLoadingDialogFragment;
...
import com.yedc.android.formentry.QuitFormDialog;
import com.yedc.android.formentry.RecordingHandler;
import com.yedc.android.formentry.RecordingWarningDialogFragment;
import com.yedc.android.formentry.SwipeHandler;
import com.yedc.android.formentry.audit.AuditEvent;
import com.yedc.android.formentry.audit.ChangesReasonPromptDialogFragment;
import com.yedc.android.formentry.audit.IdentifyUserPromptDialogFragment;
import com.yedc.android.formentry.audit.IdentityPromptViewModel;
import com.yedc.android.formentry.backgroundlocation.BackgroundLocationManager;
import com.yedc.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import com.yedc.android.formentry.repeats.AddRepeatDialog;
import com.yedc.android.formentry.repeats.DeleteRepeatDialogFragment;
import com.yedc.android.formentry.saving.FormSaveViewModel;
import com.yedc.android.formentry.saving.SaveAnswerFileErrorDialogFragment;
import com.yedc.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
...
import com.yedc.android.fragments.MediaLoadingFragment;
import com.yedc.android.fragments.dialogs.LocationProvidersDisabledDialog;
import com.yedc.android.fragments.dialogs.NumberPickerDialog;
import com.yedc.android.fragments.dialogs.RankingWidgetDialog;
import com.yedc.android.fragments.dialogs.SelectMinimalDialog;
import com.yedc.android.instancemanagement.InstanceExtKt;
import com.yedc.android.instancemanagement.InstancesDataService;
import com.yedc.android.instancemanagement.LocalInstancesUseCases;
import com.yedc.android.instancemanagement.autosend.AutoSendSettingsProvider;
import com.yedc.android.javarosawrapper.FailedValidationResult;
...
import com.yedc.android.javarosawrapper.SuccessValidationResult;
import com.yedc.android.javarosawrapper.ValidationResult;
import com.yedc.android.listeners.AdvanceToNextListener;
import com.yedc.android.listeners.FormLoaderListener;
import com.yedc.android.listeners.WidgetValueChangedListener;
import com.yedc.android.projects.ProjectsDataService;
import com.yedc.android.savepoints.SavepointListener;
import com.yedc.android.savepoints.SavepointTask;
...
import com.yedc.android.tasks.SaveFormIndexTask;
import com.yedc.android.utilities.ChangeLockProvider;
import com.yedc.android.utilities.ContentUriHelper;
import com.yedc.android.utilities.ControllableLifecyleOwner;
...
import com.yedc.android.widgets.datetime.pickers.CustomDatePickerDialog;
import com.yedc.android.widgets.datetime.pickers.CustomTimePickerDialog;
...
import com.yedc.android.widgets.utilities.ExternalAppRecordingRequester;
import com.yedc.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import com.yedc.android.widgets.utilities.InternalRecordingRequester;
...
import com.yedc.androidshared.system.PlayServicesChecker;
import com.yedc.androidshared.system.ProcessRestoreDetector;
 ...
 *
 * This class should never be started directly. Instead {@link com.yedc.android.external.FormUriActivity}
...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appBarLayout = findViewById(com.yedc.androidshared.R.id.appBarLayout);
        ...
        MaterialProgressDialogFragment.showOn(this, printerWidgetViewModel.isLoading(), getSupportFragmentManager(), () -> {
            ...
            dialog.setMessage(getLocalizedString(this, com.yedc.strings.R.string.loading));
            return dialog;
        });
    }
            ...
            if (session != null && session.getFile() != null) {
                recordingHandler.handle(getFormController(), session, file -> {
                    if (file != null) {
                        ...
                        String message = getString(com.yedc.strings.R.string.answer_file_copy_failed_message, path);
    ...
    private void handleValidationResult(ValidationResult validationResult) {
        if (validationResult instanceof FailedValidationResult failedValidationResult) {
            ...
            SnackbarUtils.showLongSnackbar(findViewById(R.id.llParent), getString(com.yedc.strings.R.string.success_form_validation), findViewById(R.id.buttonholder));
        }
    }
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(com.yedc.androidshared.R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle(getString(com.yedc.strings.R.string.loading_form));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        if (intent == null && requestCode != RequestCodes.DRAW_IMAGE && requestCode != RequestCodes.ANNOTATE_IMAGE
            ...
            showLongToast(getString(com.yedc.strings.R.string.null_intent_value));
            return;
        }
    ...
    private void loadMedia(Uri uri) {
        permissionsProvider.requestReadUriPermission(this, uri, getContentResolver(), () -> {
            ...
            progressDialog.setMessage(getString(com.yedc.strings.R.string.please_wait));
                ...
                if (widget instanceof WidgetDataReceiver) {
                    if (waitingForDataRegistry.isWaitingForData(widget.getFormEntryPrompt().getIndex())) {
                        try {
                            ...
                            Timber.e(e);
                            ToastUtils.showLongToast(currentViewIfODKView.getContext().getString(com.yedc.strings.R.string.error_attaching_binary_file,
                                    e.getMessage()));
                        }
                        set = true;
                        break;
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (!swipeHandler.beenSwiped()) {
            ...
            menu.add(0, v.getId(), 0, getString(com.yedc.strings.R.string.clear_answer));
            if (formController.indexContainsRepeatableGroup()) {
                menu.add(0, DELETE_REPEAT, 0, getString(com.yedc.strings.R.string.delete_repeat));
            }
            menu.setHeaderTitle(getString(com.yedc.strings.R.string.edit_prompt));
        }
    }
    ...
    private SwipeHandler.View createView(int event, boolean advancingPage) {
        ...
        switch (event) {
            ...
            default:
                ...
                try {
                    event = formController.stepToNextScreenEvent();
                    createErrorDialog(new FormError.Fatal(getString(com.yedc.strings.R.string.survey_internal_error)));
                } catch (JavaRosaException e) {
                    Timber.d(e);
    ...
    private void createErrorDialog(FormError error) {
        ...
        if (formError instanceof FormError.Fatal) {
            alertDialog.setTitle(getString(com.yedc.strings.R.string.form_cannot_be_used));
        } else {
            alertDialog.setTitle(getString(com.yedc.strings.R.string.error_occured));
        }
        ...
        alertDialog.setButton(BUTTON_POSITIVE, getString(com.yedc.strings.R.string.ok), errorListener);
        swipeHandler.setBeenSwiped(false);
        alertDialog.show();
    }
    ...
    public boolean saveForm(boolean exit, boolean complete, String updatedSaveName,
        ...
        if (current) {
            if (!formEntryViewModel.updateAnswersForScreen(getAnswers(), complete)) {
                showShortToast(com.yedc.strings.R.string.data_saved_error);
                return false;
            }
        }
        ...
        switch (result.getState()) {
            ...
            case SAVED:
                ...
                if (result.getRequest().viewExiting()) {
                    ...
                    showShortToast(com.yedc.strings.R.string.data_saved_ok);
                }
            ...
            case SAVE_ERROR:
                ...
                if (result.getMessage() != null) {
                    message = getString(com.yedc.strings.R.string.data_saved_error) + " "
                            + result.getMessage();
                } else {
                    message = getString(com.yedc.strings.R.string.data_saved_error);
                }
            ...
            case FINALIZE_ERROR:
                ...
                showLongToast(String.format(getString(com.yedc.strings.R.string.encryption_error_message),
                        result.getMessage()));
                finishAndReturnInstance();
                formSaveViewModel.resumeFormEntry();
                break;
    ...
    private void createClearDialog(final QuestionWidget qw) {
        alertDialog = new MaterialAlertDialogBuilder(this).create();
        alertDialog.setTitle(getString(com.yedc.strings.R.string.clear_answer_ask));
        ...
        alertDialog.setMessage(getString(com.yedc.strings.R.string.clearanswer_confirm,
                question));
        ...
        alertDialog.setCancelable(false);
        alertDialog
                .setButton(BUTTON_POSITIVE, getString(com.yedc.strings.R.string.discard_answer), quitListener);
        alertDialog.setButton(BUTTON_NEGATIVE, getString(com.yedc.strings.R.string.clear_answer_no),
                quitListener);
        alertDialog.show();
    }
    ...
    public void createLanguageDialog() {
        ...
        alertDialog = new MaterialAlertDialogBuilder(this)
                ...
                .setTitle(getString(com.yedc.strings.R.string.change_language))
                .setNegativeButton(getString(com.yedc.strings.R.string.do_not_change), null).create();
        alertDialog.show();
    }
    ...
    public void loadingComplete(FormLoaderTask task, FormDef formDef, String warningMsg) {
        ...
        if (formController != null) {
            ...
            if (hasUsedSavepoint) {
                runOnUiThread(() -> showLongToast(com.yedc.strings.R.string.savepoint_used));
            }
            ...
            if (formController.getInstanceFile() == null) {
                ...
                if (instanceFile != null) {
                    ...
                    showFormLoadErrorAndExit(getString(com.yedc.strings.R.string.loading_form_failed));
                }
            ...
            showLongToast(com.yedc.strings.R.string.loading_form_failed);
            exit();
        }
    }
    ...
    private void showFormLoadErrorAndExit(String errorMsg) {
        ...
        if (errorMsg != null) {
            ...
            createErrorDialog(new FormError.Fatal(getString(com.yedc.strings.R.string.parse_error)));
        }
    }
    ...
    public void onProgressStep(String stepMessage) {
        ...
        if (dialog != null) {
            dialog.setMessage(getString(com.yedc.strings.R.string.please_wait) + "\n\n" + stepMessage);
        }
    }
    ...
    public void onSavePointError(String errorMessage) {
        if (errorMessage != null && errorMessage.trim().length() > 0) {
            showLongToast(getString(com.yedc.strings.R.string.save_point_error, errorMessage));
        }
    }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Timber.e(e);
                        createErrorDialog(new FormError.Fatal(getString(com.yedc.strings.R.string.update_widgets_error)));
                    }
                }
            });
        }
