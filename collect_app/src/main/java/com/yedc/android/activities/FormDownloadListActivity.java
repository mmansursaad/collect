...
import com.yedc.android.activities.viewmodels.FormDownloadListViewModel;
import com.yedc.android.adapters.FormDownloadListAdapter;
import com.yedc.android.formentry.RefreshFormListDialogFragment;
...
import com.yedc.android.listeners.DownloadFormsTaskListener;
import com.yedc.android.listeners.FormListDownloaderListener;
import com.yedc.android.projects.ProjectsDataService;
import com.yedc.android.tasks.DownloadFormListTask;
import com.yedc.android.tasks.DownloadFormsTask;
import com.yedc.android.utilities.ApplicationConstants;
import com.yedc.android.utilities.AuthDialogUtility;
import com.yedc.android.utilities.DialogUtils;
import com.yedc.android.utilities.WebCredentialsUtils;
import com.yedc.android.views.DayNightProgressDialog;
...
public class FormDownloadListActivity extends FormListActivity implements FormListDownloaderListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(com.yedc.strings.R.string.get_forms));
    ...
    private void downloadFormList() {
        if (!connectivityProvider.isDeviceOnline()) {
            ...
            if (viewModel.isDownloadOnlyMode()) {
                setReturnResult(false, getString(com.yedc.strings.R.string.no_connection), viewModel.getFormResults());
                finish();
            }
        } else {
    ...
    private void startFormsDownload(@NonNull ArrayList<ServerFormDetails> filesToDownload) {
        ...
        if (totalCount > 0) {
            ...
            ToastUtils.showShortToast(com.yedc.strings.R.string.noselect_error);
        }
    }
        ...
        if (exception == null) {
            ...
            for (int i = 0; i < formList.size(); i++) {
                ...
                item.put(FORMID_DISPLAY,
                        ((details.getFormVersion() == null) ? "" : (getString(com.yedc.strings.R.string.version) + " "
            ...
            if (exception instanceof FormSourceException.AuthRequired) {
                ...
                String dialogTitle = getString(com.yedc.strings.R.string.load_remote_form_error);
    ...
    private void createAlertDialog(String title, String message, final boolean shouldExit) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, getString(com.yedc.strings.R.string.ok), quitListener);
    ...
    private void createCancelDialog() {
        ...
        cancelDialog.setTitle(getString(com.yedc.strings.R.string.canceling));
        cancelDialog.setMessage(getString(com.yedc.strings.R.string.please_wait));
    ...
    public void progressUpdate(String currentFile, int progress, int total) {
        ...
        if (fragment != null) {
            fragment.setMessage(getString(com.yedc.strings.R.string.fetching_file, currentFile,
