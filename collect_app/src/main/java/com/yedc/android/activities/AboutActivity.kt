...
import com.yedc.android.adapters.AboutItemClickListener
import com.yedc.android.adapters.AboutListAdapter
...
class AboutActivity : LocalizedActivity(), AboutItemClickListener {
    private val websiteTabHelper = com.yedc.webpage.ExternalWebPageHelper()
    private val forumTabHelper = com.yedc.webpage.ExternalWebPageHelper()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        websiteUri = Uri.parse(getString(com.yedc.strings.R.string.app_url))
        forumUri = Uri.parse(getString(com.yedc.strings.R.string.forum_url))
    }

    private fun initToolbar() {
        val toolbar = findViewById<Toolbar>(com.yedc.androidshared.R.id.toolbar)
        title = getString(com.yedc.strings.R.string.about_preferences)
    ...
    private fun shareApp() {
        val shareIntent = Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(
                Intent.EXTRA_TEXT,
                getString(com.yedc.strings.R.string.tell_your_friends_msg) + " " + GOOGLE_PLAY_URL + packageName
            )
        }
        startActivity(
            Intent.createChooser(
                shareIntent,
                getString(com.yedc.strings.R.string.tell_your_friends)
            )
        )
    }
    ...
    companion object {
        ...
        private val ITEMS = arrayOf(
            intArrayOf(
                ...
                com.yedc.strings.R.string.odk_website,
                com.yedc.strings.R.string.odk_website_summary
            ),
            intArrayOf(
                R.drawable.ic_outline_forum_24,
                com.yedc.strings.R.string.odk_forum,
                com.yedc.strings.R.string.odk_forum_summary
            ),
            intArrayOf(
                R.drawable.ic_outline_share_24,
                com.yedc.strings.R.string.tell_your_friends,
                com.yedc.strings.R.string.tell_your_friends_msg
            ),
            intArrayOf(
                R.drawable.ic_outline_rate_review_24,
                com.yedc.strings.R.string.leave_a_review,
                com.yedc.strings.R.string.leave_a_review_msg
            ),
            intArrayOf(
                R.drawable.ic_outline_stars_24,
                com.yedc.strings.R.string.all_open_source_licenses,
                com.yedc.strings.R.string.all_open_source_licenses_msg
            )
        )
    }
}
