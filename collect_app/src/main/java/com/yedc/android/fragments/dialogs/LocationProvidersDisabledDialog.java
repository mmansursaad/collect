...
public class LocationProvidersDisabledDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setIcon(com.yedc.permissions.R.drawable.ic_room_24dp)
                .setTitle(com.yedc.strings.R.string.provider_disabled_error)
                .setMessage(com.yedc.strings.R.string.location_providers_disabled_dialog_message)
                .setPositiveButton(com.yedc.strings.R.string.go_to_settings, (dialog, id) -> {
