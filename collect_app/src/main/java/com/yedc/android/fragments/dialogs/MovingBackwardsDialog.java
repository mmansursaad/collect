...
public class MovingBackwardsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(com.yedc.strings.R.string.moving_backwards_disabled_title)
                .setMessage(com.yedc.strings.R.string.moving_backwards_disabled_message)
                .setPositiveButton(com.yedc.strings.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        listener.preventOtherWaysOfEditingForm();
                    }
                })
                .setNegativeButton(com.yedc.strings.R.string.no, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                    }
                })
