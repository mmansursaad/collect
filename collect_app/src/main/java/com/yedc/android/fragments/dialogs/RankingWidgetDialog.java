...
import static com.yedc.android.utilities.ViewUtils.pxFromDp;
...
import com.yedc.android.adapters.RankingListAdapter;
import com.yedc.android.fragments.viewmodels.RankingViewModel;
import com.yedc.android.utilities.RankingItemTouchHelperCallback;
...
public class RankingWidgetDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(getActivity())
                ...
                .setPositiveButton(com.yedc.strings.R.string.ok, (dialog, id) -> {
                    listener.onRankingChanged(rankingListAdapter.getItems());
                    dismiss();
                })
                .setNegativeButton(com.yedc.strings.R.string.cancel, (dialog, id) -> dismiss())
                .create();
    }
    ...
    private NestedScrollView setUpRankingLayout() {
        ...
        float standardMargin = requireContext()
                .getResources()
                .getDimension(com.yedc.androidshared.R.dimen.margin_standard);
