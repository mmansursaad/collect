...
public class FormMetadataPage extends PreferencePage<FormMetadataPage> {
    ...
    public FormMetadataPage assertOnPage() {
        assertText(com.yedc.strings.R.string.form_metadata_title);
        return this;
    }

    public FormMetadataPage clickEmail() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.email))).perform(click());
        return this;
    }
    ...
    public FormMetadataPage clickPhoneNumber() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.phone_number))).perform(click());
        return this;
    }
}
