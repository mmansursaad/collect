...
import com.yedc.android.support.DummyActivityLauncher
...
class RecentAppsRule : ExternalResource() {
    ...
    fun leaveAndKillApp(appDependencyModule: _root_ide_package_.com.yedc.android.injection.config.AppDependencyModule? = null) {
