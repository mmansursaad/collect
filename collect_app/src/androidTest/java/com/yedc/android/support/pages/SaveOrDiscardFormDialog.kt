...
class SaveOrDiscardFormDialog<D : Page<D>> @JvmOverloads constructor(
    ...
    override fun assertOnPage(): SaveOrDiscardFormDialog<D> {
        if (saveAsDraftEnabled) {
            assertTextInDialog(com.yedc.strings.R.string.quit_form_title)
        } else {
            assertTextInDialog(com.yedc.strings.R.string.quit_form_continue_title)
        }
    ...
    fun clickSaveChanges(): D {
        return clickOnTextInDialog(com.yedc.strings.R.string.save_as_draft, destination)
    }

    fun clickSaveChangesWithError(errorMsg: Int): D {
        clickOnTextInDialog(com.yedc.strings.R.string.save_as_draft)
    ...
    fun clickDiscardForm(): D {
        return clickOnTextInDialog(com.yedc.strings.R.string.do_not_save, destination)
    }

    fun clickDiscardChanges(): D {
        return clickOnTextInDialog(com.yedc.strings.R.string.discard_changes, destination)
    }
}
