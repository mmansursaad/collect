...
import static com.yedc.android.support.matchers.CustomMatchers.isQuestionView;
import static com.yedc.android.support.matchers.CustomMatchers.withIndex;
...
import com.yedc.testshared.ViewActions;
...
public class FormEntryPage extends Page<FormEntryPage> {
    ...
    public FormEntryPage assertOnPage() {
        ...
        WaitFor.waitFor((Callable<Void>) () -> {
            assertTextDoesNotExist(com.yedc.strings.R.string.loading_form);
            return null;
        });
    ...
    public FormEntryPage clickOptionsIcon() {
        return clickOptionsIcon(com.yedc.strings.R.string.project_settings);
    }

    public ProjectSettingsPage clickProjectSettings() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.project_settings))).perform(click());
    ...
    public FormEntryPage deleteGroup(String questionText) {
        ...
        clickOnTextInPopup(com.yedc.strings.R.string.delete_repeat);
        clickOnTextInDialog(com.yedc.strings.R.string.discard_group, this);
        return this;
    }

    public FormEntryPage clickForwardButton() {
        closeSoftKeyboard();
        onView(withText(getTranslatedString(com.yedc.strings.R.string.form_forward))).perform(click());
        return this;
    }
    ...
    public FormEntryPage clickBackwardButton() {
        closeSoftKeyboard();
        onView(withText(getTranslatedString(com.yedc.strings.R.string.form_backward))).perform(click());
        return this;
    }
    ...
    public FormEntryPage longPressOnQuestion(String question, boolean isRequired) {
        WaitFor.tryAgainOnFail(() -> {
            ...
            assertText(com.yedc.strings.R.string.clear_answer);
        });
    ...
    public FormEntryPage removeResponse() {
        onView(withText(com.yedc.strings.R.string.clear_answer)).perform(click());
        return clickOnTextInDialog(com.yedc.strings.R.string.discard_answer, this);
    }
    ...
    public FormEntryPage assertSelectMinimalDialogAnswer(@Nullable String answer) {
        if (answer == null) {
            onView(withId(R.id.answer)).check(matches(withText(com.yedc.strings.R.string.select_answer)));
        } else {
    ...
    public OkDialog swipeToEndScreenWhileRecording() {
        ...
        assertText(com.yedc.strings.R.string.recording_warning);
        return okDialog;
    }

    public CancelRecordingDialog clickRecordAudio() {
        clickOnString(com.yedc.strings.R.string.record_audio_on);
    ...
    public FormEntryPage assertBackgroundLocationSnackbarShown() {
        onView(withId(com.google.android.material.R.id.snackbar_text))
                .check(matches(withText(String.format(ApplicationProvider.getApplicationContext().getString(com.yedc.strings.R.string.background_location_enabled), "⋮"))));
        return this;
    }
