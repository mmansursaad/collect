...
import static com.yedc.android.instancemanagement.InstanceExtKt.getInstanceIcon;
...
public class EditSavedFormPage extends Page<EditSavedFormPage> {
    ...
    public EditSavedFormPage assertOnPage() {
        assertText(com.yedc.strings.R.string.review_data);
        return this;
    }
    ...
    public BulkFinalizationConfirmationDialogPage clickFinalizeAll(int count) {
        this.clickOptionsIcon(com.yedc.strings.R.string.finalize_all_drafts)
                .clickOnString(com.yedc.strings.R.string.finalize_all_drafts);
