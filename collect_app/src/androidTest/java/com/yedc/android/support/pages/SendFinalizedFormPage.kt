...
class SendFinalizedFormPage : Page<SendFinalizedFormPage>() {
    ...
    fun clickSendSelected(): com.yedc.android.support.pages.OkDialog {
        clickOnText(getTranslatedString(R.string.send_selected_data))
        return com.yedc.android.support.pages.OkDialog()
    }

    fun clickSendSelectedWithAuthenticationError(): com.yedc.android.support.pages.ServerAuthDialog {
        clickOnText(getTranslatedString(R.string.send_selected_data))
        return com.yedc.android.support.pages.ServerAuthDialog().assertOnPage()
    }
    ...
    @Deprecated("uses the deprecated {@link com.yedc.android.support.matchers.CustomMatchers#withIndex(Matcher, int)})} helper.")
    ...
    fun sortByDateOldestFirst(): SendFinalizedFormPage {
        onView(withId(com.yedc.android.R.id.menu_sort)).perform(click())
