...
public class ProjectSettingsPage extends Page<ProjectSettingsPage> {
    ...
    public ProjectSettingsPage assertOnPage() {
        assertText(com.yedc.strings.R.string.project_settings);
        return this;
    }

    public ProjectDisplayPage clickProjectDisplay() {
        scrollToRecyclerViewItemAndClickText(com.yedc.strings.R.string.project_display_title);
        return new ProjectDisplayPage().assertOnPage();
    }

    public ProjectManagementPage clickProjectManagement() {
        scrollToRecyclerViewItemAndClickText(com.yedc.strings.R.string.project_management_section_title);
        return new ProjectManagementPage().assertOnPage();
    }

    public AccessControlPage clickAccessControl() {
        scrollToRecyclerViewItemAndClickText(com.yedc.strings.R.string.access_control_section_title);
        return new AccessControlPage().assertOnPage();
    }

    public UserInterfacePage clickOnUserInterface() {
        clickOnString(com.yedc.strings.R.string.client);
        return new UserInterfacePage().assertOnPage();
    }

    public FormManagementPage openFormManagement() {
        clickOnString(com.yedc.strings.R.string.form_management_preferences);
    ...
    public MapsSettingsPage clickMaps() {
        clickOnString(com.yedc.strings.R.string.maps);
        return new MapsSettingsPage().assertOnPage();
    }


    public UserAndDeviceIdentitySettingsPage clickUserAndDeviceIdentity() {
        clickOnString(com.yedc.strings.R.string.user_and_device_identity_title);
        return new UserAndDeviceIdentitySettingsPage().assertOnPage();
    }

    public ProjectSettingsPage checkIfServerOptionIsDisplayed() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.server_settings_title))).check(matches(isDisplayed()));
        return this;
    }

    public ProjectSettingsPage checkIfFormManagementOptionIsDisplayed() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.form_management_preferences))).check(matches(isDisplayed()));
        return this;
    }
    ...
    public FormManagementPage clickFormManagement() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.form_management_preferences))).perform(click());
        return new FormManagementPage();
    }

    public ExperimentalPage clickExperimental() {
        onView(withText(getTranslatedString(com.yedc.strings.R.string.experimental))).perform(click());
        return new ExperimentalPage().assertOnPage();
    }

    public ProjectSettingsPage setAdminPassword(String password) {
        scrollToRecyclerViewItemAndClickText(com.yedc.strings.R.string.set_admin_password);
        inputText(password);
        clickOKOnDialog();
        return this;
    }
