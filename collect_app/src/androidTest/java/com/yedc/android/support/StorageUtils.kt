...
object StorageUtils {
    ...
    fun copyInstance(instanceFileName: String, projectName: String) {
        ...
        _root_ide_package_.com.yedc.android.utilities.FileUtils.copyFileFromAssets(
    ...
    private fun copyFormMediaFiles(formFilename: String, mediaFilePaths: List<String>, projectName: String) {
        val mediaPathName = getFormsDirPath(projectName) + formFilename.replace(".xml", "") + _root_ide_package_.com.yedc.android.utilities.FileUtils.MEDIA_SUFFIX + "/"
        _root_ide_package_.com.yedc.android.utilities.FileUtils.checkMediaPath(File(mediaPathName))
