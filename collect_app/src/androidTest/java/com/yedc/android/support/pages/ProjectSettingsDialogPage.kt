...
internal class ProjectSettingsDialogPage : Page<ProjectSettingsDialogPage>() {
    ...
    override fun assertOnPage(): ProjectSettingsDialogPage {
        assertText(com.yedc.strings.R.string.projects)
        return this
    }

    fun clickSettings(): com.yedc.android.support.pages.ProjectSettingsPage {
        return clickOnTextInDialog(
            com.yedc.strings.R.string.settings,
            com.yedc.android.support.pages.ProjectSettingsPage()
        )
    }

    fun clickAbout(): com.yedc.android.support.pages.AboutPage {
        return clickOnTextInDialog(
            com.yedc.strings.R.string.about_preferences,
            com.yedc.android.support.pages.AboutPage()
        )
    }

    fun clickAddProject(): QrCodeProjectCreatorDialogPage {
        return clickOnTextInDialog(
            com.yedc.strings.R.string.add_project,
        ...
        onView(
            allOf(
                ...
                withContentDescription(
                    getTranslatedString(
                        com.yedc.strings.R.string.using_project,
                        projectName
                    )
                )
            )
    ...
    fun assertInactiveProject(projectName: String, subtext: String): ProjectSettingsDialogPage {
        onView(
            allOf(
                ...
                withContentDescription(
                    getTranslatedString(
                        com.yedc.strings.R.string.switch_to_project,
                        projectName
                    )
                )
            )
    ...
    fun selectProject(projectName: String): com.yedc.android.support.pages.MainMenuPage {
