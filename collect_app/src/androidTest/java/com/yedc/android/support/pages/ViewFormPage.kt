...
class ViewFormPage(private val formName: String) : Page<ViewFormPage>() {
    ...
    fun editForm(formName: String): com.yedc.android.support.pages.FormHierarchyPage {
        ...
        return com.yedc.android.support.pages.FormHierarchyPage(formName).assertOnPage()
    }
    ...
    fun acceptEditingNewerDraftEdit(formName: String): com.yedc.android.support.pages.FormHierarchyPage {
        clickOnTextInDialog(string.newer_draft_edit_found_dialog_positive_button)
        return com.yedc.android.support.pages.FormHierarchyPage(formName).assertOnPage()
    }

    fun acceptEditingNewerFinalizedEdit(formName: String): com.yedc.android.support.pages.FormHierarchyPage {
