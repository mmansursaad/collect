...
public class OkDialog extends Page<OkDialog> {
    ...
    public OkDialog assertOnPage() {
        onView(withText(com.yedc.strings.R.string.ok)).inRoot(isDialog()).check(matches(isDisplayed()));
        return this;
    }

    public <D extends Page<D>> D clickOK(D destination) {
        return clickOnTextInDialog(com.yedc.strings.R.string.ok, destination);
    }
}
