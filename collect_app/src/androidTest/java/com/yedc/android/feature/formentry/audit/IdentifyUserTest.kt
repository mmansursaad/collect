...
import com.yedc.android.support.StorageUtils.getAuditLogForFirstInstance
...
class IdentifyUserTest {
    ...
    fun openingForm_andThenEnteringIdentity_andThenFillingForm_logsUser() {
        rule.startAtMainMenu()
            ...
            .clickKeyboardEnter(com.yedc.android.support.pages.FormEntryPage("Identify User"))
            .swipeToEndScreen()
            .clickFinalize()
    ...
    fun openingSavedForm_andThenEnteringIdentity_andThenFillingForm_logsUser() {
        rule.startAtMainMenu()
            ...
            .clickOnFormWithIdentityPrompt("Identify User")
            .enterIdentity("Jack")
            .clickKeyboardEnter(com.yedc.android.support.pages.FormHierarchyPage("Identify User"))
            .clickJumpEndButton()
            .clickFinalize()
    ...
    fun openingForm_andRotating_remainsOnIdentityPrompt() {
        rule.startAtMainMenu()
            ...
            .clickOnFormWithIdentityPrompt("Identify User")
            .enterIdentity("Blah")
            .rotateToLandscape(com.yedc.android.support.pages.IdentifyUserPromptPage("Identify User"))
            .assertText("Blah")
    }
    ...
    fun minimizingAndReopeningApp_remainsOnIdentityPrompt() {
        rule.startAtMainMenu()
            ...
            .clickOnFormWithIdentityPrompt("Identify User")
            .enterIdentity("Blah")
            .minimizeAndReopenApp(com.yedc.android.support.pages.IdentifyUserPromptPage("Identify User"))
            .assertText("Blah")
    }
