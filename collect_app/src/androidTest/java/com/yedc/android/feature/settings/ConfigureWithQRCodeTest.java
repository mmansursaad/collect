...
import com.yedc.android.support.pages.ProjectSettingsPage;
import com.yedc.android.support.pages.QRCodePage;
...
public class ConfigureWithQRCodeTest {
    ...
    public void clickConfigureQRCode_opensScanner_andThenScanning_importsSettings() {
        ...
        qrCodePage
                .checkIsToastWithMessageDisplayed(com.yedc.strings.R.string.successfully_imported_settings)
    ...
    public void whenThereIsAnAdminPassword_canRemoveFromQRCode() {
        rule.startAtMainMenu()
                ...
                .clickConfigureQR()
                .clickView()
                .clickOnString(com.yedc.strings.R.string.qrcode_with_admin_password)
                .clickOnString(com.yedc.strings.R.string.admin_password)
                .clickOnString(com.yedc.strings.R.string.generate)
                .assertText(com.yedc.strings.R.string.qrcode_without_passwords);
    }
    ...
    public void whenThereIsAServerPassword_canRemoveFromQRCode() {
        rule.startAtMainMenu()
                ...
                .clickConfigureQR()
                .clickView()
                .clickOnString(com.yedc.strings.R.string.qrcode_with_server_password)
                .clickOnString(com.yedc.strings.R.string.server_password)
                .clickOnString(com.yedc.strings.R.string.generate)
                .assertText(com.yedc.strings.R.string.qrcode_without_passwords);
    }
    ...
    private static class StubQRCodeGenerator implements QRCodeGenerator {
        ...
        String getQRCodeFilePath() {
            return getApplicationContext().getExternalFilesDir(null) + File.separator + "test-com.yedc-settings.png";
        }
