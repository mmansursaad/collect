...
class CatchFormDesignExceptionsTest {
    ...
    fun whenFormHasFatalErrors_explanationDialogShouldBeDisplayedAndSurviveActivityRecreationAndTheFormShouldBeClosedAfterClickingOK() {
        rule.startAtMainMenu()
            ...
            .answerQuestion(2, "D")
            .assertTextInDialog(com.yedc.strings.R.string.update_widgets_error)
            .rotateToLandscape(com.yedc.android.support.pages.OkDialog())
            .assertTextInDialog(com.yedc.strings.R.string.update_widgets_error)
            .clickOKOnDialog()
            .assertOnPage(com.yedc.android.support.pages.MainMenuPage())
    }
    ...
    fun whenFormHasNonFatalErrors_explanationDialogShouldBeDisplayedAndTheFormShouldNotBeClosedAfterClickingOK() {
        rule.startAtMainMenu()
            ...
            .clickOK(com.yedc.android.support.pages.FormEntryPage("g6Error"))
    }
    ...
    fun whenFormHasNonFatalErrors_explanationDialogShouldNotSurviveActivityRecreation() {
        rule.startAtMainMenu()
            ...
            .startBlankFormWithError("g6Error", false)
            .clickOK(com.yedc.android.support.pages.FormEntryPage("g6Error"))
            .rotateToLandscape(com.yedc.android.support.pages.FormEntryPage("g6Error"))
            .assertTextDoesNotExist(com.yedc.strings.R.string.error_occured)
    }
