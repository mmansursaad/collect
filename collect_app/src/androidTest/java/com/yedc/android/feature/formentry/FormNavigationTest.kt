...
class FormNavigationTest {
    ...
    fun showsAndHidesButtonsCorrectlyOnEachScreen() {
        rule.startAtMainMenu()
            ...
            .assertTextDoesNotExist(com.yedc.strings.R.string.form_backward)
            .clickForwardButton()
            ...
            .assertText(com.yedc.strings.R.string.form_backward)
            .assertTextDoesNotExist(com.yedc.strings.R.string.form_forward)
    }
