...
class SendFinalizedFormTest {
    ...
    fun whenThereIsAnAuthenticationError_allowsUserToReenterCredentials() {
        ...
        rule.withProject(testDependencies.server.url)
            ...
            .fillPassword("Green")
            .clickOK(com.yedc.android.support.pages.OkDialog())
    ...
    fun whenDeleteAfterSendIsEnabled_deletesFilledForm() {
        rule.withProject(testDependencies.server.url)
            ...
            .clickSettings()
            .clickFormManagement()
            .scrollToRecyclerViewItemAndClickText(com.yedc.strings.R.string.delete_after_send)
    ...
    fun whenThereAreSentAndReadyToSendForms_displayTheBanner() {
        rule.withProject(testDependencies.server.url)
            ...
            .clickSendSelected()
            .clickOK(SendFinalizedFormPage())
            .assertQuantityText(com.yedc.strings.R.plurals.forms_ready_to_send, 1, 1)
    }
