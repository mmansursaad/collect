...
import com.yedc.android.support.pages.SaveOrDiscardFormDialog
import com.yedc.android.support.rules.CollectTestRule
import com.yedc.android.support.rules.ResetStateRule
...
class FormMetadataSettingsTest {
    ...
    var copyFormChain: RuleChain = TestRuleChain.chain()
        .around(
            ResetStateRule(
                object : _root_ide_package_.com.yedc.android.injection.config.AppDependencyModule() {
    ...
    fun metadataShouldBeDisplayedInPreferences() {
        rule.startAtMainMenu()
            ...
            .assertPreference(com.yedc.strings.R.string.username, "Chino")
            .assertPreference(com.yedc.strings.R.string.phone_number, "123")
            .assertPreference(com.yedc.strings.R.string.email, "chino@whitepony.com")
            .assertPreference(com.yedc.strings.R.string.device_id, installIDProvider.installID)
    }
    ...
    fun metadataShouldBeDisplayedInForm() {
        rule.startAtMainMenu()
            ...
            .inputText("chino@whitepony.com")
            .clickOKOnDialog()
            .pressBack(com.yedc.android.support.pages.UserAndDeviceIdentitySettingsPage())
    ...
    fun settingServerUsername_usedAsFallbackForMetadataUsername() {
        rule.startAtMainMenu()
            ...
            .startBlankForm("Metadata")
            .assertText("Chino")
            .pressBack(SaveOrDiscardFormDialog(com.yedc.android.support.pages.MainMenuPage()))
            .clickDiscardForm()
            .openProjectSettingsDialog()
            .clickSettings()
            .clickUserAndDeviceIdentity()
    ...
    fun setEmail_validatesEmail() {
        rule.startAtMainMenu()
            ...
            .inputText("aabb")
            .clickOKOnDialog()
            .checkIsToastWithMessageDisplayed(com.yedc.strings.R.string.invalid_email_address)
            .clickEmail()
            .inputText("aa@bb")
            .clickOKOnDialog()
            .assertText("aa@bb")
