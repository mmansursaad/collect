...
class InstancesAdbTest {
    ...
    fun canAddInstanceOnDisk() {
        rule.startAtMainMenu()
            ...
            .pressBack(com.yedc.android.support.pages.MainMenuPage()) // Return to main menu to trigger instance disk sync
    ...
    fun deletingInstanceOnDisk_andThenOpeningInstance_showsWarning_andRemovesInstance() {
        ...
        val instancesDir =
            testDependencies.storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.INSTANCES)
        ...
        mainMenuPage
            ...
            .assertText(com.yedc.strings.R.string.instance_deleted_message)
            .clickOK(com.yedc.android.support.pages.MainMenuPage())
