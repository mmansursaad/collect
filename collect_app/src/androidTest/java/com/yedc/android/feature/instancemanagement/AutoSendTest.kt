...
class AutoSendTest {
    ...
    fun whenAutoSendEnabled_fillingAndFinalizingForm_sendsFormAndNotifiesUser() {
        ...
        notificationDrawerRule
            .open()
            .assertNotification("YEDC", "Forms upload succeeded", "All uploads succeeded!")
            .clickNotification(
                "ODK Collect",
                "Forms upload succeeded",
                com.yedc.android.support.pages.ViewSentFormPage()
    ...
    fun whenAutoSendDisabled_fillingAndFinalizingForm_doesNotSendFormAutomatically() {
        val mainMenuPage = rule.startAtMainMenu()
            ...
            .copyForm("one-question.xml")
            .startBlankForm("One Question")
            .fillOutAndFinalize(com.yedc.android.support.pages.FormEntryPage.QuestionAndAnswer("what is your age", "31"))
