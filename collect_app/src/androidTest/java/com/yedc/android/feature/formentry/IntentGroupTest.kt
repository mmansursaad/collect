...
class IntentGroupTest {
    ...
    fun externalApp_ShouldPopulateFields() {
        ...
        onView(withId(com.yedc.android.R.id.edit_text))
            .check(doesNotExist())
        onView(withId(com.yedc.android.R.id.text_view))
            .check(doesNotExist())
    ...
    private fun assertIntegerWidgetWithAnswer() {
        ...
        onView(CoreMatchers.allOf(
            isDescendantOfA(isAssignableFrom(_root_ide_package_.com.yedc.android.widgets.IntegerWidget::class.java)),
    ...
    private fun assertDecimalWidgetWithAnswer() {
        onView(withText("Decimal external")).perform(scrollTo())
            .check(matches(isDisplayed()))
        onView(CoreMatchers.allOf(
            isDescendantOfA(isAssignableFrom(_root_ide_package_.com.yedc.android.widgets.DecimalWidget::class.java)),
            isAssignableFrom(TextInputEditText::class.java)))
        ...
        onView(
            CoreMatchers.allOf(
                isDescendantOfA(CoreMatchers.allOf(
                    isAssignableFrom(_root_ide_package_.com.yedc.android.widgets.StringWidget::class.java),
                    CoreMatchers.not(isAssignableFrom(_root_ide_package_.com.yedc.android.widgets.IntegerWidget::class.java)),
                    CoreMatchers.not(isAssignableFrom(_root_ide_package_.com.yedc.android.widgets.DecimalWidget::class.java)))),
                isAssignableFrom(TextInputEditText::class.java))
    ...
    private fun assertImageWidgetWithoutAnswer() {
        ...
        onView(withId(com.yedc.android.R.id.capture_button))
            .check(matches(CoreMatchers.not(isDisplayed())))

        onView(withId(com.yedc.android.R.id.choose_button))
            .check(matches(CoreMatchers.not(isDisplayed())))
    }

    private fun assertAudioWidgetWithoutAnswer() {
        onView(withId(com.yedc.android.R.id.audio_controller))
            .check(matches(CoreMatchers.not(isDisplayed())))
    }
    ...
    private fun assertVideoWidgetWithoutAnswer() {
        ...
        onView(withId(com.yedc.android.R.id.play_video_button))
            .check(matches(CoreMatchers.not(isDisplayed())))
    }
    ...
    private fun createTempFile(name: String, extension: String): Uri {
        ...
        _root_ide_package_.com.yedc.android.utilities.FileUtils.copyFileFromResources(
    ...
    private fun getUriForFile(file: File): Uri {
        return FileProvider.getUriForFile(
            _root_ide_package_.com.yedc.android.application.Collect.getInstance(),
