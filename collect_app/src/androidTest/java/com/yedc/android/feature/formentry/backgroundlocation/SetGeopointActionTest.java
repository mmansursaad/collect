package com.yedc.android.feature.formentry.backgroundlocation;
...
public class SetGeopointActionTest {
    ...
    public void locationCollectionSnackbar_ShouldBeDisplayedAtFormLaunch() {
        rule.startInFormEntry()
                .checkIsSnackbarWithMessageDisplayed(com.yedc.strings.R.string.background_location_enabled, "⋮");
    }
    ...
    public void locationCollectionToggle_ShouldBeAvailable() {
        rule.startInFormEntry()
                .clickOptionsIcon()
                .assertText(com.yedc.strings.R.string.track_location_on);
    }
}
