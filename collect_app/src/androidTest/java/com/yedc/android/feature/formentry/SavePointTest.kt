...
class SavePointTest {
    ...
    fun savePointIsCreatedWhenMovingForwardInForm() {
        ...
        rule.fillNewFormWithSavepoint("two-question-audit.xml")
            .clickRecover(com.yedc.android.support.pages.FormHierarchyPage("Two Question"))
            .assertText("Alexei")
            .assertTextDoesNotExist("46")
            .pressBack(com.yedc.android.support.pages.FormEntryPage("Two Question"))
            .closeSoftKeyboard()
    ...
    fun whenEditing_savePointIsCreatedWhenMovingForwardInForm() {
        ...
        rule.setUpProjectAndCopyForm("two-question-audit.xml", listOf("external_data_10.zip"))
            ...
            .fillOutAndSave(
                AppClosedPage(),
                com.yedc.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your name?", "Pasquale"),
                com.yedc.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your age?", "52")
            )
