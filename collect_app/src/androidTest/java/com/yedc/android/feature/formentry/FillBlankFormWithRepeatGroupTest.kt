...
import com.yedc.android.support.pages.AddNewRepeatDialog
...
class FillBlankFormWithRepeatGroupTest {
    ...
    fun whenNoRepeatGroupAdded_ShouldNotDoubleLastQuestion() {
        rule.startAtMainMenu()
            ...
            .pressBack(com.yedc.android.support.pages.FormEntryPage("TestRepeat"))
            .swipeToNextQuestionWithRepeatGroup("Repeat # 1")
            .clickOnDoNotAdd(AddNewRepeatDialog("Repeat # 2"))
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("TestRepeat"))
    ...
    fun dynamicGroupLabel_should_beCalculatedProperly() {
        rule.startAtMainMenu()
            ...
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("Repeat titles 1648"))
            ...
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEndPage("Repeat titles 1648"))
            .clickFinalize()
    }
    ...
    fun whenNoRepeatGroupAdded_ShouldBackwardButtonBeClickable() {
        rule.startAtMainMenu()
            ...
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("RepeatGroupAndGroup"))
            .closeSoftKeyboard()
    ...
    fun when_pageBehindRepeatGroupWithRegularGroupInsideIsVisible_should_swipeBackWork() {
        rule.startAtMainMenu()
            ...
            .clickOnAdd(com.yedc.android.support.pages.FormEntryPage("RepeatGroupNew"))
            .inputText("A")
            .closeSoftKeyboard()
            .swipeToNextQuestion("Age")
            .inputText("1")
            ...
            .closeSoftKeyboard()
            .swipeToNextQuestionWithRepeatGroup("People")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEndPage("RepeatGroupNew"))
    ...
    fun openHierarchyPageFromLastView_ShouldNotDisplayError() {
        rule.startAtMainMenu()
            ...
            .clickOnAdd(com.yedc.android.support.pages.FormEntryPage("Repeat Group"))
            .swipeToNextQuestionWithRepeatGroup("Grp1")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("Repeat Group"))
            .swipeToNextQuestionWithRepeatGroup("Grp2")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEndPage("Repeat Group"))
            .clickGoToArrow()
            .clickJumpEndButton()
            .clickFinalize()
    }
