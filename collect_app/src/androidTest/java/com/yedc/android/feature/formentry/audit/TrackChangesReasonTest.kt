package com.yedc.android.feature.formentry.audit
...
class TrackChangesReasonTest {
    ...
    fun openingAFormToEdit_andClickingSaveAndExit_andPressingBack_returnsToForm() {
        rule.startAtMainMenu()
            ...
            .clickSaveAndExitWithChangesReasonPrompt()
            .closeSoftKeyboard()
            .pressBack(com.yedc.android.support.pages.FormEntryPage("Track Changes Reason"))
    }
    ...
    fun openingAFormToEdit_andClickingSaveAndExit_andClickingCross_returnsToForm() {
        rule.startAtMainMenu()
            ...
            .clickSaveAndExitWithChangesReasonPrompt()
            .closeSoftKeyboard()
            .pressClose(com.yedc.android.support.pages.FormEntryPage("Track Changes Reason"))
    }
    ...
    fun openingAFormToEdit_andClickingSaveAndExit_andRotating_remainsOnPrompt() {
        rule.startAtMainMenu()
            ...
            .rotateToLandscape(com.yedc.android.support.pages.ChangesReasonPromptPage("Track Changes Reason"))
        ...
        rule.startAtMainMenu()
            ...
            .pressBack(
                SaveOrDiscardFormDialog(
                    com.yedc.android.support.pages.ChangesReasonPromptPage("Track Changes Reason")
                )
            )
            .clickSaveChanges()
    }
    ...
    fun openingFormToEdit_andClickingSave_promptsForReason() {
        rule.startAtMainMenu()
            ...
            .enterReason("Bah")
            .clickSave(com.yedc.android.support.pages.FormEntryPage("Track Changes Reason"))
