...
import com.yedc.android.support.pages.EntitiesPage
...
class SwitchProjectTest {
    ...
    fun switchingProject_switchesSettingsFormsInstancesAndEntities() {
        ...
        rule.startAtMainMenu()
            ...
            .fillOutAndFinalize(com.yedc.android.support.pages.FormEntryPage.QuestionAndAnswer("Name", "Alice"))
            ...
            .pressBack(com.yedc.android.support.pages.ExperimentalPage())
