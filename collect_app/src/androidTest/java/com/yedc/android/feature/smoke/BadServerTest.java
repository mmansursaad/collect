package com.yedc.android.feature.smoke;
...
import com.yedc.android.support.TranslatedStringBuilder;
    ...
    public void whenHashNotIncludedInFormList_showError() {
        ...
        rule.withProject(testDependencies.server.getUrl())
                ...
                .assertError(new TranslatedStringBuilder()
                        .addString(com.yedc.strings.R.string.form_with_no_hash_error)
                        .addString(com.yedc.strings.R.string.report_to_project_lead)
                        .build()
                )
                .navigateBack();
    }
    ...
    */
    public void whenMediaFileHasMissingPrefix_showsAsUpdated() {
        ...
        rule.withProject(testDependencies.server.getUrl())
                ...
                .clickGetBlankForm()
                .assertText(com.yedc.strings.R.string.newer_version_of_a_form_info);
    }
