...
class AddRepeatTest {
    ...
    fun whenInRepeat_swipingNext_andClickingAdd_addsAnotherRepeat() {
        rule.startAtMainMenu()
            ...
            .clickOnAdd(com.yedc.android.support.pages.FormEntryPage("One Question Repeat"))
            .assertText("Person > 2")
    }
    ...
    fun whenInRepeat_swipingNext_andClickingDoNotAdd_leavesRepeatGroup() {
        rule.startAtMainMenu()
            ...
            .assertText("Person > 1")
            .swipeToNextQuestionWithRepeatGroup("Person")
            .clickOnDoNotAdd(com.yedc.android.support.pages.EndOfFormPage("One Question Repeat"))
    }
    ...
    fun whenInRepeat_thatIsAFieldList_swipingNext_andClickingAdd_addsAnotherRepeat() {
        rule.startAtMainMenu()
            ...
            .swipeToNextQuestionWithRepeatGroup("Person")
            .clickOnAdd(com.yedc.android.support.pages.FormEntryPage("Field-List Repeat"))
            .assertText("Person > 2")
            .assertText("What is their age?")
            .assertText("What is their name?")
    }
    ...
    fun whenInARepeat_clickingPlus_andClickingDoNotAdd_returns() {
        rule.startAtMainMenu()
            ...
            .assertText("Person > 1")
            .clickPlus("Person")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("One Question Repeat"))
            .assertText("Person > 1")
    }
    ...
    fun whenInRepeatWithoutLabel_swipingNext_displaysTheAddRepeatDialog() {
        rule.startAtMainMenu()
            ...
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("Repeat without label")) // group with blank label
            .swipeToNextQuestionWithRepeatGroup("")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEntryPage("Repeat without label"))
    }
    ...
    fun whenViewFormInHierarchyForRepeatGroup_noAddButtonAppears() {
        rule.startAtMainMenu()
            ...
            .startBlankForm("One Question Repeat")
            .swipeToNextQuestionWithRepeatGroup("Person")
            .clickOnDoNotAdd(com.yedc.android.support.pages.FormEndPage("One Question Repeat"))
            .clickFinalize()
