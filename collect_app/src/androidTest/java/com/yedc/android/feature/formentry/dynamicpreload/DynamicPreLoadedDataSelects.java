package com.yedc.android.feature.formentry.dynamicpreload;
...
public class DynamicPreLoadedDataSelects {
    ...
    public void displayErrorWhenFilesAreMissing() {
        rule.setUpProjectAndCopyForm("external_data_questions.xml")
                ...
                .assertText(com.yedc.strings.R.string.file_missing, new StoragePathProvider().getOdkDirPath(StorageSubdirectory.FORMS) + "/external_data_questions-media/fruits.csv")
                .swipeToNextQuestion("External csv")
                .assertText(com.yedc.strings.R.string.file_missing, new StoragePathProvider().getOdkDirPath(StorageSubdirectory.FORMS) + "/external_data_questions-media/itemsets.csv");
    }
