...
import com.yedc.android.support.StubOpenRosaServer.EntityListItem
import com.yedc.android.support.StubOpenRosaServer.MediaFileItem
...
class DynamicPreLoadedDataPullTest {
    ...
    fun canUsePullDataFunctionToPullDataFromLocalEntities() {
        ...
        rule.withMatchExactlyProject(testDependencies.server.url)
            ...
            .fillOutAndFinalize(com.yedc.android.support.pages.FormEntryPage.QuestionAndAnswer("Name", "Logan Roy"))
