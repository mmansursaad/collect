...
import com.yedc.android.support.rules.FormEntryActivityTestRule
...
class FieldListUpdateTest {
    ...
    fun questionsAppearingBeforeCurrentBinaryQuestion_ShouldNotChangeFocus() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.yedc.strings.R.string.capture_image)
            .assertQuestion("Target10-15")
            .assertText(com.yedc.strings.R.string.capture_image)
    }
    ...
    fun changeInValueUsedInGuidanceHint_ShouldChangeGuidanceHintText() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .pressBack(com.yedc.android.support.pages.FormEntryPage("fieldlist-updates"))
            .clickGoToArrow()
            .clickGoUpIcon()
    ...
    fun selectingADateForDateTime_ShouldChangeRelevanceOfRelatedField() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.yedc.strings.R.string.select_date)
            .clickOKOnDialog()
    ...
    fun recordingAudio_ShouldChangeRelevanceOfRelatedField() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.yedc.strings.R.string.delete_answer_file)
            .clickOnTextInDialog(
                com.yedc.strings.R.string.delete_answer_file,
                com.yedc.android.support.pages.FormEntryPage("fieldlist-updates")
            )
            .assertNoQuestion("Target16")
    }
    ...
    fun changeInValueUsedToDetermineIfAQuestionIsRequired_ShouldUpdateTheRelatedRequiredQuestion() {
        rule.setUpProjectAndCopyForm("dynamic_required_question.xml")
            ...
            .swipeToNextQuestionWithConstraintViolation(com.yedc.strings.R.string.required_answer_error)
            .longPressOnQuestion("Source")
            .removeResponse()
            .assertQuestion("Target", false)
            .assertTextDoesNotExist(com.yedc.strings.R.string.required_answer_error)
    }
}
