...
public class IdentifyUserPromptPage extends Page<IdentifyUserPromptPage> {
    ...
    public IdentifyUserPromptPage assertOnPage() {
        ...
        assertTextInDialog(com.jed.optima.strings.R.string.enter_identity);
        return this;
    }

    public IdentifyUserPromptPage enterIdentity(String identity) {
        onView(withHint(getTranslatedString(com.jed.optima.strings.R.string.identity))).perform(replaceText(identity));
        return this;
    }

    public <D extends Page<D>> D clickKeyboardEnter(D destination) {
        onView(withHint(getTranslatedString(com.jed.optima.strings.R.string.identity))).perform(pressImeActionButton());
