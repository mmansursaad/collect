...
import com.jed.optima.android.support.rules.FormEntryActivityTestRule
...
class FieldListUpdateTest {
    ...
    fun questionsAppearingBeforeCurrentBinaryQuestion_ShouldNotChangeFocus() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.jed.optima.strings.R.string.capture_image)
            .assertQuestion("Target10-15")
            .assertText(com.jed.optima.strings.R.string.capture_image)
    }
    ...
    fun changeInValueUsedInGuidanceHint_ShouldChangeGuidanceHintText() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.jed.optima.strings.R.string.guidance_yes)
            .pressBack(com.jed.optima.android.support.pages.ProjectSettingsPage())
            .pressBack(com.jed.optima.android.support.pages.FormEntryPage("fieldlist-updates"))
            .clickGoToArrow()
            .clickGoUpIcon()
    ...
    fun selectingADateForDateTime_ShouldChangeRelevanceOfRelatedField() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.jed.optima.strings.R.string.select_date)
            .clickOKOnDialog()
    ...
    fun recordingAudio_ShouldChangeRelevanceOfRelatedField() {
        rule.setUpProjectAndCopyForm("fieldlist-updates.xml")
            ...
            .clickOnString(com.jed.optima.strings.R.string.delete_answer_file)
            .clickOnTextInDialog(
                com.jed.optima.strings.R.string.delete_answer_file,
                com.jed.optima.android.support.pages.FormEntryPage("fieldlist-updates")
            )
            .assertNoQuestion("Target16")
    }
    ...
    fun changeInValueUsedToDetermineIfAQuestionIsRequired_ShouldUpdateTheRelatedRequiredQuestion() {
        rule.setUpProjectAndCopyForm("dynamic_required_question.xml")
            ...
            .swipeToNextQuestionWithConstraintViolation(com.jed.optima.strings.R.string.required_answer_error)
            .longPressOnQuestion("Source")
            .removeResponse()
            .assertQuestion("Target", false)
            .assertTextDoesNotExist(com.jed.optima.strings.R.string.required_answer_error)
    }
}
