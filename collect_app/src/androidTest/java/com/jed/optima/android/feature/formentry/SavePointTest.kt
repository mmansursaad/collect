...
class SavePointTest {
    ...
    fun savePointIsCreatedWhenMovingForwardInForm() {
        ...
        rule.fillNewFormWithSavepoint("two-question-audit.xml")
            .clickRecover(com.jed.optima.android.support.pages.FormHierarchyPage("Two Question"))
            .assertText("Alexei")
            .assertTextDoesNotExist("46")
            .pressBack(com.jed.optima.android.support.pages.FormEntryPage("Two Question"))
            .closeSoftKeyboard()
    ...
    fun whenEditing_savePointIsCreatedWhenMovingForwardInForm() {
        ...
        rule.setUpProjectAndCopyForm("two-question-audit.xml", listOf("external_data_10.zip"))
            ...
            .fillOutAndSave(
                AppClosedPage(),
                com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your name?", "Pasquale"),
                com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your age?", "52")
            )
