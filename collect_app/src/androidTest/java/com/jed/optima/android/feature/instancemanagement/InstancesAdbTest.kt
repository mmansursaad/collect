...
class InstancesAdbTest {
    ...
    fun canAddInstanceOnDisk() {
        rule.startAtMainMenu()
            ...
            .pressBack(com.jed.optima.android.support.pages.MainMenuPage()) // Return to main menu to trigger instance disk sync
    ...
    fun deletingInstanceOnDisk_andThenOpeningInstance_showsWarning_andRemovesInstance() {
        ...
        val instancesDir =
            testDependencies.storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.INSTANCES)
        ...
        mainMenuPage
            ...
            .assertText(com.jed.optima.strings.R.string.instance_deleted_message)
            .clickOK(com.jed.optima.android.support.pages.MainMenuPage())
