...
object TestRuleChain {
    ...
    fun chain(testDependencies: TestDependencies = TestDependencies()): RuleChain {
        val schedulerIdlingResource =
            com.jed.optima.android.support.SchedulerIdlingResource(testDependencies.scheduler)
        val countingTaskExecutorIdlingResource =
            com.jed.optima.android.support.CountingTaskExecutorIdlingResource()
