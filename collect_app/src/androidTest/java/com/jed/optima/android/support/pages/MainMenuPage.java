...
import com.jed.optima.android.support.TestScheduler;
...
public class MainMenuPage extends Page<MainMenuPage> {
    ...
    public MainMenuPage assertOnPage() {
        return WaitFor.waitFor(() -> {
            onView(withText(com.jed.optima.strings.R.string.enter_data)).check(matches(isDisplayed()));
            onView(withText(containsString(getTranslatedString(com.jed.optima.strings.R.string.collect_app_name)))).perform(scrollTo()).check(matches(isDisplayed()));
            return this;
        });
    }
    ...
    public ProjectSettingsDialogPage openProjectSettingsDialog() {
        ...
        clickOnContentDescription(com.jed.optima.strings.R.string.projects);
    ...
    public <D extends Page<D>> D clickGetBlankForm(D destination) {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.get_forms))).perform(scrollTo(), click());
    ...
    public MainMenuPage enableManualUpdates() {
        return openProjectSettingsDialog()
                ...
                .clickFormManagement()
                .clickUpdateForms()
                .clickOption(com.jed.optima.strings.R.string.manual)
                .pressBack(new ProjectSettingsPage())
                .pressBack(new MainMenuPage());
    }
    ...
    public MainMenuPage enablePreviouslyDownloadedOnlyUpdatesWithAutomaticDownload() {
        return openProjectSettingsDialog()
                ...
                .clickUpdateForms()
                .clickOption(com.jed.optima.strings.R.string.previously_downloaded_only)
                .clickOnString(com.jed.optima.strings.R.string.automatic_download)
                .pressBack(new ProjectSettingsPage())
                .pressBack(new MainMenuPage());
    }
    ...
    public ViewSentFormPage clickViewSentForm(int number) {
        ...
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.view_sent_forms))).perform(click());
        return new ViewSentFormPage().assertOnPage();
    }

    public DeleteSavedFormPage clickDeleteSavedForm() {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.manage_files))).perform(scrollTo(), click());
    ...
    public EntitiesPage openEntityBrowser() {
        openProjectSettingsDialog()
                .clickSettings()
                .clickExperimental()
                .clickOnString(com.jed.optima.strings.R.string.entity_browser_button);
