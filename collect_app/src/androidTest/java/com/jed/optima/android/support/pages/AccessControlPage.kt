...
class AccessControlPage : Page<AccessControlPage>() {
    ...
    override fun assertOnPage(): AccessControlPage {
        assertText(com.jed.optima.strings.R.string.access_control_section_title)
        return this
    }

    fun openMainMenuSettings(): MainMenuSettingsPage {
        scrollToRecyclerViewItemAndClickText(getTranslatedString(com.jed.optima.strings.R.string.main_menu_settings))
        return MainMenuSettingsPage()
    }

    fun openUserSettings(): AccessControlPage {
        scrollToRecyclerViewItemAndClickText(getTranslatedString(com.jed.optima.strings.R.string.user_settings))
        return this
    }

    fun clickFormEntrySettings(): AccessControlPage {
        scrollToRecyclerViewItemAndClickText(getTranslatedString(com.jed.optima.strings.R.string.form_entry_setting))
        return this
    }

    fun clickMovingBackwards(): AccessControlPage {
        clickOnString(com.jed.optima.strings.R.string.moving_backwards_title)
        return this
    }

    fun assertGoToPromptEnabled(): AccessControlPage {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.view_hierarchy))).check(matches(isEnabled()))
        return this
    }

    fun assertGoToPromptDisabled(): AccessControlPage {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.view_hierarchy))).check(matches(not(isEnabled())))
        return this
    }
    ...
    fun assertSaveAsDraftInFormEntryEnabled(): AccessControlPage {
        onView(withIndex(withText(getTranslatedString(com.jed.optima.strings.R.string.save_mid)), 0)).check(matches(isEnabled()))
        return this
    }

    fun assertSaveAsDraftInFormEntryDisabled(): AccessControlPage {
        onView(withIndex(withText(getTranslatedString(com.jed.optima.strings.R.string.save_mid)), 0)).check(matches(not(isEnabled())))
        return this
    }
    ...
    fun assertSaveAsDraftInFormEndEnabled(): AccessControlPage {
        onView(withIndex(withText(getTranslatedString(com.jed.optima.strings.R.string.save_as_draft)), 1)).check(matches(isEnabled()))
        return this
    }

    fun assertSaveAsDraftInFormEndDisabled(): AccessControlPage {
        onView(withIndex(withText(getTranslatedString(com.jed.optima.strings.R.string.save_as_draft)), 1)).check(matches(not(isEnabled())))
        return this
    }
    ...
    fun assertFinalizeEnabled(): AccessControlPage {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.finalize))).check(matches(isEnabled()))
        return this
    }

    fun assertFinalizeDisabled(): AccessControlPage {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.finalize))).check(matches(not(isEnabled())))
        return this
    }
    ...
    fun clickOnSaveAsDraftInFormEnd(): AccessControlPage {
        onView(withIndex(withText(getTranslatedString(com.jed.optima.strings.R.string.save_mid)), 1)).perform(click())
        return this
    }
