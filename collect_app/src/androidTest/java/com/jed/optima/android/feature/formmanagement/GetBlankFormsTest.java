...
import com.jed.optima.android.support.pages.GetBlankFormPage;
...
public class GetBlankFormsTest {
    ...
    public void whenThereIsAnErrorFetchingFormList_showsError() {
        ...
        rule.withProject(testDependencies.server.getUrl())
                ...
                .assertText(com.jed.optima.strings.R.string.load_remote_form_error)
                .clickOK(new GetBlankFormPage());
    }
    ...
    public void whenThereIsAnErrorFetchingForms_showsError() {
        ...
        rule.withProject(testDependencies.server.getUrl())
                ...
                .showDetails()
                .assertError("The server https://server.example.com returned status code 500. If you keep having this problem, report it to the person who asked you to com.jed.optima data.")
                .navigateBack();
    }
}
