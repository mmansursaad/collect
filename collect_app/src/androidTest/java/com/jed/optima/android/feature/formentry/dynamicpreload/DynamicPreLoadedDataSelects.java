package com.jed.optima.android.feature.formentry.dynamicpreload;
...
public class DynamicPreLoadedDataSelects {
    ...
    public void displayErrorWhenFilesAreMissing() {
        rule.setUpProjectAndCopyForm("external_data_questions.xml")
                ...
                .assertText(com.jed.optima.strings.R.string.file_missing, new StoragePathProvider().getOdkDirPath(StorageSubdirectory.FORMS) + "/external_data_questions-media/fruits.csv")
                .swipeToNextQuestion("External csv")
                .assertText(com.jed.optima.strings.R.string.file_missing, new StoragePathProvider().getOdkDirPath(StorageSubdirectory.FORMS) + "/external_data_questions-media/itemsets.csv");
    }
