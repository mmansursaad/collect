...
import com.jed.optima.android.support.DummyActivityLauncher
...
class RecentAppsRule : ExternalResource() {
    ...
    fun leaveAndKillApp(appDependencyModule: com.jed.optima.android.injection.config.AppDependencyModule? = null) {
