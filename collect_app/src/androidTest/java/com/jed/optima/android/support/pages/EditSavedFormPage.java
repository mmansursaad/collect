...
import static com.jed.optima.android.instancemanagement.InstanceExtKt.getInstanceIcon;
...
public class EditSavedFormPage extends Page<EditSavedFormPage> {
    ...
    public EditSavedFormPage assertOnPage() {
        assertText(com.jed.optima.strings.R.string.review_data);
        return this;
    }
    ...
    public BulkFinalizationConfirmationDialogPage clickFinalizeAll(int count) {
        this.clickOptionsIcon(com.jed.optima.strings.R.string.finalize_all_drafts)
                .clickOnString(com.jed.optima.strings.R.string.finalize_all_drafts);
