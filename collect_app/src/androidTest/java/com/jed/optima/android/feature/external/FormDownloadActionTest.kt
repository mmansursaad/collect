...
import com.jed.optima.android.support.pages.FormsDownloadResultPage
import com.jed.optima.android.support.rules.CollectTestRule
import com.jed.optima.android.support.rules.TestRuleChain
import com.jed.optima.android.utilities.ApplicationConstants.BundleKeys.FORM_IDS
import com.jed.optima.android.utilities.ApplicationConstants.BundleKeys.PASSWORD
import com.jed.optima.android.utilities.ApplicationConstants.BundleKeys.SUCCESS_KEY
import com.jed.optima.android.utilities.ApplicationConstants.BundleKeys.URL
import com.jed.optima.android.utilities.ApplicationConstants.BundleKeys.USERNAME
...
class FormDownloadActionTest {
    ...
    fun passingIds_downloadsFormsFromProjectServer_andReturnsSuccessResult() {
        ...
        val intent = Intent("com.jed.optima.android.FORM_DOWNLOAD")
        ...
        rule.relaunch(com.jed.optima.android.support.pages.MainMenuPage())
            .clickFillBlankForm()
    ...
    fun passingIds_andServerDetails_whenThereIsAnAuthenticationError_allowsUserToReenterCredentials_andReturnsSuccessResult() {
        ...
        val result = rule.launchForResult(intent,
            com.jed.optima.android.support.pages.ServerAuthDialog()
        ) {
