...
public class FormEndPage extends Page<FormEndPage> {
    ...
    public FormEndPage assertOnPage() {
        onView(withText(getTranslatedString(com.jed.optima.strings.R.string.save_enter_data_description, formName))).check(matches(isDisplayed()));
        return this;
    }

    public <D extends Page<D>> D clickSaveAsDraft(D destination) {
        return clickOnString(com.jed.optima.strings.R.string.save_as_draft, destination);
    }
    ...
    public FormEndPage clickSaveAsDraftWithError(String errorMsg) {
        clickOnString(com.jed.optima.strings.R.string.save_as_draft);
        checkIsToastWithMessageDisplayed(errorMsg);
        return this;
    }

    public <D extends Page<D>> D clickFinalize(D destination) {
        return clickOnString(com.jed.optima.strings.R.string.finalize, destination);
    }
    ...
    public MainMenuPage clickSend() {
        clickOnString(com.jed.optima.strings.R.string.send);
