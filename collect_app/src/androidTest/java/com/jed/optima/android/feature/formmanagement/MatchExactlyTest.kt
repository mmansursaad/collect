...
import com.jed.optima.android.support.pages.ErrorPage
import com.jed.optima.android.support.rules.CollectTestRule
import com.jed.optima.android.support.rules.NotificationDrawerRule
...
class MatchExactlyTest {
    ...
    fun whenMatchExactlyEnabled_clickingFillBlankForm_andClickingRefresh_whenThereIsAnError_showsNotification_andClickingShowDetails_showsErrorDetails() {
        ...
        notificationDrawerRule
            ...
            .clickAction(
                ...
                "Show details",
                ErrorPage()
            ).assertText(com.jed.optima.strings.R.string.form_update_error)
            .assertText("Demo project")
            .assertText("The server https://server.example.com returned status code 500. If you keep having this problem, report it to the person who asked you to com.jed.optima data.")
    }
    ...
    fun whenMatchExactlyEnabled_clickingFillBlankForm_andClickingRefresh_whenThereIsAnAuthenticationError_promptsForCredentials() {
        ...
        rule.startAtMainMenu()
            ...
            .clickOK(com.jed.optima.android.support.pages.FillBlankFormPage())
            .clickRefresh()
    ...
    fun whenMatchExactlyEnabled_hidesGetBlankFormsAndDeleteBlankForms() {
        rule.startAtMainMenu()
            ...
            .copyForm("one-question-repeat.xml")
            .enableMatchExactly()
            .assertTextDoesNotExist(com.jed.optima.strings.R.string.get_forms)
            .clickDeleteSavedForm()
            .assertTextDoesNotExist(com.jed.optima.strings.R.string.forms)
    }
