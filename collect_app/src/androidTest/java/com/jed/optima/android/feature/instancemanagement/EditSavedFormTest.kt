    ...
    fun killingAppWhenEditingFinalizedForm_createsSavepointForFormRecovery() {
        rule.startAtMainMenu()
            ...
            .killAndReopenApp(rule, recentAppsRule,
                com.jed.optima.android.support.pages.MainMenuPage(), testDependencies)

            .clickDrafts(1)
            .clickOnFormWithSavepoint("One Question Editable (Edit 1)")
            .clickRecover(com.jed.optima.android.support.pages.FormHierarchyPage("One Question Editable"))
            .closeSnackbar()
