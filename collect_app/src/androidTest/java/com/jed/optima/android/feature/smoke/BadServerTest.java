...
import com.jed.optima.android.support.TranslatedStringBuilder;
    ...
    public void whenHashNotIncludedInFormList_showError() {
        ...
        rule.withProject(testDependencies.server.getUrl())
                ...
                .assertError(new TranslatedStringBuilder()
                        .addString(com.jed.optima.strings.R.string.form_with_no_hash_error)
                        .addString(com.jed.optima.strings.R.string.report_to_project_lead)
                        .build()
                )
                .navigateBack();
    }
