...
class AuditTest {
    ...
    fun fillAndEditingForm_updatesAuditLogForInstance() {
        rule.startAtMainMenu()
            ...
            .fillOut(
                com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("what is your age", "31")
            )
            .swipeToEndScreen()
            .clickSaveAsDraft()
            .clickDrafts(1)
            ...
            .clickGoToStart()
            .fillOutAndFinalize(
                com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("what is your age", "32")
            )
    ...
    fun navigatingToSettings_savesAnswersFromCurrentScreenToAuditLog() {
        rule.startAtMainMenu()
            ...
            .fillOut(com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your age?", "31"))
            .clickOptionsIcon()
    ...
    fun navigatingToNextQuestion_savesAnswersFromCurrentScreenToAuditLog() {
        rule.startAtMainMenu()
            ...
            .fillOut(com.jed.optima.android.support.pages.FormEntryPage.QuestionAndAnswer("What is your name?", "Adam"))
            .swipeToEndScreen()
    ...
    fun navigatingBackToTheFormAfterKillingTheAppWhenMovingBackwardsIsDisabled_savesFormResumeEventToAuditLog() {
        rule.startAtMainMenu()
            ...
            .clickRecover(com.jed.optima.android.support.pages.FormEntryPage("One Question Audit"))
            .swipeToEndScreen()
            .clickFinalize()
