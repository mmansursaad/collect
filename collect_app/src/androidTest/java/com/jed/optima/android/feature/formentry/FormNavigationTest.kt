...
class FormNavigationTest {
    ...
    fun showsAndHidesButtonsCorrectlyOnEachScreen() {
        rule.startAtMainMenu()
            ...
            .assertTextDoesNotExist(com.jed.optima.strings.R.string.form_backward)
            .clickForwardButton()
            ...
            .assertText(com.jed.optima.strings.R.string.form_backward)
            .assertTextDoesNotExist(com.jed.optima.strings.R.string.form_forward)
    }
