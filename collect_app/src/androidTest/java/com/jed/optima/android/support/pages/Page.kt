...
import com.jed.optima.androidshared.ui.ToastUtils.popRecordedToasts
...
import com.jed.optima.testshared.WaitFor.waitFor
...
abstract class Page<T : Page<T>> {
    ...
    fun getTranslatedString(id: Int?, vararg formatArgs: Any): String {
        return ApplicationProvider.getApplicationContext<com.jed.optima.android.application.Collect>()
    ...
    fun closeSnackbar(): T {
        Interactions.clickOn(withContentDescription(com.jed.optima.strings.R.string.close_snackbar))
        return this as T
    }
    ...
    fun <D : Page<D>> killAndReopenApp(
        ...
        destination: D,
        appDependencyModule: com.jed.optima.android.injection.config.AppDependencyModule? = null
    ): D {
    ...
    companion object {
        private fun rotateToLandscape(): ViewAction {
            return com.jed.optima.android.support.actions.RotateAction(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE)
        }

        private fun rotateToPortrait(): ViewAction {
            return com.jed.optima.android.support.actions.RotateAction(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT)
        }
