...
import static com.jed.optima.testshared.ViewActions.clickOnViewContentDescription;
...
public class FillBlankFormPage extends Page<FillBlankFormPage> {
    ...
    public FillBlankFormPage assertOnPage() {
        assertToolbarTitle(com.jed.optima.strings.R.string.enter_data);
        return this;
    }
    ...
    public FillBlankFormPage checkMapIconDisplayedForForm(String formName) {
        onView(withId(R.id.form_list))
                ...
                .check(matches(hasDescendant(allOf(withContentDescription(com.jed.optima.strings.R.string.open_form_map), withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)))));
        return this;
    }
    ...
    public FillBlankFormPage checkMapIconNotDisplayedForForm(String formName) {
        onView(withId(R.id.form_list))
                .perform(RecyclerViewActions.actionOnItem(hasDescendant(withText(formName)), scrollTo()))
                .check(matches(hasDescendant(allOf(withContentDescription(com.jed.optima.strings.R.string.open_form_map), withEffectiveVisibility(ViewMatchers.Visibility.GONE)))));
        return this;
    }

    public FormMapPage clickOnMapIconForForm(String formName) {
        onView(withId(R.id.form_list))
                .perform(RecyclerViewActions.actionOnItem(hasDescendant(withText(formName)), clickOnViewContentDescription(com.jed.optima.strings.R.string.open_form_map, ApplicationProvider.getApplicationContext())));
    ...
    public FillBlankFormPage assertFormExists(String formName) {
        ...
        return WaitFor.waitFor(() -> {
            assertTextDoesNotExist(com.jed.optima.strings.R.string.empty_list_of_drafts_title);
    ...
    public FillBlankFormPage assertNoForms() {
        assertText(com.jed.optima.strings.R.string.empty_list_of_blank_forms_title);
        return this;
    }
}
