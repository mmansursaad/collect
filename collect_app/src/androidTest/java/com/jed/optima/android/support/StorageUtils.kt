...
object StorageUtils {
    ...
    fun copyInstance(instanceFileName: String, projectName: String) {
        ...
        com.jed.optima.android.utilities.FileUtils.copyFileFromAssets(
    ...
    private fun copyFormMediaFiles(formFilename: String, mediaFilePaths: List<String>, projectName: String) {
        val mediaPathName = getFormsDirPath(projectName) + formFilename.replace(".xml", "") + com.jed.optima.android.utilities.FileUtils.MEDIA_SUFFIX + "/"
        com.jed.optima.android.utilities.FileUtils.checkMediaPath(File(mediaPathName))
