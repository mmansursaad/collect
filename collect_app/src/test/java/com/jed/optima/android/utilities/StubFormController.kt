...
open class StubFormController : FormController {
    ...
    override fun getAuditEventLogger(): com.jed.optima.android.formentry.audit.AuditEventLogger? = null
    ...
    @Throws(com.jed.optima.android.exception.JavaRosaException::class)
    ...
    override fun getSubmissionMetadata(): com.jed.optima.android.javarosawrapper.InstanceMetadata? = null
