...
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils;
...
import static com.jed.optima.android.widgets.support.GeoWidgetHelpers.getRandomDoubleArray;
...
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnlyAndAnswer;
...
public class GeoPointMapWidgetTest {
    ...
    public void creatingWidgetWithInvalidValue_doesNotUpdateWidgetDisplayedAnswer() {
        ...
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.get_point));
    }
    ...
    public void whenPromptIsReadOnlyAndHasAnswer_viewGeoPointButtonIsShown() {
        ...
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.view_point));
    }
    ...
    public void whenPromptIsNotReadOnlyAndHasAnswer_viewOrChangeLocationButtonIsShown() {
        GeoPointMapWidget widget = createWidget(promptWithAnswer(answer));
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.view_or_change_point));
    }
