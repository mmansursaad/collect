...
class ImageCompressionControllerTest {
    ...
    private val questionWidget = mock<com.jed.optima.android.widgets.QuestionWidget>().also {
    ...
    private val treeElement = mock<TreeElement>().also {
        ...
        whenever(it.namespace).thenReturn(com.jed.optima.android.utilities.ApplicationConstants.Namespaces.XML_OPENROSA_NAMESPACE)
    }
