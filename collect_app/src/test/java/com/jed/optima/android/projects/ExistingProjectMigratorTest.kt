...
class ExistingProjectMigratorTest {
    ...
    private fun getProjectDirPaths(projectId: String): Array<String> {
        return arrayOf(
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.FORMS, projectId),
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.INSTANCES, projectId),
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.CACHE, projectId),
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.METADATA, projectId),
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.LAYERS, projectId),
            storagePathProvider.getOdkDirPath(com.jed.optima.android.storage.StorageSubdirectory.SETTINGS, projectId)
        )
    }
}
