...
import com.jed.optima.android.widgets.CounterWidget.Companion.MAX_VALUE

class CounterWidgetTest : com.jed.optima.android.widgets.base.QuestionWidgetTest<CounterWidget, IAnswerData>() {

    override fun createWidget() = CounterWidget(
        activity,
        com.jed.optima.android.formentry.questions.QuestionDetails(formEntryPrompt),
        dependencies
    )
    ...
    fun `clicking the minus button calls widgetValueChanged listener`() {
        whenever(formEntryPrompt.answerValue).thenReturn(IntegerData(1))
        val valueChangedListener = com.jed.optima.android.widgets.support.QuestionWidgetHelpers.mockValueChangedListener<com.jed.optima.android.widgets.QuestionWidget>(widget)
