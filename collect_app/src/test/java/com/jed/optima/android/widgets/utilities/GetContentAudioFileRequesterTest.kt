...
class GetContentAudioFileRequesterTest {
    ...
    fun requestFile_whenIntentIsNotAvailable_doesNotStartAnyIntentAndCancelsWaitingForData() {
        ...
        setupRequester()
        requester.requestFile(_root_ide_package_.com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithAnswer(null))
    ...
    fun requestFile_startsChooseAudioFileActivityAndSetsWidgetWaitingForData() {
        ...
        assertThat(
            ...
            equalTo(_root_ide_package_.com.jed.optima.android.utilities.ApplicationConstants.RequestCodes.AUDIO_CHOOSER)
        )
        assertThat(
