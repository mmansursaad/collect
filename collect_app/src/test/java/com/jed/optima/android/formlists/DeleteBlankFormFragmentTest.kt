package com.jed.optima.android.formlists
...
import com.jed.optima.android.formlists.blankformlist.BlankFormListMenuProvider
...
class DeleteBlankFormFragmentTest {
    ...
    fun `clicking delete selected and then accepting deletes selected forms`() {
        ...
        onView(withText(com.jed.optima.strings.R.string.delete_file)).perform(click())
        onView(withText(context.getString(com.jed.optima.strings.R.string.delete_confirm, 2)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.jed.optima.strings.R.string.delete_yes)).inRoot(isDialog()).perform(click())
    ...
    fun `clicking delete selected and then cancelling does nothing`() {
        ...
        onView(withText(context.getString(com.jed.optima.strings.R.string.delete_confirm, 2)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.jed.optima.strings.R.string.delete_no)).inRoot(isDialog()).perform(click())
    ...
    fun `clicking delete selected unselects forms`() {
        ...
        onView(withText(com.jed.optima.strings.R.string.delete_file)).perform(click())
        onView(withText(context.getString(com.jed.optima.strings.R.string.delete_confirm, 1)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.jed.optima.strings.R.string.delete_yes)).inRoot(isDialog()).perform(click())
