...
class FormEntryUseCasesTest {
    ...
    fun finalizeDraft_whenValidationFails_marksInstanceAsHavingErrors() {
        ...
        assertThat(
            ...
            equalTo(com.jed.optima.forms.instances.Instance.STATUS_INVALID)
        )
    }
    ...
    ): Pair<com.jed.optima.forms.Form?, FormDef?> {
    ...
    private fun createDraft(
        ...
        formDef: FormDef,
        instancesRepository: com.jed.optima.formstest.InMemInstancesRepository,
    ...
    private fun copyTestForm(testForm: String): File {
        return TempFiles.createTempFile(".xml").also {
            com.jed.optima.android.utilities.FileUtils.copyFileFromResources(testForm, it.absolutePath)
        }
    }
}
