...
class FileRequesterImplTest {
    ...
    private val externalAppIntentProvider = mock<_root_ide_package_.com.jed.optima.android.utilities.ExternalAppIntentProvider>()
    ...
    fun `If both attempts to start activity failed a toast should be displayed`() {
        ...
        val toastText = ShadowToast.getTextOfLatestToast()
        assertThat(toastText, `is`(activity.getString(com.jed.optima.strings.R.string.no_app)))
    }
