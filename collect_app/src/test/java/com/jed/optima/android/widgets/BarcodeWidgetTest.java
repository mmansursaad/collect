...
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithAppearance;
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnly;
...
public class BarcodeWidgetTest {
    ...
    public void whenPromptHasAnswer_replaceBarcodeButtonIsDisplayed() {
        ...
        assertThat(widget.binding.barcodeButton.getText().toString(), equalTo(widgetTestActivity.getString(com.jed.optima.strings.R.string.replace_barcode)));
    }
    ...
    public void clearAnswer_clearsWidgetAnswer() {
        ...
        assertThat(widget.binding.barcodeButton.getText().toString(), equalTo(widgetTestActivity.getString(com.jed.optima.strings.R.string.get_barcode)));
    }
    ...
    public void setData_updatesButtonLabel() {
        BarcodeWidget widget = createWidget(promptWithAnswer(null));
        widget.setData("\ud800blah\b");
        assertThat(widget.binding.barcodeButton.getText(), equalTo(widgetTestActivity.getString(com.jed.optima.strings.R.string.replace_barcode)));
    }
    ...
    public void clickingBarcodeButton_whenFrontCameraIsNotAvailable_showsFrontCameraNotAvailableToast() {
        ...
        assertThat(ShadowToast.getTextOfLatestToast(), equalTo(widgetTestActivity.getString(com.jed.optima.strings.R.string.error_front_camera_unavailable)));
    }
