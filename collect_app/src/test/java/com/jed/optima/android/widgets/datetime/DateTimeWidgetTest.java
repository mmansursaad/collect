...
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.mockValueChangedListener;
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithQuestionDefAndAnswer;
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnlyAndQuestionDef;
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.widgetDependencies;
import static com.jed.optima.android.widgets.support.QuestionWidgetHelpers.widgetTestActivity;
...
public class DateTimeWidgetTest {
    ...
    public void whenPromptIsNotReadOnly_buttonShowsCorrectText() {
        ...
        assertEquals(widget.binding.dateWidget.dateButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.select_date));
        assertEquals(widget.binding.timeWidget.timeButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.select_time));
    }
    ...
    public void getAnswer_whenPromptHasDateAnswer_returnsDateAnswerAndCurrentTime() {
        ...
        widget.binding.timeWidget.timeAnswerText.setText(widget.getContext().getString(com.jed.optima.strings.R.string.no_time_selected));
    ...
    public void getAnswer_whenPromptHasTimeAnswer_returnsTimeAnswerAndCurrentDate() {
        DateTimeWidget widget = createWidget(promptWithQuestionDefAndAnswer(questionDef, new DateTimeData(localDateTime.toDate())));
        widget.binding.dateWidget.dateAnswerText.setText(widget.getContext().getString(com.jed.optima.strings.R.string.no_date_selected));
    ...
    public void whenPromptDoesNotHaveAnswer_answerTextViewShowsNoValueSelected() {
        ...
        assertEquals(widget.binding.dateWidget.dateAnswerText.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.no_date_selected));
        assertEquals(widget.binding.timeWidget.timeAnswerText.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.no_time_selected));
    }
