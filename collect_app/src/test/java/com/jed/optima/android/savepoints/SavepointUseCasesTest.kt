...
class SavepointUseCasesTest {
    private var formV1: com.jed.optima.forms.Form
    private var formV2: com.jed.optima.forms.Form

    private var instance1: com.jed.optima.forms.instances.Instance
    private var instance2: com.jed.optima.forms.instances.Instance

    private val formsRepository = com.jed.optima.formstest.InMemFormsRepository().apply {
        formV1 = save(
            FormUtils.buildForm(
                "1",
                "1",
    ...
    private val instancesRepository = com.jed.optima.formstest.InMemInstancesRepository().apply {
        instance1 = save(
    ...
    fun `getSavepoint called with the old form version uri returns null if only the new form version has a savepoint`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                com.jed.optima.android.external.FormsContract.getUri("1", formV1.dbId),
                com.jed.optima.android.external.FormsContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
    ...
    fun `getSavepoint called with the new form version uri returns savepoint if it has one`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                com.jed.optima.android.external.FormsContract.getUri("1", formV2.dbId),
                com.jed.optima.android.external.FormsContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
                savepointsRepository
    ...
    fun `getSavepoint called for a saved form uri returns null if only its blank form has a savepoint`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                com.jed.optima.android.external.InstancesContract.getUri("1", instance1.dbId),
                com.jed.optima.android.external.InstancesContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
                savepointsRepository
            ),
