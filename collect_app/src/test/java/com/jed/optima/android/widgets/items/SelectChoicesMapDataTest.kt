...
class SelectChoicesMapDataTest {
    ...
    fun `uses marker without cutout if marker-symbol is defined`() {
        ...
        val data = loadDataForPrompt(prompt)
        val item = data.getMappableItems().getOrAwaitValue()!![0] as MappableSelectItem.MappableSelectPoint
        assertThat(item.smallIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_small))
        assertThat(item.largeIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_big))
    }
    ...
    fun `uses marker with cutout if marker-symbol is not defined or blank`() {
        ...
        assertThat(firstItem.smallIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_small))
        assertThat(firstItem.largeIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_big))

        val secondItem = data.getMappableItems().getOrAwaitValue()!![1] as MappableSelectItem.MappableSelectPoint
        assertThat(secondItem.smallIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_small))
        assertThat(secondItem.largeIcon, equalTo(com.jed.optima.icons.R.drawable.ic_map_marker_with_hole_big))
    }
