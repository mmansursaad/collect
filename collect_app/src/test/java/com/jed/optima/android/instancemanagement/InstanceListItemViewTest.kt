...
import com.jed.optima.android.databinding.FormChooserListItemBinding
...
class InstanceListItemViewTest {
    ...
    fun `show an error chip if the status is STATUS_INVALID`() {
        ...
        val instance = InstanceFixtures.instance(status = com.jed.optima.forms.instances.Instance.STATUS_INVALID)
    ...
    fun `show a no-error chip if the status is STATUS_VALID`() {
        val binding = FormChooserListItemBinding.inflate(layoutInflater)
        val instance = InstanceFixtures.instance(status = com.jed.optima.forms.instances.Instance.STATUS_VALID)
    ...
    fun `show a no-error chip if the status is STATUS_NEW_EDIT`() {
        val binding = FormChooserListItemBinding.inflate(layoutInflater)
        val instance = InstanceFixtures.instance(status = com.jed.optima.forms.instances.Instance.STATUS_NEW_EDIT)
    ...
    fun `show an error chip if the status is STATUS_INCOMPLETE`() {
        val binding = FormChooserListItemBinding.inflate(layoutInflater)
        val instance = InstanceFixtures.instance(status = com.jed.optima.forms.instances.Instance.STATUS_INCOMPLETE)
    ...
    fun `do not show a chip if the status is STATUS_COMPLETE`() {
        val binding = FormChooserListItemBinding.inflate(layoutInflater)
        val instance = InstanceFixtures.instance(status = com.jed.optima.forms.instances.Instance.STATUS_COMPLETE)
