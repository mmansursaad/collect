...
class BlankFormListItemTest {
    ...
    fun `Form should be properly converted to BlankFormListItem`() {
        val form = com.jed.optima.forms.Form.Builder()
            .dbId(1)
            .formId("1")
        ...
        assertThat(blankFormListItem.contentUri, `is`(Uri.parse("content://com.jed.optima.android.provider.odk.forms/forms/1?projectId=DEMO")))
    }
    ...
    fun `dateOfLastUsage should be set taking into account forms saved not only for given formId but also formVersion`() {
        val formV1 = com.jed.optima.forms.Form.Builder()
            .dbId(1)
            .formId("1")
        ...
        val formV2 = com.jed.optima.forms.Form.Builder(formV1)
            .dbId(2)
