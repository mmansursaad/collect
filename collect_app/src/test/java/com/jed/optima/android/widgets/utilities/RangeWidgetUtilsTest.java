...
import com.jed.optima.android.databinding.RangePickerWidgetAnswerBinding;
...
import com.jed.optima.android.views.TrackingTouchSlider;
...
public class RangeWidgetUtilsTest {
    ...
    public void whenPromptDoesNotHaveAnswer_answerTextViewShowsNoValueSelected() {
        ...
        assertThat(binding.widgetAnswerText.getText(), equalTo(widgetTestActivity().getString(com.jed.optima.strings.R.string.no_value_selected)));
    }
    ...
    public void whenPromptDoesNotHaveAnswer_pickerButtonShowsNoValueSelected() {
        RangeWidgetUtils.setUpRangePickerWidget(widgetTestActivity(), binding, promptWithQuestionDefAndAnswer(rangeQuestion, null));
        assertThat(binding.widgetButton.getText(), equalTo(widgetTestActivity().getString(com.jed.optima.strings.R.string.select_value)));
    }
    ...
    public void whenPromptHasAnswer_pickerButtonShowsCorrectAnswer() {
        RangeWidgetUtils.setUpRangePickerWidget(widgetTestActivity(), binding, promptWithQuestionDefAndAnswer(
                rangeQuestion, new StringData("4")));
        assertThat(binding.widgetButton.getText(), equalTo(widgetTestActivity().getString(com.jed.optima.strings.R.string.edit_value)));
    }
    ...
    public void whenRangeQuestionHasZeroRangeStep_invalidWidgetToastIsShown() {
        ...
        assertThat(toastText, equalTo(ApplicationProvider.getApplicationContext().getString(com.jed.optima.strings.R.string.invalid_range_widget)));
    }
