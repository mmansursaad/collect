...
class QRCodeActivityResultDelegateTest {
    ...
    fun forSelectPhoto_importsSettingsFromQRCode_showsSuccessToast() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(com.jed.optima.strings.R.string.successfully_imported_settings)
            )
        )
    }
    ...
    fun forSelectPhoto_whenImportingFails_showsInvalidToast() {
        ...
        assertThat(ShadowToast.getTextOfLatestToast(), equalTo(context.getString(com.jed.optima.strings.R.string.invalid_qrcode)))
    }
    ...
    fun forSelectPhotoWithGoogleDriveProtocol_whenImporting_showsInvalidToast() {
        ...
        assertThat(ShadowToast.getTextOfLatestToast(), equalTo(context.getString(com.jed.optima.strings.R.string.settings_with_gd_protocol)))
    }
    ...
    fun forSelectPhoto_whenQRCodeDecodeFailsWithNotFound_showsNoQRToast() {
        ...
        assertThat(ShadowToast.getTextOfLatestToast(), equalTo(context.getString(com.jed.optima.strings.R.string.qr_code_not_found)))
    }
