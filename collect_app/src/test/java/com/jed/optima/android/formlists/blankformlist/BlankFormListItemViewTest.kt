...
class BlankFormListItemViewTest {
    ...
    fun `displays form version`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(com.jed.optima.strings.R.string.version_number, "myVersion"))
        )
    }
    ...
    fun `displays form id`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(com.jed.optima.strings.R.string.id_number, "myId"))
        )
    }
}
