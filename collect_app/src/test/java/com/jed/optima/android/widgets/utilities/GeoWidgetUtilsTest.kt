...
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.convertCoordinatesIntoDegreeFormat
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.floor
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.getGeoPointAnswerToDisplay
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.getGeoPolyAnswerToDisplay
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.isWithinMapBounds
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.parseGeometry
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.parseGeometryPoint
import com.jed.optima.android.widgets.utilities.GeoWidgetUtils.truncateDouble
...
class GeoWidgetUtilsTest {
    ...
    private val answer = GeoPointData(_root_ide_package_.com.jed.optima.android.widgets.support.GeoWidgetHelpers.getRandomDoubleArray())
    ...
    fun getAnswerToDisplay_whenAnswerIsNotNullAndConvertible_returnsAnswer() {
        ...
        assertEquals(
            ...
            context.getString(
                com.jed.optima.strings.R.string.gps_result,
