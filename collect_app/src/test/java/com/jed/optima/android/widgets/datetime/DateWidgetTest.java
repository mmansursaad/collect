...
public class DateWidgetTest {
    ...
    public void whenPromptIsNotReadOnly_buttonShowsCorrectText() {
        ...
        assertEquals(widget.binding.dateButton.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.select_date));
    }
    ...
    public void whenPromptDoesNotHaveAnswer_answerTextViewShowsNoDateSelected() {
        DateWidget widget = createWidget(promptWithQuestionDefAndAnswer(questionDef, null));
        assertEquals(widget.binding.dateAnswerText.getText(), widget.getContext().getString(com.jed.optima.strings.R.string.no_date_selected));
    }
