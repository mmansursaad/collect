...
import com.jed.optima.android.TestSettingsProvider.getSettingsProvider
import com.jed.optima.android.formentry.FormEntryMenuProvider.FormEntryMenuClickListener
...
import com.jed.optima.testshared.RobolectricHelpers.createThemedActivity
import com.jed.optima.testshared.RobolectricHelpers.getFragmentByClass
...
class FormEntryMenuProviderTest {
    ...
    private val formEntryViewModel = mock<com.jed.optima.android.formentry.FormEntryViewModel>().apply {
    ...
    private val answersProvider = mock<com.jed.optima.android.formentry.questions.AnswersProvider>()
    private val audioRecorder = mock<AudioRecorder>().apply {
        whenever(isRecording()).thenReturn(false)
    }
    private val backgroundAudioViewModel = mock<com.jed.optima.android.formentry.BackgroundAudioViewModel>().apply {
    ...
    private val backgroundLocationViewModel = mock<com.jed.optima.android.formentry.backgroundlocation.BackgroundLocationViewModel>()
    ...
    fun onPrepare_whenBackgroundRecodingEnabled_checksRecordAudio() {
        ...
        assertThat(menu.findItem(R.id.menu_record_audio).title, equalTo(activity.getLocalizedString(com.jed.optima.strings.R.string.record_audio_on)))
    }
    ...
    fun onPrepare_whenNotRecordingInBackground_unchecksRecordAudio() {
        ...
        assertThat(menu.findItem(R.id.menu_record_audio).title, equalTo(activity.getLocalizedString(com.jed.optima.strings.R.string.record_audio_off)))
    }
    ...
    fun onItemSelected_whenAddRepeat_whenRecording_showsWarning() {
        ...
        val dialog = getFragmentByClass(activity.supportFragmentManager, com.jed.optima.android.formentry.RecordingWarningDialogFragment::class.java)
    ...
    fun onItemSelected_whenPreferences_startsPreferencesActivityWithChangeSettingsRequest() {
        ...
        assertThat(nextStartedActivity.requestCode, equalTo(com.jed.optima.android.utilities.ApplicationConstants.RequestCodes.CHANGE_SETTINGS))
    }
    ...
    fun onItemSelected_whenHierarchy_startsHierarchyActivity() {
        ...
        assertThat(nextStartedActivity.requestCode, equalTo(com.jed.optima.android.utilities.ApplicationConstants.RequestCodes.HIERARCHY_ACTIVITY))
    }
