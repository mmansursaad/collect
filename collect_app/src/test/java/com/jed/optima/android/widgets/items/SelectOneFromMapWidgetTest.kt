...
import com.jed.optima.android.widgets.support.QuestionWidgetHelpers.mockValueChangedListener
import com.jed.optima.android.widgets.support.QuestionWidgetHelpers.promptWithAnswer
...
import com.jed.optima.android.widgets.utilities.QuestionFontSizeUtils.FontSize
...
class SelectOneFromMapWidgetTest {
    ...
    private val settingsProvider = InMemSettingsProvider().also {
        ...
        it.getUnprotectedSettings().save(ProjectKeys.KEY_GUIDANCE_HINT, _root_ide_package_.com.jed.optima.android.preferences.GuidanceHint.YES.toString())
    }
    ...
    fun `clicking button opens SelectOneFromMapDialogFragment`() {
        ...
        val widget =
            SelectOneFromMapWidget(activity,
                _root_ide_package_.com.jed.optima.android.formentry.questions.QuestionDetails(prompt), false, mock(), widgetDependencies())
    ...
    fun `setData calls AdvanceToNextListener when the 'quick' appearance is used`() {
        val listener = mock<_root_ide_package_.com.jed.optima.android.listeners.AdvanceToNextListener>()
        val widget = SelectOneFromMapWidget(
            activityController.get(),
            _root_ide_package_.com.jed.optima.android.formentry.questions.QuestionDetails(
                promptWithAnswer(null)
