...
class MediaUtilsTest {
    ...
    private var contentUriProvider = mock<com.jed.optima.android.utilities.ContentUriProvider>()
    ...
    fun `When open file, launch on intentLauncher should be called with proper parameters`() {
        ...
        whenever(
            ...
            Uri.parse("content://com.jed.optima.android.provider/external_files/Android/data/com.jed.optima.android/files/image.png")
        )
        ...
        assertThat(
            ...
            `is`("content://com.jed.optima.android.provider/external_files/Android/data/com.jed.optima.android/files/image.png")
        )
