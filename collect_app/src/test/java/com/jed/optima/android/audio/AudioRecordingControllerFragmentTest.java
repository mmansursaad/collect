...
import static com.jed.optima.testshared.RobolectricHelpers.getFragmentByClass;
...
public class AudioRecordingControllerFragmentTest {
    ...
    public void whenRecordingPaused_pauseIconChangesToResume() {
        ...
        FragmentScenario<AudioRecordingControllerFragment> scenario = launcherRule.launchInContainer(AudioRecordingControllerFragment.class);
        scenario.onFragment(fragment -> {
            assertThat(shadowOf(fragment.binding.pauseRecording.getIcon()).getCreatedFromResId(), is(com.jed.optima.icons.R.drawable.ic_baseline_mic_24));
            assertThat(fragment.binding.pauseRecording.getContentDescription(), is(fragment.getString(com.jed.optima.strings.R.string.resume_recording)));
        });
    }
    ...
    public void whenRecordingResumed_pauseIconChangesToPause() {
        ...
        scenario.onFragment(fragment -> {
            ...
            assertThat(fragment.binding.pauseRecording.getContentDescription(), is(fragment.getString(com.jed.optima.strings.R.string.pause_recording)));
        });
    }
    ...
    public void whenRecordingResumed_recordingStatusChangesToRecording() {
        ...
        FragmentScenario<AudioRecordingControllerFragment> scenario = launcherRule.launchInContainer(AudioRecordingControllerFragment.class);
        scenario.onFragment(fragment -> {
            assertThat(shadowOf(fragment.binding.recordingIcon.getDrawable()).getCreatedFromResId(), is(com.jed.optima.icons.R.drawable.ic_baseline_mic_24));
        });
    }
    ...
    public void whenFormHasBackgroundRecording_andBackgroundRecordingIsDisabled_showsThatRecordingIsDisabled() {
        ...
        scenario.onFragment(fragment -> {
            ...
            assertThat(fragment.binding.timeCode.getText(), is(fragment.getString(com.jed.optima.strings.R.string.recording_disabled, "⋮")));
    ...
    public void whenFormHasBackgroundRecording_andThereIsAnError_andSessionIsOver_showsThatThereIsAnError() {
        ...
        scenario.onFragment(fragment -> {
            assertThat(fragment.binding.getRoot().getVisibility(), is(View.VISIBLE));
            assertThat(fragment.binding.timeCode.getText(), is(fragment.getString(com.jed.optima.strings.R.string.start_recording_failed)));
            assertThat(fragment.binding.volumeBar.getVisibility(), is(View.GONE));
            assertThat(fragment.binding.controls.getVisibility(), is(View.GONE));
            assertThat(fragment.binding.help.getVisibility(), is(View.GONE));
        });
