...
class RangePickerDecimalWidgetTest {
    ...
    private fun createWidget(prompt: FormEntryPrompt): _root_ide_package_.com.jed.optima.android.widgets.range.RangePickerDecimalWidget {
        return _root_ide_package_.com.jed.optima.android.widgets.range.RangePickerDecimalWidget(
