...
class FormEndViewTest {
    ...
    fun `form title is displayed correctly`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.save_enter_data_description,
                    "blah"
                )
            )
        )
    ...
    fun `when form should not be sent automatically then 'Finalize' button should be displayed`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(com.jed.optima.strings.R.string.finalize))
        )
    }
    ...
    fun `when form should be sent automatically then 'Send' button should be displayed`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.send
                )
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Send' buttons are visible display correct info for forms that can be edited after finalization`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.form_editing_enabled_after_sending
                )
            )
        )
        assertThat(
            ...
            equalTo(
                "${context.getString(com.jed.optima.strings.R.string.form_editing_enabled_after_sending_hint)} ${context.getString(com.jed.optima.strings.R.string.form_edits_warning_learn_more)}"
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Send' buttons are visible display correct info for forms that can not be edited after finalization`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.form_editing_disabled_after_sending
                )
            )
        )
        assertThat(
            view.findViewById<MaterialTextView>(R.id.form_edits_warning_message).text.toString(),
            equalTo(
                "${context.getString(com.jed.optima.strings.R.string.form_editing_disabled_hint)} ${context.getString(com.jed.optima.strings.R.string.form_edits_warning_learn_more)}"
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Finalize' buttons are visible correct info for forms that can be edited after finalization`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.form_editing_enabled_after_finalizing
                )
            )
        )
        assertThat(
            view.findViewById<MaterialTextView>(R.id.form_edits_warning_message).text.toString(),
            equalTo(
                "${context.getString(com.jed.optima.strings.R.string.form_editing_enabled_after_finalizing_hint)} ${context.getString(com.jed.optima.strings.R.string.form_edits_warning_learn_more)}"
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Finalize' buttons are visible correct info for forms that can not be edited after finalization`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.form_editing_disabled_after_finalizing
                )
            )
        )
        assertThat(
    ...
    fun `when only 'Send' button is visible display correct info for forms that can not be edited after sending`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    com.jed.optima.strings.R.string.form_edits_warning_learn_more
                )
            )
        )
    }
