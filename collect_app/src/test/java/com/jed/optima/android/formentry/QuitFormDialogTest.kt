...
import com.jed.optima.settings.keys.ProtectedProjectKeys.KEY_SAVE_MID
import com.jed.optima.shadows.ShadowAndroidXAlertDialog
...
class QuitFormDialogTest {
    ...
    private val formSaveViewModel = mock<com.jed.optima.android.formentry.saving.FormSaveViewModel>()
    private val formEntryViewModel = mock<com.jed.optima.android.formentry.FormEntryViewModel>()
    ...
    fun whenSaveAsDraftIsEnabled_andFormCanBeFullyDiscarded_showsSaveExplanation() {
        ...
        assertThat(
            ...
            equalTo(activity.getString(com.jed.optima.strings.R.string.save_explanation))
        )
    }
    ...
    fun whenSaveAsDraftIsEnabled_andFormCanNotBeFullyDiscarded_showsLastSavedTime() {
        ...
        assertThat(
            ...
            equalTo(
                SimpleDateFormat(
                    activity.getString(com.jed.optima.strings.R.string.save_explanation_with_last_saved),
                    Locale.getDefault()
                ).format(456L)
            )
        )
    ...
    fun whenSaveAsDraftIsDisabled_andFormCanBeFullyDiscarded_showsWarningTitleAndMessage_andHidesButton() {
        ...
        assertThat(
            shadowDialog.title,
            equalTo(activity.getString(com.jed.optima.strings.R.string.quit_form_continue_title))
        )
        assertThat(
            shadowDialog.getView().findViewById<TextView>(R.id.save_explanation).text,
            equalTo(activity.getString(com.jed.optima.strings.R.string.discard_form_warning))
        )
        assertThat(
    ...
    fun whenSaveAsDraftIsDisabled_andFormCanNotBeFullyDiscarded_showsWarningTitleAndMessage_andHidesButton() {
        ...
        assertThat(
            ...
            equalTo(
                SimpleDateFormat(
                    activity.getString(com.jed.optima.strings.R.string.discard_changes_warning),
                    Locale.getDefault()
                ).format(456L)
            )
        )
