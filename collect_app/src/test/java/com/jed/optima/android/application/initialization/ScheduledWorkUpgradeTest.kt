...
class ScheduledWorkUpgradeTest {
    ...
    fun `schedules updates for all projects`() {
        ...
        val formUpdateScheduler = mock<com.jed.optima.android.backgroundwork.FormUpdateScheduler>()
        val scheduledWorkUpgrade = ScheduledWorkUpgrade(
            mock(),
            projectsRepository,
            formUpdateScheduler,
    ...
    fun `schedules submits for all projects`() {
        ...
        val instanceSubmitScheduler = mock<com.jed.optima.android.backgroundwork.InstanceSubmitScheduler>()
        val scheduledWorkUpgrade = ScheduledWorkUpgrade(
            mock(),
            projectsRepository,
            mock(),
