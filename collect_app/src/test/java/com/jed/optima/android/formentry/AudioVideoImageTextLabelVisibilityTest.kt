...
class AudioVideoImageTextLabelVisibilityTest(
    ...
    private lateinit var reference: com.jed.optima.android.logic.FileReference
    private lateinit var audioVideoImageTextLabel: com.jed.optima.android.formentry.questions.AudioVideoImageTextLabel
    ...
    fun setUp() {
        ...
        val activity = com.jed.optima.android.support.CollectHelpers.createThemedActivity(
            WidgetTestActivity::class.java
        )
        audioVideoImageTextLabel =
            com.jed.optima.android.formentry.questions.AudioVideoImageTextLabel(activity)
