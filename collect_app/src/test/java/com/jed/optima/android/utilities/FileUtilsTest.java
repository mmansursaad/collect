...
public class FileUtilsTest {
    ...
    public void simplifyScopedStoragePathTest() {
        ...
        assertThat(FileUtils.expandAndroidStoragePath("/storage/emulated/0/Android/data/com.jed.optima.android/files/layers"), is("/sdcard/Android/data/com.jed.optima.android/files/layers"));
        assertThat(FileUtils.expandAndroidStoragePath("/storage/emulated/0/Android/data/com.jed.optima.android/files/layers/countries/countries-raster.mbtiles"), is("/sdcard/Android/data/com.jed.optima.android/files/layers/countries/countries-raster.mbtiles"));
    }
