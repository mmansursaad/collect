...
class ExternalAppIntentProviderTest {
    ...
    private lateinit var externalAppIntentProvider: com.jed.optima.android.utilities.ExternalAppIntentProvider

    @Before
    fun setup() {
        formEntryPrompt = mock()
        externalAppIntentProvider = com.jed.optima.android.utilities.ExternalAppIntentProvider()
