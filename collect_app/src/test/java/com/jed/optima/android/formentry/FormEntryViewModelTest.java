...
import static com.jed.optima.androidtest.LiveDataTestUtilsKt.getOrAwaitValue;
...
import com.jed.optima.android.javarosawrapper.FakeFormController;
...
public class FormEntryViewModelTest {
    ...
    public void moveForward_whenThereIsAFailedConstraint_setsFailedConstraint() {
        Consumable<FailedValidationResult> failedValidationResult =
                new Consumable<>(new FailedValidationResult(startingIndex, 0, null, com.jed.optima.strings.R.string.invalid_answer_error));
    ...
    public void moveForward_whenThereIsAFailedConstraint_doesNotFlushAuditLog() throws Exception {
        FailedValidationResult failedValidationResult = new FailedValidationResult(startingIndex, 0, null, com.jed.optima.strings.R.string.invalid_answer_error);
