...
import com.jed.optima.android.TestSettingsProvider.getProtectedSettings
import com.jed.optima.android.TestSettingsProvider.getUnprotectedSettings
...
class QRCodeViewModelTest {
    ...
    fun warning_whenServerAndAdminPasswordSet_isForBoth() {
        ...
        assertThat(viewModel.warning.value, equalTo(com.jed.optima.strings.R.string.qrcode_with_both_passwords))
    }
