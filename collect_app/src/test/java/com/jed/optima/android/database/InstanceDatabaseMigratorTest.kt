...
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.CAN_DELETE_BEFORE_SEND
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.CAN_EDIT_WHEN_COMPLETE
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.DELETED_DATE
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.DISPLAY_NAME
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.EDIT_NUMBER
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.EDIT_OF
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.GEOMETRY
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.GEOMETRY_TYPE
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.INSTANCE_FILE_PATH
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.JR_FORM_ID
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.JR_VERSION
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.LAST_STATUS_CHANGE_DATE
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.STATUS
import com.jed.optima.android.database.instances.DatabaseInstanceColumns.SUBMISSION_URI
...
class InstanceDatabaseMigratorTest {
    ...
    private var instancesDatabaseMigrator =
        com.jed.optima.android.database.instances.InstanceDatabaseMigrator()

    @Before
    fun setup() {
        assertThat("Test expects different Instances DB version", com.jed.optima.android.database.DatabaseConstants.INSTANCES_DATABASE_VERSION, equalTo(10))
    }
    ...
    fun databaseIdsShouldNotBeReused() {
        ...
        database.insert(com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, contentValues)
        database.rawQuery("SELECT * FROM " + com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME + ";", arrayOf<String>()).use { cursor ->
            assertThat(cursor.count, equalTo(1))
            cursor.moveToFirst()
            assertThat(cursor.getInt(cursor.getColumnIndex(_ID)), equalTo(1))
        }

        database.delete(com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, null)
        database.insert(com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, contentValues)
    ...
    fun onUpgrade_fromVersion9_setsFinalizationDateToLastStatusChangedDate_forFinalizedStatuses() {
        ...
        for (status in finalizedStatuses) {
            ...
            database.rawQuery("SELECT * FROM ${com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME};", null).use { cursor ->
                cursor.moveToFirst()
            ...
            database.execSQL("DROP TABLE IF EXISTS ${com.jed.optima.android.database.DatabaseConstants.INSTANCES_TABLE_NAME}")
        }
    }
