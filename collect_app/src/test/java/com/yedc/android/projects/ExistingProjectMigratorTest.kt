...
class ExistingProjectMigratorTest {
    ...
    private fun getProjectDirPaths(projectId: String): Array<String> {
        return arrayOf(
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.FORMS, projectId),
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.INSTANCES, projectId),
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.CACHE, projectId),
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.METADATA, projectId),
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.LAYERS, projectId),
            storagePathProvider.getOdkDirPath(_root_ide_package_.com.yedc.android.storage.StorageSubdirectory.SETTINGS, projectId)
        )
    }
}
