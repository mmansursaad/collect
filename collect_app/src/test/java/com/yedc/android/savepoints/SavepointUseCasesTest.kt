...
class SavepointUseCasesTest {
    private var formV1: com.yedc.forms.Form
    private var formV2: com.yedc.forms.Form

    private var instance1: com.yedc.forms.instances.Instance
    private var instance2: com.yedc.forms.instances.Instance

    private val formsRepository = com.yedc.formstest.InMemFormsRepository().apply {
        formV1 = save(
            FormUtils.buildForm(
                "1",
                "1",
    ...
    private val instancesRepository = com.yedc.formstest.InMemInstancesRepository().apply {
        instance1 = save(
    ...
    fun `getSavepoint called with the old form version uri returns null if only the new form version has a savepoint`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                _root_ide_package_.com.yedc.android.external.FormsContract.getUri("1", formV1.dbId),
                _root_ide_package_.com.yedc.android.external.FormsContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
    ...
    fun `getSavepoint called with the new form version uri returns savepoint if it has one`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                _root_ide_package_.com.yedc.android.external.FormsContract.getUri("1", formV2.dbId),
                _root_ide_package_.com.yedc.android.external.FormsContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
                savepointsRepository
    ...
    fun `getSavepoint called for a saved form uri returns null if only its blank form has a savepoint`() {
        ...
        assertThat(
            SavepointUseCases.getSavepoint(
                _root_ide_package_.com.yedc.android.external.InstancesContract.getUri("1", instance1.dbId),
                _root_ide_package_.com.yedc.android.external.InstancesContract.CONTENT_ITEM_TYPE,
                formsRepository,
                instancesRepository,
                savepointsRepository
            ),
