...
class FormManagementPreferencesFragmentTest {
    ...
    private val instanceSubmitScheduler = mock<_root_ide_package_.com.yedc.android.backgroundwork.InstanceSubmitScheduler>()
    ...
    fun setup() {
        com.yedc.android.support.CollectHelpers.overrideAppDependencyModule(object : _root_ide_package_.com.yedc.android.injection.config.AppDependencyModule() {
            ...
            override fun providesFormSubmitManager(scheduler: Scheduler, settingsProvider: SettingsProvider, application: Application): _root_ide_package_.com.yedc.android.backgroundwork.InstanceSubmitScheduler {
    ...
    fun `When 'Manual Updates' enabled disables prefs`() {
        generalSettings.save(ProjectKeys.KEY_FORM_UPDATE_MODE, com.yedc.settings.enums.FormUpdateMode.MANUAL.getValue(context))
        val scenario = launcherRule.launch(_root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment::class.java)
        scenario.onFragment { f: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
            assertThat(
    ...
    fun `When 'Previously Downloaded Only 'enabled disables prefs`() {
        generalSettings.save(ProjectKeys.KEY_FORM_UPDATE_MODE, com.yedc.settings.enums.FormUpdateMode.PREVIOUSLY_DOWNLOADED_ONLY.getValue(context))
        val scenario = launcherRule.launch(_root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment::class.java)
        scenario.onFragment { f: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
            assertThat(
                f.findPreference<Preference>(ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK)!!.isEnabled,
    ...
    fun `When 'Match Exactly' enabled disables prefs`() {
        generalSettings.save(ProjectKeys.KEY_FORM_UPDATE_MODE, com.yedc.settings.enums.FormUpdateMode.MATCH_EXACTLY.getValue(context))
        val scenario = launcherRule.launch(_root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment::class.java)
        scenario.onFragment { f: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
            assertThat(
                f.findPreference<Preference>(ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK)!!.isEnabled,
    ...
    fun `When 'Manual Updates' enabled and 'Automatic Download' disabled setting to 'Previously Downloaded' resets 'Automatic Download'`() {
        ...
        scenario.onFragment { f: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
            ...
            updateMode!!.value = com.yedc.settings.enums.FormUpdateMode.PREVIOUSLY_DOWNLOADED_ONLY.getValue(context)
    ...
    fun `Changing Form Update Mode should not cause any crash if related preferences are disabled in Protected Settings`() {
        ...
        val scenario = launcherRule.launch(
            _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment::class.java
        )
        scenario.onFragment { f: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
            ...
            val updateMode = f.findPreference<ListPreference>(ProjectKeys.KEY_FORM_UPDATE_MODE)
            updateMode!!.value = com.yedc.settings.enums.FormUpdateMode.PREVIOUSLY_DOWNLOADED_ONLY.getValue(context)
            updateMode.value = com.yedc.settings.enums.FormUpdateMode.MATCH_EXACTLY.getValue(context)
            updateMode.value = com.yedc.settings.enums.FormUpdateMode.MANUAL.getValue(context)
        }
    }
    ...
    fun `Enabled preferences should be visible in Locked mode`() {
        ...
        val scenario = launcherRule.launch(_root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment::class.java)
        scenario.onFragment { fragment: _root_ide_package_.com.yedc.android.preferences.screens.FormManagementPreferencesFragment ->
