...
class FormMetadataPreferencesFragmentTest {
    ...
    private val settingsProvider =
        ApplicationProvider.getApplicationContext<_root_ide_package_.com.yedc.android.application.Collect>().component!!.settingsProvider()
    ...
    fun whenMetadataEmpty_preferenceSummariesAreNotSet() {
        ...
        launcherRule
            .launch(_root_ide_package_.com.yedc.android.preferences.screens.FormMetadataPreferencesFragment::class.java)
            .onFragment {
                assertThat(
                ...
                assertThat(
                    ...
                    equalTo(it.context!!.getString(com.yedc.strings.R.string.preference_not_available))
                )
            }
    }
