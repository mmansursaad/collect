...
class HierarchyListItemViewTest {
    ...
    fun `Group item should contain group label, primary text and icon`() {
        ...
        assertThat(view.findViewById<MaterialTextView>(R.id.group_label).text.toString(), equalTo(context.getString(com.yedc.strings.R.string.group_label)))
    ...
    fun `Repeatable group item should contain group label, primary text and icon`() {
        ...
        assertThat(view.findViewById<MaterialTextView>(R.id.group_label).visibility, equalTo(View.VISIBLE))
        assertThat(view.findViewById<MaterialTextView>(R.id.group_label).text.toString(), equalTo(context.getString(com.yedc.strings.R.string.repeatable_group_label)))
