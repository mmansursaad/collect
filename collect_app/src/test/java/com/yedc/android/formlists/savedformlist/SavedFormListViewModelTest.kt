...
import com.yedc.android.formlists.savedformlist.SavedFormListViewModel.SortOrder
...
class SavedFormListViewModelTest {
    ...
    private fun saveForms(projectId: String, instances: List<com.yedc.forms.instances.Instance>) {
