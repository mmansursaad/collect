package com.yedc.android.formlists
...
import com.yedc.android.formlists.blankformlist.BlankFormListItem
import com.yedc.android.formlists.blankformlist.BlankFormListMenuProvider
...
import com.yedc.testshared.ViewActions.clickOnItemWith
import com.yedc.testshared.ViewMatchers.recyclerView
...
class DeleteBlankFormFragmentTest {
    ...
    fun `clicking delete selected and then accepting deletes selected forms`() {
        ...
        onView(withText(com.yedc.strings.R.string.delete_file)).perform(click())
        onView(withText(context.getString(com.yedc.strings.R.string.delete_confirm, 2)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.yedc.strings.R.string.delete_yes)).inRoot(isDialog()).perform(click())
    ...
    fun `clicking delete selected and then cancelling does nothing`() {
        ...
        onView(withText(context.getString(com.yedc.strings.R.string.delete_confirm, 2)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.yedc.strings.R.string.delete_no)).inRoot(isDialog()).perform(click())
    ...
    fun `clicking delete selected unselects forms`() {
        ...
        onView(withText(com.yedc.strings.R.string.delete_file)).perform(click())
        onView(withText(context.getString(com.yedc.strings.R.string.delete_confirm, 1)))
            .inRoot(isDialog())
            .check(matches(isDisplayed()))
        onView(withText(com.yedc.strings.R.string.delete_yes)).inRoot(isDialog()).perform(click())
