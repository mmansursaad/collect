...
import com.yedc.android.database.instances.DatabaseInstanceColumns.CAN_DELETE_BEFORE_SEND
import com.yedc.android.database.instances.DatabaseInstanceColumns.CAN_EDIT_WHEN_COMPLETE
import com.yedc.android.database.instances.DatabaseInstanceColumns.DELETED_DATE
import com.yedc.android.database.instances.DatabaseInstanceColumns.DISPLAY_NAME
import com.yedc.android.database.instances.DatabaseInstanceColumns.EDIT_NUMBER
import com.yedc.android.database.instances.DatabaseInstanceColumns.EDIT_OF
import com.yedc.android.database.instances.DatabaseInstanceColumns.GEOMETRY
import com.yedc.android.database.instances.DatabaseInstanceColumns.GEOMETRY_TYPE
import com.yedc.android.database.instances.DatabaseInstanceColumns.INSTANCE_FILE_PATH
import com.yedc.android.database.instances.DatabaseInstanceColumns.JR_FORM_ID
import com.yedc.android.database.instances.DatabaseInstanceColumns.JR_VERSION
import com.yedc.android.database.instances.DatabaseInstanceColumns.LAST_STATUS_CHANGE_DATE
import com.yedc.android.database.instances.DatabaseInstanceColumns.STATUS
import com.yedc.android.database.instances.DatabaseInstanceColumns.SUBMISSION_URI

@RunWith(AndroidJUnit4::class)
class InstanceDatabaseMigratorTest {

    private var database = SQLiteDatabase.create(null)
    private var instancesDatabaseMigrator =
        _root_ide_package_.com.yedc.android.database.instances.InstanceDatabaseMigrator()

    @Before
    fun setup() {
        assertThat("Test expects different Instances DB version", _root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_DATABASE_VERSION, equalTo(10))
    }
    ...
    fun databaseIdsShouldNotBeReused() {
        ...
        database.insert(_root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, contentValues)
        database.rawQuery("SELECT * FROM " + _root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME + ";", arrayOf<String>()).use { cursor ->
            assertThat(cursor.count, equalTo(1))
            cursor.moveToFirst()
            assertThat(cursor.getInt(cursor.getColumnIndex(_ID)), equalTo(1))
        }

        database.delete(_root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, null)
        database.insert(_root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME, null, contentValues)
    ...
    fun onUpgrade_fromVersion9_setsFinalizationDateToLastStatusChangedDate_forFinalizedStatuses() {
        ...
        for (status in finalizedStatuses) {
            ...
            database.rawQuery("SELECT * FROM ${_root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME};", null).use { cursor ->
                cursor.moveToFirst()
            ...
            database.execSQL("DROP TABLE IF EXISTS ${_root_ide_package_.com.yedc.android.database.DatabaseConstants.INSTANCES_TABLE_NAME}")
        }
    }
