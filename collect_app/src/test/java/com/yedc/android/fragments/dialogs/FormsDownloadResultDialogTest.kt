...
class FormsDownloadResultDialogTest {
    ...
    fun `The title of the 'POSITIVE BUTTON' should be 'OK'`() {
        ...
        scenario.onFragment {
            assertThat(
                ...
                `is`(ApplicationProvider.getApplicationContext<_root_ide_package_.com.yedc.android.application.Collect>().getString(com.yedc.strings.R.string.ok))
            )
        }
    }
    ...
    fun `If there are no errors an appropriate message should be displayed`() {
        ...
        launcherRule.launch(FormsDownloadResultDialog::class.java, args)
        onView(withText(com.yedc.strings.R.string.all_downloads_succeeded)).inRoot(isDialog())
    ...
    fun `If there are errors an appropriate message should be displayed`() {
        ...
        onView(
            withText(
                ApplicationProvider.getApplicationContext<_root_ide_package_.com.yedc.android.application.Collect>()
                    .getString(com.yedc.strings.R.string.some_downloads_failed, "1", "1")
            )
    ...
    fun `If there are errors 'SHOW DETAILS' button should be displayed`() {
        ...
        scenario.onFragment {
            ...
            assertThat(
                ...
                `is`(
                    ApplicationProvider.getApplicationContext<_root_ide_package_.com.yedc.android.application.Collect>()
                        .getString(com.yedc.strings.R.string.show_details)
                )
            )
        }
    }
