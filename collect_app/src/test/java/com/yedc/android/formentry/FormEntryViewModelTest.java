...
import static com.yedc.androidtest.LiveDataTestUtilsKt.getOrAwaitValue;
...
import com.yedc.android.javarosawrapper.FakeFormController;
...
import com.yedc.formstest.InMemFormsRepository;
...
public class FormEntryViewModelTest {
    ...
    public void moveForward_whenThereIsAFailedConstraint_setsFailedConstraint() {
        Consumable<FailedValidationResult> failedValidationResult =
                new Consumable<>(new FailedValidationResult(startingIndex, 0, null, com.yedc.strings.R.string.invalid_answer_error));
    ...
    public void moveForward_whenThereIsAFailedConstraint_doesNotFlushAuditLog() throws Exception {
        FailedValidationResult failedValidationResult = new FailedValidationResult(startingIndex, 0, null, com.yedc.strings.R.string.invalid_answer_error);
