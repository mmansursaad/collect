...
class AudioVideoImageTextLabelVisibilityTest(
    ...
    private lateinit var reference: _root_ide_package_.com.yedc.android.logic.FileReference
    private lateinit var audioVideoImageTextLabel: _root_ide_package_.com.yedc.android.formentry.questions.AudioVideoImageTextLabel
    ...
    fun setUp() {
        ...
        val activity = com.yedc.android.support.CollectHelpers.createThemedActivity(
            WidgetTestActivity::class.java
        )
        audioVideoImageTextLabel =
            _root_ide_package_.com.yedc.android.formentry.questions.AudioVideoImageTextLabel(
                activity
            )
