...
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.BEGINNING_OF_FORM;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.CONSTRAINT_ERROR;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.DELETE_REPEAT;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.END_OF_FORM;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FINALIZE_ERROR;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FORM_EXIT;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FORM_FINALIZE;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FORM_RESUME;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FORM_SAVE;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.FORM_START;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.GOOGLE_PLAY_SERVICES_NOT_AVAILABLE;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.GROUP;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.HIERARCHY;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_NOT_GRANTED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_TRACKING_DISABLED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.PROMPT_NEW_REPEAT;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.QUESTION;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.REPEAT;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.SAVE_ERROR;
import static com.yedc.android.formentry.audit.AuditEvent.AuditEventType.UNKNOWN_EVENT_TYPE;
import static com.yedc.android.formentry.audit.AuditEventCSVLine.toCSVLine;
