...
class FormEntryUseCasesTest {
    ...
    fun finalizeDraft_whenValidationFails_marksInstanceAsHavingErrors() {
        ...
        assertThat(
            ...
            equalTo(com.yedc.forms.instances.Instance.STATUS_INVALID)
        )
    }
    ...
    ): Pair<com.yedc.forms.Form?, FormDef?> {
    ...
    private fun createDraft(
        ...
        formDef: FormDef,
        instancesRepository: com.yedc.formstest.InMemInstancesRepository,
    ...
    private fun copyTestForm(testForm: String): File {
        return TempFiles.createTempFile(".xml").also {
            _root_ide_package_.com.yedc.android.utilities.FileUtils.copyFileFromResources(testForm, it.absolutePath)
        }
    }
}
