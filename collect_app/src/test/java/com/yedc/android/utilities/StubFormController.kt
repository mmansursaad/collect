...
open class StubFormController : FormController {
    ...
    override fun getAuditEventLogger(): _root_ide_package_.com.yedc.android.formentry.audit.AuditEventLogger? = null
    ...
    @Throws(_root_ide_package_.com.yedc.android.exception.JavaRosaException::class)
    ...
    override fun getSubmissionMetadata(): _root_ide_package_.com.yedc.android.javarosawrapper.InstanceMetadata? = null
