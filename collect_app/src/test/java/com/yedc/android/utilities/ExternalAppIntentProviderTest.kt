...
class ExternalAppIntentProviderTest {
    ...
    private lateinit var externalAppIntentProvider: _root_ide_package_.com.yedc.android.utilities.ExternalAppIntentProvider

    @Before
    fun setup() {
        formEntryPrompt = mock()
        externalAppIntentProvider =
            _root_ide_package_.com.yedc.android.utilities.ExternalAppIntentProvider()
