...
class ImageCompressionControllerTest {
    ...
    private val questionWidget = mock<_root_ide_package_.com.yedc.android.widgets.QuestionWidget>().also {
    ...
    private val treeElement = mock<TreeElement>().also {
        ...
        whenever(it.namespace).thenReturn(_root_ide_package_.com.yedc.android.utilities.ApplicationConstants.Namespaces.XML_OPENROSA_NAMESPACE)
    }
