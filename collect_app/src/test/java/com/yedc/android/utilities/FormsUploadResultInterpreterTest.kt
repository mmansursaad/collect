...
class FormsUploadResultInterpreterTest {
    ...
    private val instance1 = com.yedc.forms.instances.Instance.Builder()
        .formId("1")
        .formVersion("1")
    ...
    private val instance2 = com.yedc.forms.instances.Instance.Builder()
        .formId("2")
        .formVersion("2")
    ...
    private var resultWithoutErrors = mapOf<com.yedc.forms.instances.Instance, FormUploadException?>(
        instance1 to null,
        instance2 to null
    )

    private var resultWithOneError = mapOf<com.yedc.forms.instances.Instance, FormUploadException?>(
        instance1 to null,
    ...
    fun `When not all forms uploaded successfully getFailures() should return list of failures`() {
        ...
        assertThat(
            ...
            `is`(context.getString(com.yedc.strings.R.string.form_details, "2", "2"))
        )
