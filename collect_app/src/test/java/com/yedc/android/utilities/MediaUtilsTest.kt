...
class MediaUtilsTest {
    ...
    private var contentUriProvider = mock<_root_ide_package_.com.yedc.android.utilities.ContentUriProvider>()
    ...
    fun `When open file, launch on intentLauncher should be called with proper parameters`() {
        ...
        whenever(
            ...
            Uri.parse("content://com.yedc.android.provider/external_files/Android/data/com.yedc.android/files/image.png")
        )
        ...
        assertThat(
            ...
            `is`("content://com.yedc.android.provider/external_files/Android/data/com.yedc.android/files/image.png")
        )
