...
class InstanceAutoDeleteCheckerTest {
    ...
    fun `Only instances of a form version with auto-delete enabled should be deleted`() {
        val formV1 = formsRepository.save(
            com.yedc.forms.Form.Builder()
                ...
                .version("1")
                .autoDelete("false")
                .formFilePath(_root_ide_package_.com.yedc.android.utilities.FormUtils.createXFormFile("1", "1").absolutePath)
                .build()
        )

        val instanceV1 = com.yedc.forms.instances.Instance.Builder()
        ...
        val formV2 = formsRepository.save(
            com.yedc.forms.Form.Builder(formV1)
                .version("2")
                .autoDelete("true")
                .build()
        )

        val instanceV2 = com.yedc.forms.instances.Instance.Builder()
    ...
    private fun saveInstance(autoDelete: String = ""): com.yedc.forms.instances.Instance {
