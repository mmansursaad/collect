...
import com.yedc.forms.instances.Instance.STATUS_COMPLETE
import com.yedc.forms.instances.Instance.STATUS_INCOMPLETE
import com.yedc.forms.instances.Instance.STATUS_INVALID
import com.yedc.forms.instances.Instance.STATUS_NEW_EDIT
import com.yedc.forms.instances.Instance.STATUS_SUBMISSION_FAILED
import com.yedc.forms.instances.Instance.STATUS_SUBMITTED
import com.yedc.forms.instances.Instance.STATUS_VALID
...
class InstancesDataServiceTest {
    private val projectsDependencyModuleFactory = CachingProjectDependencyModuleFactory { projectId ->
        ProjectDependencyModule(
            ...
            { com.yedc.formstest.InMemFormsRepository() },
            { com.yedc.formstest.InMemInstancesRepository() },
            mock(),
    ...
    private val httpInterface = mock<com.yedc.openrosa.http.OpenRosaHttpInterface>()
