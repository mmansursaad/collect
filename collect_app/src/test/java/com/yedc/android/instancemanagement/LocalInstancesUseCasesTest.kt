...
class LocalInstancesUseCasesTest {
    ...
    fun `#editInstance makes a proper copy of the instance dir`() {
        ...
        val instancesRepository = com.yedc.formstest.InMemInstancesRepository()
    ...
    fun `#editInstance makes a proper copy of the instance row in the database`() {
        ...
        assertThat(firstEditedInstance.status, equalTo(com.yedc.forms.instances.Instance.STATUS_NEW_EDIT))
