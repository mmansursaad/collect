...
import static com.yedc.android.widgets.support.GeoWidgetHelpers.stringFromDoubleList;
...
public class GeoShapeWidgetTest {
    ...
    public void whenPromptIsReadOnlyAndHasAnswer_viewGeoShapeButtonIsShown() {
        ...
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.yedc.strings.R.string.view_polygon));
    }

    @Test
    public void whenPromptIsNotReadOnlyAndDoesNotHaveAnswer_startGeoShapeButtonIsShown() {
        GeoShapeWidget widget = createWidget(promptWithAnswer(null));
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.yedc.strings.R.string.get_polygon));
    }

    @Test
    public void whenPromptIsNotReadOnlyAndHasAnswer_viewOrChangeGeoShapeButtonIsShown() {
        GeoShapeWidget widget = createWidget(promptWithAnswer(new StringData(answer)));
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(com.yedc.strings.R.string.view_or_change_polygon));
    }
