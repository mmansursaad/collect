package com.yedc.android.widgets.datetime.pickers
...
import com.yedc.android.widgets.datetime.DatePickerDetails.DatePickerMode
...
class BuddhistDatePickerDialogTest {
    ...
    private fun launchFragment(
        ...
        val args = Bundle().apply {
            putSerializable(
                _root_ide_package_.com.yedc.android.widgets.utilities.DateTimeWidgetUtils.DATE,
                LocalDateTime().withYear(year).withMonthOfYear(month).withDayOfMonth(day)
            )
            putSerializable(
                _root_ide_package_.com.yedc.android.widgets.utilities.DateTimeWidgetUtils.DATE_PICKER_DETAILS,
                _root_ide_package_.com.yedc.android.widgets.datetime.DatePickerDetails(
                    _root_ide_package_.com.yedc.android.widgets.datetime.DatePickerDetails.DatePickerType.BUDDHIST,
                    datePickerMode
                )
            )
        }
