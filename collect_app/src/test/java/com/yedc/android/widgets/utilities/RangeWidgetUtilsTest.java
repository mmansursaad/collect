...
import com.yedc.android.databinding.RangePickerWidgetAnswerBinding;
...
import com.yedc.android.views.TrackingTouchSlider;
...
public class RangeWidgetUtilsTest {
    ...
    public void whenPromptDoesNotHaveAnswer_answerTextViewShowsNoValueSelected() {
        ...
        assertThat(binding.widgetAnswerText.getText(), equalTo(widgetTestActivity().getString(com.yedc.strings.R.string.no_value_selected)));
    }
    ...
    public void whenPromptDoesNotHaveAnswer_pickerButtonShowsNoValueSelected() {
        RangeWidgetUtils.setUpRangePickerWidget(widgetTestActivity(), binding, promptWithQuestionDefAndAnswer(rangeQuestion, null));
        assertThat(binding.widgetButton.getText(), equalTo(widgetTestActivity().getString(com.yedc.strings.R.string.select_value)));
    }
    ...
    public void whenPromptHasAnswer_pickerButtonShowsCorrectAnswer() {
        RangeWidgetUtils.setUpRangePickerWidget(widgetTestActivity(), binding, promptWithQuestionDefAndAnswer(
                rangeQuestion, new StringData("4")));
        assertThat(binding.widgetButton.getText(), equalTo(widgetTestActivity().getString(com.yedc.strings.R.string.edit_value)));
    }
    ...
    public void whenRangeQuestionHasZeroRangeStep_invalidWidgetToastIsShown() {
        ...
        assertThat(toastText, equalTo(ApplicationProvider.getApplicationContext().getString(com.yedc.strings.R.string.invalid_range_widget)));
    }
