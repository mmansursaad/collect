...
class RangePickerIntegerWidgetTest {
    ...
    private fun createWidget(prompt: FormEntryPrompt): _root_ide_package_.com.yedc.android.widgets.range.RangePickerIntegerWidget {
        return _root_ide_package_.com.yedc.android.widgets.range.RangePickerIntegerWidget(
