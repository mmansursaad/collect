...
import com.yedc.android.javarosawrapper.InstanceMetadata;
...
public class OSMWidgetTest {
    ...
    public void whenPromptHasAnswer_widgetShowsCorrectAnswer() {
        ...
        assertThat(widget.binding.errorText.getVisibility(), is(View.GONE));
        assertThat(widget.binding.osmFileHeaderText.getText(), is(widgetActivity.getString(com.yedc.strings.R.string.edited_osm_file)));
    ...
    public void whenPromptHasAnswer_recaptureOsmButtonIsDisplayed() {
        OSMWidget widget = createWidget(promptWithAnswer(new StringData("blah")));
        assertThat(widget.binding.launchOpenMapKitButton.getText(), is(widgetActivity.getString(com.yedc.strings.R.string.recapture_osm)));
    }
    ...
    public void clearAnswer_showsCaptureOsmButton() {
        OSMWidget widget = createWidget(promptWithAnswer(new StringData("blah")));
        widget.clearAnswer();
        assertThat(widget.binding.launchOpenMapKitButton.getText(), is(widgetActivity.getString(com.yedc.strings.R.string.capture_osm)));
    }
