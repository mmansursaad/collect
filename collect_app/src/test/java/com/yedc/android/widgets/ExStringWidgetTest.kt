...
import com.yedc.android.widgets.support.QuestionWidgetHelpers
import com.yedc.android.widgets.utilities.StringRequester

class ExStringWidgetTest : _root_ide_package_.com.yedc.android.widgets.base.GeneralExStringWidgetTest<_root_ide_package_.com.yedc.android.widgets.ExStringWidget, StringData>() {
    @Mock
    var stringRequester: StringRequester? = null

    override fun createWidget(): _root_ide_package_.com.yedc.android.widgets.ExStringWidget {
        whenever(formEntryPrompt.dataType).thenReturn(Constants.DATATYPE_TEXT)

        return _root_ide_package_.com.yedc.android.widgets.ExStringWidget(
            activity,
    ...
    override fun whenPromptHasHiddenAnswerAppearance_answerIsNotDisplayed() {
        val prompt =
            _root_ide_package_.com.yedc.android.support.MockFormEntryPromptBuilder(
                QuestionWidgetHelpers.promptWithAppearance(Appearances.HIDDEN_ANSWER)
            )
                .withAnswer(StringData("original contents"))
                .build()

        val widgetTestActivity = _root_ide_package_.com.yedc.android.widgets.support.QuestionWidgetHelpers.widgetTestActivity()
        val widget = _root_ide_package_.com.yedc.android.widgets.ExStringWidget(
            widgetTestActivity,
