...
import com.yedc.android.widgets.utilities.GeoWidgetUtils.convertCoordinatesIntoDegreeFormat
import com.yedc.android.widgets.utilities.GeoWidgetUtils.floor
import com.yedc.android.widgets.utilities.GeoWidgetUtils.getGeoPointAnswerToDisplay
import com.yedc.android.widgets.utilities.GeoWidgetUtils.getGeoPolyAnswerToDisplay
import com.yedc.android.widgets.utilities.GeoWidgetUtils.isWithinMapBounds
import com.yedc.android.widgets.utilities.GeoWidgetUtils.parseGeometry
import com.yedc.android.widgets.utilities.GeoWidgetUtils.parseGeometryPoint
import com.yedc.android.widgets.utilities.GeoWidgetUtils.truncateDouble
...
class GeoWidgetUtilsTest {
    ...
    private val answer = GeoPointData(_root_ide_package_.com.yedc.android.widgets.support.GeoWidgetHelpers.getRandomDoubleArray())
    ...
    fun getAnswerToDisplay_whenAnswerIsNotNullAndConvertible_returnsAnswer() {
        ...
        assertEquals(
            ...
            context.getString(
                com.yedc.strings.R.string.gps_result,
