...
class ExternalAppRecordingRequesterTest {
    ...
    fun requestRecording_whenIntentIsNotAvailable_doesNotStartAnyIntentAndCancelsWaitingForData() {
        ...
        requester.requestRecording(_root_ide_package_.com.yedc.android.widgets.support.QuestionWidgetHelpers.promptWithAnswer(null))
    ...
    fun requestRecording_whenPermissionIsGranted_startsRecordSoundIntentAndSetsWidgetWaitingForData() {
        ...
        assertThat(
            ...
            equalTo(_root_ide_package_.com.yedc.android.utilities.ApplicationConstants.RequestCodes.AUDIO_CAPTURE)
        )
        assertThat(
