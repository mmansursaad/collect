...
class StringWidgetTest : _root_ide_package_.com.yedc.android.widgets.base.GeneralStringWidgetTest<_root_ide_package_.com.yedc.android.widgets.StringWidget, StringData>() {
    override fun createWidget(): _root_ide_package_.com.yedc.android.widgets.StringWidget {
        whenever(formEntryPrompt.dataType).thenReturn(Constants.DATATYPE_TEXT)

        return _root_ide_package_.com.yedc.android.widgets.StringWidget(
            activity,
