...
class FormSourceExceptionMapperTest {
    ...
    fun fetchError_returnsGenericMessage() {
        val expectedString = context.getString(com.yedc.strings.R.string.report_to_project_lead)
    ...
    fun unreachable_returnsUnknownHostMessage() {
        val expectedString = context.getString(
            ...
            "http://unknown.com"
        ) + " " + context.getString(com.yedc.strings.R.string.report_to_project_lead)
        assertThat(
