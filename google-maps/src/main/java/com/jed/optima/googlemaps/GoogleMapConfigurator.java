...
import static com.jed.optima.androidshared.ui.PrefUtils.createListPref;
import static com.jed.optima.androidshared.ui.PrefUtils.getInt;
...
import com.jed.optima.maps.layers.MbtilesFile.LayerType;
    ...
    @Override public void showUnavailableMessage(Context context) {
        if (!isGoogleMapsSdkAvailable(context)) {
            ToastUtils.showLongToast(context.getString(
                com.jed.optima.strings.R.string.basemap_source_unavailable, context.getString(sourceLabelId)));
        }
