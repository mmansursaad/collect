...
import com.jed.optima.googlemaps.scaleview.MapScaleView;
...
import com.jed.optima.maps.layers.MapFragmentReferenceLayerUtils;
...
public class GoogleMapFragment extends MapViewModelMapFragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync((GoogleMap googleMap) -> {
            if (googleMap == null) {
                ToastUtils.showShortToast(com.jed.optima.strings.R.string.google_play_services_error_occured);
    ...
    private void updateLocationIndicator(LatLng loc, double radius) {
        ...
        if (locationCrosshairs == null) {
            locationCrosshairs = map.addMarker(new MarkerOptions()
                .position(loc)
                .icon(getBitmapDescriptor(getContext(), new MarkerIconDescription(com.jed.optima.maps.R.drawable.ic_crosshairs)))
        ...
        if (accuracyCircle == null) {
            ...
            int fill = getResources().getColor(com.jed.optima.androidshared.R.color.color_primary_low_emphasis);
    ...
    private MapConfigurator createConfigurator() {
        return new GoogleMapConfigurator(
                ProjectKeys.KEY_GOOGLE_MAP_STYLE, com.jed.optima.strings.R.string.basemap_source_google,
    ...
    private static class DynamicPolyLineFeature implements LineFeature {
        ...
        DynamicPolyLineFeature(Context context, LineDescription lineDescription, GoogleMap map) {
            ...
            for (MapPoint point : lineDescription.getPoints()) {
                markers.add(createMarker(context, new MarkerDescription(point, true, CENTER, new MarkerIconDescription(com.jed.optima.icons.R.drawable.ic_map_point)), map));
            }
