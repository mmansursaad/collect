...
import static com.yedc.androidshared.ui.PrefUtils.createListPref;
import static com.yedc.androidshared.ui.PrefUtils.getInt;
...
import com.yedc.maps.layers.MbtilesFile.LayerType;
    ...
    @Override public void showUnavailableMessage(Context context) {
        if (!isGoogleMapsSdkAvailable(context)) {
            ToastUtils.showLongToast(context.getString(
                com.yedc.strings.R.string.basemap_source_unavailable, context.getString(sourceLabelId)));
        }
