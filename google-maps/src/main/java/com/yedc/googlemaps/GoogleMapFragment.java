...
import com.yedc.googlemaps.scaleview.MapScaleView;
...
import com.yedc.maps.layers.MapFragmentReferenceLayerUtils;
...
public class GoogleMapFragment extends MapViewModelMapFragment implements
    ...
    private void updateLocationIndicator(LatLng loc, double radius) {
        ...
        if (locationCrosshairs == null) {
            locationCrosshairs = map.addMarker(new MarkerOptions()
                .position(loc)
                .icon(getBitmapDescriptor(getContext(), new MarkerIconDescription(com.yedc.maps.R.drawable.ic_crosshairs)))
        ...
        if (accuracyCircle == null) {
            ...
            int fill = getResources().getColor(com.yedc.androidshared.R.color.color_primary_low_emphasis);
    ...
    private MapConfigurator createConfigurator() {
        return new GoogleMapConfigurator(
                ProjectKeys.KEY_GOOGLE_MAP_STYLE, com.yedc.strings.R.string.basemap_source_google,
    ...
    private static class DynamicPolyLineFeature implements LineFeature {
        ...
        DynamicPolyLineFeature(Context context, LineDescription lineDescription, GoogleMap map) {
            ...
            for (MapPoint point : lineDescription.getPoints()) {
                markers.add(createMarker(context, new MarkerDescription(point, true, CENTER, new MarkerIconDescription(com.yedc.icons.R.drawable.ic_map_point)), map));
            }
