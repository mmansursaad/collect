...
import com.jed.optima.selfiecamera.support.RobolectricApplication
...
class CaptureSelfieActivityTest {
    ...
    fun clickingPreview_whenThereIsAnErrorSavingImage_showsToast() {
        ...
        assertThat(latestToast, equalTo(application.getString(com.jed.optima.strings.R.string.camera_error)))
    }
    ...
    fun whenCameraFailsToInitialize_showsToast() {
        ...
        assertThat(latestToast, equalTo(application.getString(com.jed.optima.strings.R.string.camera_failed_to_initialize)))
    }
}
