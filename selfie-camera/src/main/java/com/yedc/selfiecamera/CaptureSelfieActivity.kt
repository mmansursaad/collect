        ...
        camera.state().observe(this) {
            when (it) {
                ...
                Camera.State.FAILED_TO_INITIALIZE -> {
                    showLongToast(com.yedc.strings.R.string.camera_failed_to_initialize)
                }
            }
        }
    }
    ...
    private fun setupCamera(camera: Camera) {
        ...
        previewView.setOnClickListener {
            camera.takePicture(
                ...
                { showLongToast(com.yedc.strings.R.string.camera_error) }
            )
        }

        showLongToast(com.yedc.strings.R.string.take_picture_instruction)
    }
