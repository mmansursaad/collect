        ...
        camera.state().observe(this) {
            when (it) {
                ...
                Camera.State.FAILED_TO_INITIALIZE -> {
                    showLongToast(com.jed.optima.strings.R.string.camera_failed_to_initialize)
                }
            }
        }
    }
    ...
    private fun setupCamera(camera: Camera) {
        ...
        previewView.setOnClickListener {
            camera.takePicture(
                ...
                { showLongToast(com.jed.optima.strings.R.string.camera_error) }
            )
        }

        showLongToast(com.jed.optima.strings.R.string.take_picture_instruction)
    }
