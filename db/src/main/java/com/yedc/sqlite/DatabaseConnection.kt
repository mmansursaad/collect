...
open class DatabaseConnection @JvmOverloads constructor(
    ...
    private val migrator: _root_ide_package_.com.yedc.db.sqlite.DatabaseMigrator,
...
private class DatabaseMigratorSQLiteOpenHelper(
    ...
    version: Int,
    private val databaseMigrator: _root_ide_package_.com.yedc.db.sqlite.DatabaseMigrator
