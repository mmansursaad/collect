...
internal object PermissionsDialogCreatorImpl : PermissionsDialogCreator {
    override fun showEnableGPSDialog(
        ...
        MaterialAlertDialogBuilder(activity)
            .setMessage(activity.getString(com.jed.optima.strings.R.string.gps_enable_message))
            .setCancelable(false)
            .setPositiveButton(
                activity.getString(com.jed.optima.strings.R.string.enable_gps)
            ...
            .setNegativeButton(
                activity.getString(com.jed.optima.strings.R.string.cancel)
    ...
    override fun showAdditionalExplanation(
        ...
        MaterialAlertDialogBuilder(activity)
            ...
            .setNeutralButton(com.jed.optima.strings.R.string.open_settings) { _, _ ->
