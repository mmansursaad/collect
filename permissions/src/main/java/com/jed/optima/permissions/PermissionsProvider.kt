package com.jed.optima.permissions
            ...
            object : PermissionListener {
                ...
                override fun denied() {
                    ...
                    permissionsDialogCreator.showAdditionalExplanation(
                        activity,
                        com.jed.optima.strings.R.string.camera_runtime_permission_denied_title,
                        com.jed.optima.strings.R.string.camera_runtime_permission_denied_desc,
        ...
        requestPermissions(
            ...
            object : PermissionListener {
                ...
                override fun denied() {
                    ...
                    permissionsDialogCreator.showAdditionalExplanation(
                        activity,
                        com.jed.optima.strings.R.string.location_runtime_permissions_denied_title,
                        com.jed.optima.strings.R.string.location_runtime_permissions_denied_desc,
        ...
        requestPermissions(
            ...
            object : PermissionListener {
                ...
                override fun denied() {
                    ...
                    permissionsDialogCreator.showAdditionalExplanation(
                        activity,
                        com.jed.optima.strings.R.string.record_audio_runtime_permission_denied_title,
                        com.jed.optima.strings.R.string.record_audio_runtime_permission_denied_desc,
                        com.jed.optima.icons.R.drawable.ic_baseline_mic_24,
                        action
                    )
                }
            },
            ...
            requestPermissions(
                ...
                object : PermissionListener {
                    ...
                    override fun denied() {
                        permissionsDialogCreator.showAdditionalExplanation(
                            activity,
                            com.jed.optima.strings.R.string.storage_runtime_permission_denied_title,
                            com.jed.optima.strings.R.string.storage_runtime_permission_denied_desc,
